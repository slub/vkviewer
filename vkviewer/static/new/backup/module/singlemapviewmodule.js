goog.provide('VK2.Module.SingleMapViewer');

goog.require('goog.object');
goog.require('goog.Uri');
goog.require('goog.dom');
goog.require('VK2.Settings');
goog.require('VK2.Tools.MetadataVisualizer');
goog.require('VK2.Tools.ResetGeoreferenceParameter');
goog.require('VK2.Tools.TimestampSwitcher');
goog.require('VK2.Viewer.Messtischblatt');
goog.require('VK2.Viewer.Zoomify');

/**
 * @param {Object} settings
 * @constructor
 */
VK2.Module.SingleMapViewer = function(settings){
	...
	var mtbViewer = new VK2.Viewer.Messtischblatt(this._settings.georef_map_container_id, {
	...
	var zoomifyViewer = new VK2.Viewer.Zoomify(this._settings.zoomify_container, this._settings.zoomify_url, this._settings.zoomify_width, this._settings.zoomify_height);
 ...
 */
VK2.Module.SingleMapViewer.prototype.getZoomifyViewer = function(){
