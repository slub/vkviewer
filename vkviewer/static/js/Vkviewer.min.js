...
VK2.Utils.AppLoader.prototype.loadApplication=function(){this._checkIfCookiesAreEnabble();this._loadOLMap();this._loadEventBehavior();this._loadVK2Tools()};VK2.Utils.AppLoader.prototype.loadApplicationWithGeoref=function(){this.loadApplication();this._loadGeoreferencerChooser()};VK2.Utils.Settings={};VK2.Utils.Settings.DOM={};VK2.Utils.Settings.proxy_url="/vkviewer/proxy/?url=";VK2.Utils.Settings.geonetwork="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/search#|";
...
VK2.Tools.MinimizeMesstischblattView.prototype._addShowSingleMapBehavior=function(a,b){a.href="/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+(b.geometry.bounds.left+","+b.geometry.bounds.bottom+","+b.geometry.bounds.right+","+b.geometry.bounds.top)+"&time="+b.data.time+"&id="+b.data.mtbid;$(a).fancybox({type:"iframe",width:"100%",height:"100%"})};
VK2.Tools.MinimizeMesstischblattView.prototype._addShowMetadataBehavior=function(a,b){var c=VK2.Utils.Settings.geonetwork;goog.isDef(b)&&(c+=b);a.href=c;a.target="_blank"};VK2.Tools.MinimizeMesstischblattView.prototype.deactivate=function(){goog.style.showElement(this._panel,!1)};
