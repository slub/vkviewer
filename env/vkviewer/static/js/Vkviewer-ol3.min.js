...
VK2.Tools.Georeferencer.prototype.loadValidationMap=function(a,b,c){var d=new ol.layer.Tile({source:new ol.source.OSM});c=new ol.layer.Tile({source:new ol.source.TileWMS({url:b,params:{LAYERS:c,VERSION:"1.1.1"},projection:"EPSG:900913"})});var e=new ol.Map({layers:[d,c],interactions:ol.interaction.defaults().extend([new ol.interaction.DragZoom]),renderer:"canvas",target:a,view:new ol.View2D({projection:"EPSG:900913",center:[0,0],zoom:2}),controls:[new ol.control.FullScreen,new ol.control.Zoom,new ol.control.Attribution]});
VK2.Requests.Georeferencer.getExtentForWMS(this._urls.proxy+b,function(a){a=(new ol.parser.ogc.WMSCapabilities).read(a);for(var b=0;b<a.capability.layers.length;b++)a.capability.layers[b].bbox.hasOwnProperty("EPSG:4314")&&(bbox_4314=a.capability.layers[b].bbox["EPSG:4314"].bbox,Proj4js.defs["EPSG:4314"]="+proj=longlat +ellps=bessel +towgs84=582,105,414,1.04,0.35,-3.08,8.3 +no_defs",bbox_900913=ol.proj.transform(bbox_4314,"EPSG:4314","EPSG:900913"),e.getView().fitExtent(bbox_900913,e.getSize()))},
function(a){alert("Problems while parsing wms capabilities.")});e.addControl(new ol3.control.LayerSpy({spyLayer:new ol.layer.Tile({source:new ol.source.OSM}),radius:50}))};VK2.Tools.ReportError=function(a,b,c,d){this._displayBtn=goog.dom.getElement(a);this._key=c;this._reference=d;this._parentDialogContainer=goog.dom.getElement(b);this._loadHtmlContent();this._loadClickBehavior()};
