...
VK2.Tools.ReportError.prototype._loadHtmlContent = function(){
	...
	var labelHeader = goog.dom.createDom('h4',{
		'id':'myModalLabel',
		'class':'modal-title',
		'innerHTML': VK2.Utils.getMsg('report_error_titel')+': '+this._key
	});
	...
	var closeBtnFooter = goog.dom.createDom('button',{
		...
		'data-dismiss':'modal',
		'innerHTML': VK2.Utils.getMsg('report_error_btn_cancel')
	});
	...
	this._submitBtn = goog.dom.createDom('button',{
		...
		'data-dismiss':'modal',
		'innerHTML': VK2.Utils.getMsg('report_error_btn_submit')
	});
...
VK2.Tools.ReportError.prototype._loadClickBehavior = function(){
	...
	goog.events.listen(this._submitBtn, goog.events.EventType.CLICK, function(event){
		...
		var success_callback = function(xhrio){alert(VK2.Utils.getMsg('report_error_confirmed'));}
		var error_callback = function(xhrio){alert(VK2.Utils.getMsg('report_error_alert'));}
