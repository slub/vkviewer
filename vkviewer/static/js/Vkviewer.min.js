...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});VK2.Utils={};VK2.Utils.initializeFancyboxForClass=function(a){$("."+a).each(function(){$(this).fancybox({type:"iframe",autoSize:!1,wrapCSS:"vk2-fancybox-wrapper",beforeShow:function(){for(var a=$(".fancybox-iframe").contents()[0].body,a=goog.dom.getChildren(a),c=0;c<a.length;c++)if(goog.dom.classes.has(a[c],"page-container")){var d=goog.style.getSize(a[c]),e=goog.object.get(d,"width")+20;this.width=goog.isDef(e)?e+"px":"100%";d=goog.object.get(d,"height");this.height=goog.isDef(d)?d+"px":"100%"}}})})};
...
goog.dom.createDom("th",{id:"header-col-"+this._headingCol[e].id,"class":"header-col col-"+this._headingCol[e].id}),g=goog.dom.createDom("div",{"class":this._headingCol[e].id,innerHTML:this._headingCol[e].title});goog.dom.appendChild(f,g);goog.dom.appendChild(d,f)}this._tableBody=goog.dom.createDom("tbody",{"class":"table-body"});goog.dom.appendChild(c,d);goog.dom.appendChild(a,b);goog.dom.appendChild(a,c);goog.dom.appendChild(a,this._tableBody);goog.dom.appendChild(this._parentEl,a);$(goog.dom.getElement(this.tableId)).tablesorter()};
