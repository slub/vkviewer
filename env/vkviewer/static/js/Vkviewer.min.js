...
a=new VK2.Tools.Layerbar(a);this._sidebar.appendControl(this._settings.vk2LayerbarControl,this._settings.vk2LayerbarPanel,a);return a},_loadToolLayersearch:function(){var a=new VK2.Tools.SpatialSearch(document.getElementById(this._settings.vk2LayersearchPanel),this._settings.map,this._settings.mapController);this._sidebar.appendControl(this._settings.vk2LayersearchControl,this._settings.vk2LayersearchPanel,a);return a},_loadToolSidebar:function(a){this._checkIfToolContainerIsInit(this._settings.vk2Sidebar)&&
...
this.addFeatures([a])};a.activate=function(){if(this.map){var a=this.map,b=a.getLayerIndex(this)+1;a.getNumLayers()>b&&a.setLayerIndex(this,a.getNumLayers()+1);this.setVisibility(!0)}};a.deactivate=function(){this.map&&this.setVisibility(!1)};return a};VK2.Tools.addGazetteer=function(a,b){$(document.getElementById(a)).autocomplete({source:function(a,d){VK2.Validation.isBlattnumber(a.term)?(d(),$.ajax({url:"/vkviewer/proxy/?url=http://139.30.111.16/fgs/vkll/fragblattnr.php?blattnr="+a.term,success:$.proxy(function(a){""!=a?(a=JSON.parse(a),VK2.Utils.jumptolonlat(b,a.coordinates[0],a.coordinates[1])):alert(VK2.Utils.get_I18n_String("noResultsBlattnr"))},this)})):$.ajax({url:"http://open.mapquestapi.com/nominatim/v1/search.php",dataType:"json",data:{featureClass:"P",
...
{id:"header-col-"+this._headingCol[e].id,"class":"header-col"}),g=goog.dom.createDom("div",{"class":this._headingCol[e].id,innerHTML:this._headingCol[e].title});goog.dom.appendChild(f,g);goog.dom.appendChild(d,f)}this._tableBody=goog.dom.createDom("tbody",{"class":"table-body"});goog.dom.appendChild(c,d);goog.dom.appendChild(a,b);goog.dom.appendChild(a,c);goog.dom.appendChild(a,this._tableBody);goog.dom.appendChild(this._parentEl,a);$(document.getElementById(this.tableId)).tablesorter()};
VK2.Tools.SearchTable.prototype.refreshData=function(a){$(this._tableBody).empty();for(key in a){for(var b=goog.dom.createDom("tr",{id:key,"class":"data-row"}),c=0;c<this._columnIds.length;c++){var d=goog.dom.createDom("td",{"class":"data-col-"+this._columnIds[c],innerHTML:a[key][this._columnIds[c]]});goog.dom.appendChild(b,d)}this._controller.addRowBehavior(b,a[key].feature);goog.dom.appendChild(this._tableBody,b)}$(document.getElementById(this.tableId)).trigger("update")};VK2.Tools.SpatialSearch=function(a,b,c){this.NAME=VK2.Utils.get_I18n_String("toolname_layersearch");this._timeParams={extent:null,time:null,wms:"http://194.95.145.43/mapcache",wms_layer:"messtischblaetter",wfs:"http://194.95.145.43/cgi-bin/mtbows",layer:"Historische Messtischblaetter",featureType:"Historische_Messtischblaetter_WFS",featurePrefix:"ms",featureNS:"http://mapserver.gis.umn.edu/mapserver",geometryName:"boundingbox",serviceVersion:"1.0.0",maxFeatures:1E4,srsName:"EPSG:900913",maxResolution:305.74811309814453};
...
VK2.Tools.SpatialSearch.prototype._loadHtmlContent=function(){var a=goog.dom.createDom("div",{id:"panel-layersearch","class":"panel panel-default searchTablePanel"});goog.dom.appendChild(this._parentElement,a);var b=goog.dom.createDom("div",{id:this._elementIds.headerPanel,"class":"panel-heading"}),c=goog.dom.createDom("div",{id:"panel-heading-content","class":"content"}),d=goog.dom.createDom("div",{"class":"loading"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,d);goog.dom.appendChild(a,b);
b=goog.dom.createDom("div",{id:this._elementIds.tablePanel,"class":"panel-mapsearch-table"});goog.dom.appendChild(a,b);b=goog.dom.createDom("div",{id:this._elementIds.toolsPanel,"class":"panel-spatialsearch-tools"});goog.dom.appendChild(a,b);var a=goog.dom.createDom("div",{"class":"time-slider-container"}),c=goog.dom.createDom("div",{id:this._toolElementIds.label_start,"class":"slider-label slider-label-start"}),d=goog.dom.createDom("div",{id:this._toolElementIds.label_end,"class":"slider-label slider-label-end"}),
e=goog.dom.createDom("div",{id:this._toolElementIds.slider,"class":"slider"});goog.dom.appendChild(a,c);goog.dom.appendChild(a,e);goog.dom.appendChild(a,d);goog.dom.appendChild(b,a);a=goog.dom.createDom("div",{"class":"layer-chooser-container"});c=goog.dom.createDom("input",{id:this._toolElementIds.input_field,"class":"layer-chooser-input",type:"text"});d=goog.dom.createDom("button",{id:this._toolElementIds.btn,"class":"layer-chooser-btn",innerHTML:VK2.Utils.get_I18n_String("displaytimestamp")});
