...
goog.style.getCssTranslation=function(a){var b;goog.userAgent.IE?b="-ms-transform":goog.userAgent.WEBKIT?b="-webkit-transform":goog.userAgent.OPERA?b="-o-transform":goog.userAgent.GECKO&&(b="-moz-transform");var c;b&&(c=goog.style.getStyle_(a,b));c||(c=goog.style.getStyle_(a,"transform"));return c?(a=c.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};VK2.Utils={initializeFancyboxForClass:function(a){$("."+a).each(function(){$(this).fancybox({type:"iframe",autoSize:!1,beforeShow:function(){var a=$(".fancybox-iframe").contents()[0].body,a=goog.style.getSize(a),c=goog.object.get(a,"width");this.width=goog.isDef(c)?c+"px":"100%";a=goog.object.get(a,"height");this.height=goog.isDef(a)?a+"px":"100%"}})})},loadBaseMap:function(a,b,c){a=new OpenLayers.Map(a,b);c=new OpenLayers.Layer.OSM("Mapnik","",c);a.addLayers([c]);a.setCenter(b.startPoint,2);return a},
setGenericOpenLayersPropertys:function(a){OpenLayers.IMAGE_RELOAD_ATTEMPTS=5;OpenLayers.ProxyHost=VK2.Utils.getHost(a)},jumptolonlat:function(a,b,c){b=(new OpenLayers.LonLat(b,c)).transform(new OpenLayers.Projection("EPSG:4326"),a.getProjectionObject());a.setCenter(b,12);return!0},encode_utf8:function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var d=a.charCodeAt(c);128>d?b+=String.fromCharCode(d):(127<d&&2048>d?b+=String.fromCharCode(d>>6|192):(b+=String.fromCharCode(d>>12|224),
b+=String.fromCharCode(d>>6&63|128)),b+=String.fromCharCode(d&63|128))}return b},decode_utf8:function(a){for(var b="",c=0,d=c1=c2=0;c<a.length;)d=a.charCodeAt(c),128>d?(b+=String.fromCharCode(d),c++):191<d&&224>d?(c2=a.charCodeAt(c+1),b+=String.fromCharCode((d&31)<<6|c2&63),c+=2):(c2=a.charCodeAt(c+1),c3=a.charCodeAt(c+2),b+=String.fromCharCode((d&15)<<12|(c2&63)<<6|c3&63),c+=3);return b},getAllUrlParams:function(){for(var a=window.location.search.substring(1).split("&"),b={},c=0;c<a.length;c++){var d=
a[c].split("=");b[d[0]]=decodeURIComponent(d.slice(1).join("="))}return b},get_url_param:function(a){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");a=RegExp("[\\?&]"+a+"=([^&#]*)").exec(window.location.href);return null==a?"":a[1]},getHost:function(a){var b=location.protocol+"//"+location.hostname+(location.port?":"+location.port:"");return"/"==a.charAt(0)?b+a:b+"/"+a},routeToTop:function(a){var b=document.createElement("a");b.href=a;b.target="_top";document.body.appendChild(b);b.click()},fixControlConflictsOnOLMap:function(a){"undefined"!=
typeof a.handlers?a.handlers.feature.stopDown=!1:"undefined"!=typeof a.handler&&(a.handler.stopDown=!1,a.handler.stopUp=!1)},getDictionaryValues:function(a){list=[];for(var b in a)return list.push(a[b]),list},get_I18n_String:function(a){try{if(goog.isDef(lang_dictionary))return lang_dictionary[a]}catch(b){console.log("Could not found dictionary.")}}};VK2.Utils.setCookie=function(a,b){goog.net.cookies.set(a,b)};
VK2.Utils.removeClass=function(a,b){goog.dom.classes.has(a,b)&&goog.dom.classes.remove(a,b)};VK2.Class=function(a){classObj=function(){this.initialize.apply(this,arguments)};for(var b in a)classObj.prototype[b]=a[b];classObj.prototype.initialize||(classObj.prototype.initialize=function(){});return classObj};VK2.Filter={getBoundingBoxFilter:function(a,b){return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,value:a,projection:b})},getTimeFilter:function(a,b,c,d){return new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,value:a,projection:b}),new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.LESS_THAN_OR_EQUAL_TO,
...
VK2.Controller.MapSearchController.prototype._addRowClickBehavior=function(a,b){var c=this._ftLayer;$(a).click(function(){var a=b.geometry.getCentroid();c.map.setCenter(new OpenLayers.LonLat(a.x,a.y),4);$(this).trigger("mouseenter");$("#spatialsearch-tools-input-layer").val(b.data.time)})};
VK2.Controller.MapSearchController.prototype._addRowHoverBehavior=function(a,b){var c=this._ftLayer,d=this._hoverLayer;$(a).hover(function(){$(this).hasClass("hover-table")||($(this).addClass("hover-table"),d.updateGeometry(b.geometry))},function(){$(this).hasClass("hover-table")&&($(this).removeClass("hover-table"),d.removeAllFeatures(),c.drawFeature(b))})};
...
VK2.Tools.SearchTable.prototype.refreshData=function(a){$(this._tableBody).empty();for(key in a){for(var b=goog.dom.createDom("tr",{id:key,"class":"data-row"}),c=0;c<this._columnIds.length;c++){var d=goog.dom.createDom("td",{"class":"data-col-"+this._columnIds[c]+" col-"+this._columnIds[c],innerHTML:a[key][this._columnIds[c]]});goog.dom.appendChild(b,d)}this._controller.addRowBehavior(b,a[key].feature);goog.dom.appendChild(this._tableBody,b)}$(document.getElementById(this.tableId)).trigger("update")};VK2.Tools.SpatialSearch=function(a,b,c){this.NAME=VK2.Utils.get_I18n_String("toolname_layersearch");this._timeParams={extent:null,time:null,wms:"http://194.95.145.43/mapcache",wms_layer:"messtischblaetter",wfs:"http://194.95.145.43/cgi-bin/mtbows",layer:"Historische Messtischblaetter",featureType:"Historische_Messtischblaetter_WFS",featurePrefix:"ms",featureNS:"http://mapserver.gis.umn.edu/mapserver",geometryName:"boundingbox",serviceVersion:"1.0.0",maxFeatures:1E4,srsName:"EPSG:900913",maxResolution:305.74811309814453};
