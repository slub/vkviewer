...
"display","none");goog.style.setStyle(georefLoadingScreen,"z-index","0");alert("Something went wrong, while trying to compute validation result")})}else alert("Please check your georeference params! Are there 4 points?")},void 0,this);goog.events.listen(b,goog.events.EventType.CLICK,function(a){a=this._validateGeorefParams();var b=this._settings.georef_id;if(goog.isDef(a)){var f=function(a){a=goog.dom.createDom("a",{href:c.main_page,target:"_top"});goog.dom.appendChild(document.body,a);a.click()},
g=function(a){goog.style.setStyle(georefLoadingScreen,"display","none");goog.style.setStyle(georefLoadingScreen,"z-index","0");alert("Something went wrong, while trying to submit georeference parameter")};this._isValidationState?(goog.style.setStyle(georefLoadingScreen,"display","block"),goog.style.setStyle(georefLoadingScreen,"z-index","2000"),VK2.Requests.Georeferencer.submit(c.process_submit,this._objectId,void 0,b,f,g)):(goog.style.setStyle(georefLoadingScreen,"display","block"),goog.style.setStyle(georefLoadingScreen,
"z-index","2000"),VK2.Requests.Georeferencer.submit(c.process_submit,this._objectId,a,void 0,f,g))}else alert("Please check your georeference params! Are there 4 points?")},void 0,this)};VK2.Tools.Georeferencer.prototype._validateGeorefParams=function(){var a=this._drawSource.getAllFeatures();if(!(4>a.length)){for(var b="",c=0;c<a.length;c++)var d=a[c].getGeometry().getCoordinates(),b=b+Math.round(d[0])+":"+Math.round(parseInt(this._settings.height)+d[1]),b=c<a.length-1?b+",":b+"";return b}};
...
interactions:ol.interaction.defaults().extend([new ol.interaction.DragZoom]),controls:[new ol.control.FullScreen,new ol.control.Zoom],renderer:"canvas",target:this._mapContainer,view:new ol.View2D({projection:e,center:d,zoom:1,maxZoom:9})}))};
VK2.Tools.ZoomifyViewer.prototype._loadZoomifyLayer=function(a){var b="/vkviewer/proxy/?url="+a+"/ImageProperties.xml",c=new goog.net.XhrIo;goog.events.listenOnce(c,"success",function(b){b=b.target;var c=b.getResponseXml().childNodes[0];this._loadZoomifyMap(a+"/",c.getAttribute("WIDTH"),c.getAttribute("HEIGHT"));b.dispose()},!1,this);goog.events.listenOnce(c,"error",function(a){goog.isDef(error_callback)&&error_callback(a)},!1,this);c.send(b)};VK2.Tools.ZoomifyViewer.prototype.getMap=function(){return this._map};VK2.Tools.SingleMapViewer=function(a){this._settings={reset_georef_id:"reset-georef-map",map_id:null,tab_list_id:"singlemapview-tab-list",georef_map_container_id:"map-container",opacity_slider_id:"opacity-slider",str_extent:"",time:null,metadata_container:"metadata-container",metadata_key:null,zoomify_container:"zoomify-container",zoomify_url:null,zoomify_width:null,zoomify_height:null};goog.object.extend(this._settings,a);a=this._settings.str_extent;a=a.split(",");for(var b=[],c=0;c<a.length;c++)b.push(parseFloat(a[c]));
var d=new VK2.Tools.MesstischblattViewer(this._settings.georef_map_container_id,{time:this._settings.time,extent:b,opacity_slider:this._settings.opacity_slider_id});new VK2.Tools.MetadataVisualizer(this._settings.metadata_container,this._settings.metadata_key,{csw_url:VK2.Utils.Settings.csw_url});goog.dom.getElement(this._settings.reset_georef_id)&&new VK2.Tools.ResetGeoreferenceParameter(this._settings.reset_georef_id,map_id);var e=new VK2.Tools.ZoomifyViewer(this._settings.zoomify_container,this._settings.zoomify_url,
this._settings.zoomify_width,this._settings.zoomify_height);$("#"+this._settings.tab_list_id+" a").click(function(a){a.preventDefault();$(this).tab("show");a=(new goog.Uri(this.href)).getFragment();"georef-view"==a?d.getMap().updateSize():"original-view"==a&&e.getMap().updateSize()})};VK2.Requests={};VK2.Requests.Georeferencer={};VK2.Requests.Georeferencer.submit=function(a,b,c,d){goog.isDef(a)&&goog.isDef(b)?console.log("Pure submit."):goog.isDef(a)&&goog.isDef(c)&&console.log("Submit validation.")};VK2.Requests.Georeferencer.validate=function(a,b,c,d,e){this._sendRequest(a+"?mtbid="+b+"&points="+c,d,e)};
