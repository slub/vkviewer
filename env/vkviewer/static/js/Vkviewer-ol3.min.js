...
VK2.Requests.CSW_GetRecordById._getChildNode=function(a,b){var c=[],d=goog.dom.findNodes(a,function(a){return a.nodeType==goog.dom.NodeType.ELEMENT&&a.tagName==b[0]}),e=goog.array.slice(b,1);if(0<e.length)for(var f=0;f<d.length;f++)goog.array.extend(c,this._getChildNode(d[f],e));else for(f=0;f<d.length;f++)goog.array.insert(c,d[f].textContent);return c};VK2.Requests.Georeferencer={};VK2.Requests.Georeferencer.submit=function(a,b,c,d){goog.isDef(a)&&goog.isDef(b)?console.log("Pure submit."):goog.isDef(a)&&goog.isDef(c)&&console.log("Submit validation.")};VK2.Requests.Georeferencer.validate=function(a,b,c,d,e){this._sendRequest(a+"?mtbid="+b+"&points="+c,d,e)};VK2.Requests.Georeferencer.submit=function(a,b,c,d,e,f){goog.isDef(c)?this._sendRequest(a+"?mtbid="+b+"&points="+c,e,f):goog.isDef(d)&&(a=a+"?mtbid="+b+"&georefid="+d,this._sendRequest(a,e,f))};
VK2.Requests.Georeferencer.getExtentForWMS=function(a,b,c){this._sendRequest(a+"&VERSION=1.1.1&SERVICE=WMS&REQUEST=GetCapabilities",b,c)};VK2.Requests.Georeferencer._sendRequest=function(a,b,c){var d=new goog.net.XhrIo;goog.events.listenOnce(d,"success",function(a){a=a.target;var c=a.getResponseText()?a.getResponseText():"";a.dispose();goog.isDef(b)&&b(c)},!1,this);goog.events.listenOnce(d,"error",function(a){goog.isDef(c)&&c(a)},!1,this);d.send(a)};VK2.Tools={};ol.FeatureOverlay.prototype.removeAllFeatures=function(){this.getFeatures().clear()};
...
controls:[this._fullscreenControl,new ol.control.Zoom],renderer:"canvas",target:this._mapContainerId,view:new ol.View2D({projection:b,center:a,zoom:2,maxZoom:9})})};VK2.Tools.Georeferencer.prototype._loadGeoreferenceControls=function(){var a=this._defaultStyles.point;this._drawSource=new ol.source.Vector;this._drawLayer=new ol.layer.Vector({source:this._drawSource,styleFunction:function(b,c){return a}});this._map.addLayer(this._drawLayer);this._loadToggleControls(this._map,this._drawSource);this._loadButtonEvents()};
