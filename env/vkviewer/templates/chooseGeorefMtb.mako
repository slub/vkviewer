		...
		<div class="vk2ChooseGeorefMtb">
			...
			% if paginator.items:
				...
				% for mtb in paginator.items:
					...
					<a href="${request.route_url('home_login')}?mtbid${mtb['mtbid']}&zoomify_prop=${mtb['zoomify_prop']}&zoomify_width=${mtb['zoomify_width']}&zoomify_height=${mtb['zoomify_height']}&layer=${mtb['titel']}" target="_top">${mtb['titel']}</a> <br> 
