...
if(c)for(g=0;!b.propagationStopped_&&g<c.length;g++)f=b.currentTarget=c[g],e=f.fireListeners(d,!1,b)&&e;return e};goog.events.KeyCodes={WIN_KEY_FF_LINUX:0,MAC_ENTER:3,BACKSPACE:8,TAB:9,NUM_CENTER:12,ENTER:13,SHIFT:16,CTRL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,FF_SEMICOLON:59,FF_EQUALS:61,FF_DASH:173,QUESTION_MARK:63,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,
...
VK2.Tools.Georeferencer.prototype._loadToggleControls=function(a,b){for(var c=this._defaultStyles.hover,d=new ol.FeatureOverlay({styleFunction:function(a,b){return c}}),e={addpoint:[new ol.interaction.Draw({source:b,type:"Point",styleFunction:function(a,b){return c}})],dragpoint:[new ol.interaction.Modify({featureOverlay:d,pixelTolerance:10}),new ol.interaction.Select({featureOverlay:d,pixelTolerance:5})],deletepoint:[new ol.interaction.DeleteFeature({featureOverlay:d,pixelTolerance:5},b)]},f=goog.dom.getElementsByTagNameAndClass("input",
"toggle-elements",this._toolContainer),g=0;g<f.length;g++)goog.events.listen(f[g],goog.events.EventType.CLICK,function(b){this._removeInteractions(e,a,d);if(goog.isDef(b.target.value)&&""!=b.target.value&&e.hasOwnProperty(b.target.value))for(var c=0;c<e[b.target.value].length;c++)a.addInteraction(e[b.target.value][c])},void 0,this)};
VK2.Tools.Georeferencer.prototype._removeInteractions=function(a,b,c){for(var d in a)if(a.hasOwnProperty(d))for(var e=0;e<a[d].length;e++)b.removeInteraction(a[d][e]),c.removeAllFeatures()};
