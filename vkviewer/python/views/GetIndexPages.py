...
""" basic start site """
@view_config(route_name='home', renderer='index_logged_out.mako', permission='view',http_cache=(0, {'public':True}))
@view_config(route_name='home1', renderer='index_logged_out.mako', permission='view',http_cache=(0, {'public':True}))
...
@view_config(route_name='home_login', renderer='index_logged_in.mako', permission='edit',http_cache=(0, {'public':True}))
