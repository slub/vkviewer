...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};var VK2={Utils:{}};VK2.Utils.Settings={};VK2.Utils.Settings.DOM={};VK2.Utils.Settings.proxy_url="/vkviewer/proxy/?url=";VK2.Utils.Settings.geonetwork="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/search#|";VK2.Utils.Settings.csw_url="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/csw";
...
VK2.Utils.sendReport=function(a,b,c){var d=new goog.net.XhrIo;goog.events.listenOnce(d,"success",function(a){a=a.target;goog.isDef(b)&&b(a);a.dispose()},!1,this);goog.events.listenOnce(d,"error",function(a){a=a.target;goog.isDef(c)&&c(a)},!1,this);d.send(a)};VK2.Utils.getCenterPointForExtent=function(a){return[a[0]+(a[2]-a[0])/2,a[1]+(a[3]-a[1])/2]};String.prototype.replaceAll=function(a,b){return this.split(a).join(b)};VK2.Events={};VK2.Events.EventType={PARSED_RECORD:goog.events.getUniqueId("parsed_record")};VK2.Events.ParsedCswRecordEvent=function(a,b){goog.events.Event.call(this,VK2.Events.EventType.PARSED_RECORD);this.parser=a;this.parsed_content=b};goog.inherits(VK2.Events.ParsedCswRecordEvent,goog.events.Event);goog.events.KeyCodes={WIN_KEY_FF_LINUX:0,MAC_ENTER:3,BACKSPACE:8,TAB:9,NUM_CENTER:12,ENTER:13,SHIFT:16,CTRL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,FF_SEMICOLON:59,FF_EQUALS:61,FF_DASH:173,QUESTION_MARK:63,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,
...
goog.events.KeyEvent=function(a,b,c,d){goog.events.BrowserEvent.call(this,d);this.type=goog.events.KeyHandler.EventType.KEY;this.keyCode=a;this.charCode=b;this.repeat=c};goog.inherits(goog.events.KeyEvent,goog.events.BrowserEvent);var ol3={control:{}};
ol3.control.LayerSpy=function(a){var b=a||{};this._buildHtmlElement();var c=this,d=goog.isDef(b.radius)?parseInt(b.radius):75;a=new goog.events.KeyHandler(document);goog.events.listen(a,goog.events.KeyHandler.EventType.KEY,function(a){a.keyCode===goog.events.KeyCodes.Y?(d=Math.min(d+5,150),c.getMap().requestRenderFrame()):a.keyCode===goog.events.KeyCodes.X&&(d=Math.max(d-5,25),c.getMap().requestRenderFrame())},void 0,this);var e=null,f=function(a){a=a.context;a.save();a.beginPath();e&&(a.arc(e[0],
e[1],d,0,2*Math.PI),a.lineWidth=5,a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.clip()},g=function(a){a.context.restore()},h=function(a){e=c.getMap().getEventPixel(a.event_);c.getMap().requestRenderFrame()},k=function(){e=null;c.getMap().requestRenderFrame()};goog.events.listen(this._layerSpyAnchor,goog.events.EventType.CLICK,function(a){goog.dom.classes.has(this,"active")?(b.spyLayer.un("precompose",f),b.spyLayer.un("postcompose",g),c.getMap().removeLayer(b.spyLayer),goog.dom.classes.remove(this,
"active"),goog.events.unlisten(c.getMap().getViewport(),"mousemove",h),goog.events.unlisten(c.getMap().getViewport(),"mouseout",k)):(c.getMap().addLayer(b.spyLayer),b.spyLayer.on("precompose",f),b.spyLayer.on("postcompose",g),goog.dom.classes.add(this,"active"),goog.events.listen(c.getMap().getViewport(),"mousemove",h),goog.events.listen(c.getMap().getViewport(),"mouseout",k))});ol.control.Control.call(this,{element:this._layerSpyContainer,target:b.target})};ol.inherits(ol3.control.LayerSpy,ol.control.Control);
ol3.control.LayerSpy.prototype._buildHtmlElement=function(){this._layerSpyAnchor=goog.dom.createDom("a",{href:"#layerspy",innerHTML:"L"});this._layerSpyContainer=goog.dom.createDom("div",{"class":"ol-layerspy ol-unselectable"});goog.dom.appendChild(this._layerSpyContainer,this._layerSpyAnchor)};ol3.control.RotateNorth=function(a){a=a||{};var b=document.createElement("a");b.href="#rotate-north";b.innerHTML="N";var c=this,d=function(a){a.preventDefault();c.getMap().getView().getView2D().setRotation(0)};b.addEventListener("click",d,!1);b.addEventListener("touchstart",d,!1);d=document.createElement("div");d.className="rotate-north ol-unselectable";d.appendChild(b);ol.control.Control.call(this,{element:d,target:a.target})};ol.inherits(ol3.control.RotateNorth,ol.control.Control);VK2.Tools={};ol.FeatureOverlay.prototype.removeAllFeatures=function(){this.getFeatures().clear()};
VK2.Tools.Georeferencer=function(a,b,c){this._settings={width:null,height:null,url:"",zoomify:!0,georef_params:"",georef_id:void 0};goog.object.extend(this._settings,c);this._urls={process_submit:"/vkviewer/georef/confirm",process_validation:"/vkviewer/georef/validate",display_validation:"/vkviewer/georeference/validate",main_page:"/vkviewer/auth?georef=on&points=20",proxy:"/vkviewer/proxy/?url="};goog.isDef(c.urls)&&goog.object.extend(this._urls,c.urls);this._isValidationState=goog.isDef(this._settings.georef_id)&&
goog.isDef(this._settings.georef_params);this._mapContainerId=a;this._objectId=b;this._defaultStyles={point:[new ol.style.Style({image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.6)"}),stroke:new ol.style.Stroke({color:"#319FD3",width:1.5})})})],hover:[new ol.style.Style({image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"rgba(255,0,0,0.1)"}),stroke:new ol.style.Stroke({color:"#f00",width:1})}),zIndex:1E5})]};this._settings.zoomify&&this._loadZoomifyLayer();
this._loadToolbox();this._loadGeoreferenceControls();$(this._controlElement).click();goog.isDef(this._settings.georef_params)&&""!=this._settings.georef_params&&this._loadGeorefParams(this._drawSource,this._settings.georef_params)};VK2.Tools.Georeferencer.prototype._loadGeorefParams=function(a,b){for(var c=b.split(","),d=0;d<c.length;d++){var e=c[d],e=e.replace(/:/g,","),e=e.split(",");e[0]=parseInt(e[0]);e[1]=parseInt(e[1])-parseInt(this._settings.height);e=new ol.Feature(new ol.geom.Point(e));a.addFeatures([e])}};
VK2.Tools.Georeferencer.prototype._loadToolbox=function(){var a=goog.dom.createDom("div",{"class":"georeference-tools-container",id:"georeference-tools-container"});goog.dom.appendChild(goog.dom.getElement(this._mapContainerId),a);this._controlElement=goog.dom.createDom("div",{"class":"georeference-tools-handler"});goog.dom.appendChild(a,this._controlElement);goog.dom.appendChild(this._controlElement,goog.dom.createDom("span",{"class":"icon"}));goog.dom.appendChild(a,this._loadToolHtmlContent());
goog.dom.appendChild(goog.dom.getElement(this._mapContainerId),this._loadLoadingScreenHtmlContent());this._loadOpenCloseBehavior(this._controlElement)};
VK2.Tools.Georeferencer.prototype._loadLoadingScreenHtmlContent=function(){var a=goog.dom.createDom("div",{id:"georefLoadingScreen","class":"georefLoadingScreen"}),b=goog.dom.createDom("div",{"class":"centerLoading"});goog.dom.appendChild(a,b);var c=goog.dom.createDom("div",{"class":"progress progress-striped active"});goog.dom.appendChild(b,c);b=goog.dom.createDom("div",{"class":"progress-bar",role:"progressbar","aria-valuenow":"100","aria-valuemin":"0","aria-valuemax":"100",style:"width:100%"});
goog.dom.appendChild(c,b);return a};
VK2.Tools.Georeferencer.prototype._loadOpenCloseBehavior=function(a){goog.events.listen(a,goog.events.EventType.CLICK,function(a){goog.style.getSize(a.currentTarget.parentElement);var c=this._toolContainer;goog.dom.classes.has(a.currentTarget,"open")?$(a.currentTarget.parentElement).animate({left:"-250px"},1E3,function(){goog.dom.classes.remove(a.currentTarget,"open");goog.style.setStyle(c,"display","none")}):(goog.style.setStyle(c,"display","block"),$(a.currentTarget.parentElement).animate({left:"-2px"},1E3,
function(){goog.dom.classes.add(a.currentTarget,"open")}))},void 0,this)};
VK2.Tools.Georeferencer.prototype._loadToolHtmlContent=function(){var a=function(a,b,c,d,k){k=goog.isDef(k)?k:"";d=goog.isDef(d)?d:"";return goog.dom.createDom("input",{type:a,name:"type",value:b,id:c,"class":d,checked:k})};this._toolContainer=goog.dom.createDom("div",{"class":"georeference-tools-inner-container",id:"georeference-tools-inner-container"});var b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(this._toolContainer,b);var c=a("radio","none","noneToggle","toggle-elements",
"checked"),d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("moveMap")}));goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(this._toolContainer,b);c=a("radio","addpoint","pointToggle","toggle-elements");d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("setCornerPoint")}));
goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(this._toolContainer,b);c=a("radio","dragpoint","dragToggle","toggle-elements");d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("moveCornerPoint")}));goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(this._toolContainer,b);a=a("radio","deletepoint","deleteToggle","toggle-elements");
c=goog.dom.createDom("label",{});goog.dom.appendChild(c,a);goog.dom.appendChild(c,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("deleteCornerPoint")}));goog.dom.appendChild(b,c);goog.dom.appendChild(this._toolContainer,goog.dom.createDom("br",{}));a=goog.dom.createDom("input",{type:"hidden",id:"mtbid",name:"mtbid"});goog.dom.appendChild(this._toolContainer,a);a=goog.dom.createDom("input",{type:"hidden",id:"points",name:"points"});goog.dom.appendChild(this._toolContainer,a);a="";this._isValidationState?
(b=VK2.Utils.get_I18n_String("validateBtn_validate"),a=VK2.Utils.get_I18n_String("submitBtn_validate")):(b=VK2.Utils.get_I18n_String("validateBtn_georeference"),a=VK2.Utils.get_I18n_String("submitBtn_georeference"));b=goog.dom.createDom("input",{type:"button","class":"vk2GeorefToolsBtn btn btn-default btn-validate",value:b});goog.dom.appendChild(this._toolContainer,b);this._isValidationState&&(a=goog.dom.createDom("input",{type:"button","class":"vk2GeorefToolsBtn btn btn-default btn-submit",value:a}),
goog.dom.appendChild(this._toolContainer,a));return this._toolContainer};
VK2.Tools.Georeferencer.prototype._loadZoomifyLayer=function(){var a=[this._settings.width/2,-this._settings.height/2],b=new ol.proj.Projection({code:"ZOOMIFY",units:"pixels",extent:[0,0,this._settings.width,this._settings.height]});this._zoomifySource=new ol.source.Zoomify({url:this._settings.url,size:[this._settings.width,this._settings.height]});this._fullscreenControl=new ol.control.FullScreen;this._map=new ol.Map({layers:[new ol.layer.Tile({source:this._zoomifySource})],interactions:ol.interaction.defaults().extend([new ol.interaction.DragZoom]),
controls:[this._fullscreenControl,new ol.control.Zoom],renderer:"canvas",target:this._mapContainerId,view:new ol.View2D({projection:b,center:a,zoom:2,maxZoom:9})})};
VK2.Tools.Georeferencer.prototype._loadGeoreferenceControls=function(){var a=this._defaultStyles.point;this._drawSource=new ol.source.Vector;this._drawLayer=new ol.layer.Vector({source:this._drawSource,styleFunction:function(b,c){return a}});this._map.addLayer(this._drawLayer);this._map.addControl(new ol.control.ZoomToExtent({extent:this._map.getView().getView2D().calculateExtent(this._map.getSize())}));this._loadToggleControls(this._map,this._drawSource);this._loadButtonEvents()};
VK2.Tools.Georeferencer.prototype._loadButtonEvents=function(){var a=goog.dom.getElementByClass("btn-validate",this._toolContainer),b=goog.dom.getElementByClass("btn-submit",this._toolContainer);goog.dom.getElement("georefLoadingScreen");var c=this._urls;goog.events.listen(a,goog.events.EventType.CLICK,function(a){var b=this._validateGeorefParams();if(goog.isDef(b)){var f=this._fullscreenControl;goog.style.setStyle(georefLoadingScreen,"display","block");goog.style.setStyle(georefLoadingScreen,"z-index",
"2000");VK2.Requests.Georeferencer.validate(c.process_validation,this._objectId,b,function(a){f.element.children[0].click();for(var d=c.display_validation+"?points="+b+"&",k=new goog.Uri(window.location.href),l=k.getQueryData().getKeys(),m=0;m<l.length;m++)"points"!=l[m]&&"layer_id"!=l[m]&&"wms_url"!=l[m]&&"georefid"!=l[m]&&(d=d+l[m]+"="+k.getQueryData().get(l[m])+"&");a=JSON.parse(a);for(var n in a)a.hasOwnProperty(n)&&(d=d+n+"="+a[n]+"&");window.location.href=d},function(a){goog.style.setStyle(georefLoadingScreen,
"display","none");goog.style.setStyle(georefLoadingScreen,"z-index","0");alert("Something went wrong, while trying to compute validation result")})}else alert("Please check your georeference params! Are there 4 points?")},void 0,this);this._isValidationState&&goog.events.listen(b,goog.events.EventType.CLICK,function(a){a=this._validateGeorefParams();var b=this._settings.georef_id;goog.isDef(a)?(goog.style.setStyle(georefLoadingScreen,"display","block"),goog.style.setStyle(georefLoadingScreen,"z-index",
"2000"),VK2.Requests.Georeferencer.submit(c.process_submit,this._objectId,void 0,b,function(a){a=goog.dom.createDom("a",{href:c.main_page,target:"_top"});goog.dom.appendChild(document.body,a);a.click()},function(a){goog.style.setStyle(georefLoadingScreen,"display","none");goog.style.setStyle(georefLoadingScreen,"z-index","0");alert("Something went wrong, while trying to submit georeference parameter")})):alert("Please check your georeference params! Are there 4 points?")},void 0,this)};
VK2.Tools.Georeferencer.prototype._validateGeorefParams=function(){var a=this._drawSource.getAllFeatures();if(!(4>a.length)){for(var b="",c=0;c<a.length;c++)var d=a[c].getGeometry().getCoordinates(),b=b+Math.round(d[0])+":"+Math.round(parseInt(this._settings.height)+d[1]),b=c<a.length-1?b+",":b+"";return b}};
VK2.Tools.Georeferencer.prototype._loadToggleControls=function(a,b){var c=this._defaultStyles.hover,d=new ol.FeatureOverlay({styleFunction:function(a,b){return c}}),e={addpoint:[new ol.interaction.Draw({source:b,type:"Point",styleFunction:function(a,b){return c}})],dragpoint:[new ol.interaction.Modify({featureOverlay:d,pixelTolerance:10}),new ol.interaction.Select({featureOverlay:d,pixelTolerance:5})],deletepoint:[new ol.interaction.DeleteFeature({featureOverlay:d,pixelTolerance:5},b)]};goog.events.listen(this._drawSource,
"addfeature",function(a){a=this._drawSource.getAllFeatures();var b=0;4<a.length&&(alert(VK2.Utils.get_I18n_String("checkCornerPoint_count")),b++,this._drawSource.removeFeature(a[4]));console.log(a[a.length-1].getGeometry().getCoordinates()+" (Zuletzt gesetzt)");for(var c=a[a.length-1].getGeometry().getCoordinates(),d=0;d<a.length-1;d++){var e=a[d].getGeometry().getCoordinates(),f=(Math.round(c[0])-Math.round(e[0])).toString(),e=(Math.round(c[1])-Math.round(e[1])).toString(),f=f.replace(/\-/g,""),
e=e.replace(/\-/g,"");if(3E3>parseInt(f)&3E3>parseInt(e))if(0<b)break;else alert(VK2.Utils.get_I18n_String("checkCornerPoint_distance")),b++,this._drawSource.removeFeature(a[a.length-1])}},void 0,this);for(var f=goog.dom.getElementsByTagNameAndClass("input","toggle-elements",this._toolContainer),g=0;g<f.length;g++)goog.events.listen(f[g],goog.events.EventType.CLICK,function(b){this._removeInteractions(e,a,d);if(goog.isDef(b.target.value)&&""!=b.target.value&&e.hasOwnProperty(b.target.value))for(var c=
0;c<e[b.target.value].length;c++)a.addInteraction(e[b.target.value][c])},void 0,this)};VK2.Tools.Georeferencer.prototype._removeInteractions=function(a,b,c){for(var d in a)if(a.hasOwnProperty(d))for(var e=0;e<a[d].length;e++)b.removeInteraction(a[d][e]),c.removeAllFeatures()};
VK2.Tools.Georeferencer.prototype.loadValidationMap=function(a,b,c){var d=new ol.layer.Tile({source:new ol.source.OSM}),e=new ol.layer.Tile({source:new ol.source.TileWMS({url:b,params:{LAYERS:c,VERSION:"1.1.1"},projection:"EPSG:900913"})}),f=new ol.Map({layers:[d,e],interactions:ol.interaction.defaults().extend([new ol.interaction.DragZoom]),renderer:"canvas",target:a,view:new ol.View2D({projection:"EPSG:900913",center:[0,0],zoom:2}),controls:[new ol.control.FullScreen,new ol.control.Zoom,new ol.control.Attribution]});
VK2.Requests.Georeferencer.getExtentForWMS(this._urls.proxy+b,function(a){a=(new ol.parser.ogc.WMSCapabilities).read(a);for(var b=0;b<a.capability.layers.length;b++)a.capability.layers[b].bbox.hasOwnProperty("EPSG:4314")&&(bbox_4314=a.capability.layers[b].bbox["EPSG:4314"].bbox,Proj4js.defs["EPSG:4314"]="+proj=longlat +ellps=bessel +towgs84=582,105,414,1.04,0.35,-3.08,8.3 +no_defs",bbox_900913=ol.proj.transform(bbox_4314,"EPSG:4314","EPSG:900913"),f.getView().fitExtent(bbox_900913,f.getSize()))},
function(a){alert("Problems while parsing wms capabilities.")});f.addControl(new ol3.control.LayerSpy({spyLayer:new ol.layer.Tile({source:new ol.source.OSM}),radius:50}));opacitySlider&&goog.isDef(goog.dom.getElement(opacitySlider))&&(a=goog.dom.getElement(opacitySlider),$(a).slider({min:0,max:100,value:100,animate:"slow",orientation:"horizontal",step:1,start:function(a,b){$(this.parentElement).find(".tooltip").fadeIn("fast")},slide:function(a,b){$(this.parentElement).find(".tooltip").find(".tooltip-inner").html("Transparency "+
b.value);e.setOpacity(b.value/100)},stop:function(a,b){$(this.parentElement).find(".tooltip").fadeOut("fast")}}))};VK2.Tools.ReportError=function(a,b,c,d){this._displayBtn=goog.dom.getElement(a);this._key=c;this._reference=d;this._parentDialogContainer=goog.dom.getElement(b);this._loadHtmlContent();this._loadClickBehavior()};
VK2.Tools.ReportError.prototype._loadHtmlContent=function(){this._dialogContainer=goog.dom.createDom("div",{id:"myModal","class":"modal fade",tabindex:"-1",role:"dialog","aria-labelledby":"myModalLabel","aria-hidden":"true"});goog.dom.appendChild(this._parentDialogContainer,this._dialogContainer);var a=goog.dom.createDom("div",{"class":"modal-dialog"});goog.dom.appendChild(this._dialogContainer,a);var b=goog.dom.createDom("div",{"class":"modal-content"});goog.dom.appendChild(a,b);a=goog.dom.createDom("div",
{"class":"modal-header"});goog.dom.appendChild(b,a);var c=goog.dom.createDom("button",{type:"button","class":"close","data-dismiss":"modal",innerHTML:"&times;","aria-hidden":"true"});goog.dom.appendChild(a,c);c=goog.dom.createDom("h4",{id:"myModalLabel","class":"modal-title",innerHTML:VK2.Utils.get_I18n_String("report_error_titel")+": "+this._key});goog.dom.appendChild(a,c);a=goog.dom.createDom("div",{"class":"modal-body"});goog.dom.appendChild(b,a);this._textarea=goog.dom.createDom("textarea",{"class":"form-control",
rows:"3"});goog.dom.appendChild(a,this._textarea);a=goog.dom.createDom("div",{"class":"modal-footer"});goog.dom.appendChild(b,a);b=goog.dom.createDom("button",{type:"button","class":"btn btn-default","data-dismiss":"modal",innerHTML:VK2.Utils.get_I18n_String("report_error_btn_cancel")});goog.dom.appendChild(a,b);this._submitBtn=goog.dom.createDom("button",{type:"button","class":"btn btn-primary","data-dismiss":"modal",innerHTML:VK2.Utils.get_I18n_String("report_error_btn_submit")});goog.dom.appendChild(a,
this._submitBtn)};
VK2.Tools.ReportError.prototype._loadClickBehavior=function(){goog.events.listen(this._displayBtn,goog.events.EventType.CLICK,function(a){$(this._dialogContainer).modal({show:!0,keyboard:!0})},void 0,this);goog.events.listen(this._submitBtn,goog.events.EventType.CLICK,function(a){VK2.Utils.sendReport("/vkviewer/report/error?message="+this._textarea.value+"&id="+this._key+"&reference="+this._reference,function(a){alert(VK2.Utils.get_I18n_String("report_error_confirmed"))},function(a){alert(VK2.Utils.get_I18n_String("report_error_alert"))})},void 0,
this)};VK2.Tools.MesstischblattViewer=function(a,b){this._mtbProps={width:0,height:0,zoomify_url:"",extent:[1409871.625,6603406.5,1428422.75,6621075],projection:"EPSG:900913",crossOrigin:"anonymous",full_screen:!0,zoomToMaxExtent:!0,layerSpy:!0,time:"",minResolution:0,opacity_slider:"opacity-slider",maxResolution:76.43702827453613};goog.object.extend(this._mtbProps,b);this._borderLayer=this._createBorderLayer(this._mtbProps.extent);this._baseLayer=new ol.layer.Tile({source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,
...
renderer:"canvas",target:a,view:new ol.View2D({projection:this._mtbProps.projection,minResolution:2*this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution/2,extent:this._mtbProps.extent,center:VK2.Utils.getCenterPointForExtent(this._mtbProps.extent),zoom:1}),controls:[new ol.control.Attribution,new ol.control.Zoom,new ol3.control.RotateNorth]});this._loadControls()};
VK2.Tools.MesstischblattViewer.prototype._loadControls=function(){this._mtbProps.full_screen&&this._map.addControl(new ol.control.FullScreen);this._mtbProps.zoomToMaxExtent&&this._map.addControl(new ol.control.ZoomToExtent({extent:this._mtbProps.extent}));this._mtbProps.layerSpy&&this._map.addControl(new ol3.control.LayerSpy({spyLayer:new ol.layer.Tile({attribution:void 0,source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution})}));if(this._mtbProps.opacity_slider&&
goog.isDef(goog.dom.getElement(this._mtbProps.opacity_slider))){var a=goog.dom.getElement(this._mtbProps.opacity_slider),b=this;$(a).slider({min:0,max:100,value:100,animate:"slow",orientation:"horizontal",step:1,start:function(a,b){$(this.parentElement).find(".tooltip").fadeIn("fast")},slide:function(a,d){$(this.parentElement).find(".tooltip").find(".tooltip-inner").html("Transparency "+d.value);b._mtbLayer.setOpacity(d.value/100)},stop:function(a,b){$(this.parentElement).find(".tooltip").fadeOut("fast")}})}};
...
"display","block")},afterClose:function(){goog.style.setStyle(this.parentEl,"display","none");this.parentObj._clearHtmlContent();this.parentObj=null;delete this.parentObj}}).click()};VK2.Tools.MetadataVisualizer.prototype.displayCswIsoRecord=function(a){a=a.parsed_content;this._setPageTitle(a.TITEL[0]);this._displayMetadata(a)};VK2.Tools.MetadataVisualizer.prototype._setPageTitle=function(a){goog.dom.getElement("singlemapview-title").innerHTML=a};
VK2.Tools.MetadataVisualizer.prototype._displayMetadata=function(a){var b=goog.dom.createDom("div",{"class":"container"});goog.dom.appendChild(this._parentEl,b);var c=goog.dom.createDom("div",{"class":"row-metadata"});goog.dom.appendChild(b,c);b=goog.dom.createDom("div",{"class":"col-md-8 col-lg-8 metdata-col"});goog.dom.appendChild(c,b);var d=goog.dom.createDom("div",{"class":"col-md-4 col-lg-4 thumbnail-col"});goog.dom.appendChild(c,d);this._setTitle(b,a.ABSTRACT[0],VK2.Utils.Settings.geonetwork+
a.ID[0]);this._setThumbnail(d,a.THUMBNAIL[0]);this._setCatchwords(b,VK2.Utils.get_I18n_String("mdrecord_keyword"),"Messtischbl\u00e4tter Messtischblatt");this._setLanguage(b,VK2.Utils.get_I18n_String("mdrecord_language"),"German");for(c=0;c<a.REFERENCE_SYSTEM.length;c++)this._setCrsIdentifier(b,VK2.Utils.get_I18n_String("mdrecord_referencesystem"),a.REFERENCE_SYSTEM[c]);for(c=0;c<a.ONLINE_RESSOURCE.length;c++)this._setOnlineRessource(b,VK2.Utils.get_I18n_String("mdrecord_onlineresource"),a.ONLINE_RESSOURCE[c]);
this._setResolution(b,VK2.Utils.get_I18n_String("mdrecord_spatialresolution"),a.DENOMINATOR[0]);this._setUniqueId(b,a.ID[0])};VK2.Tools.MetadataVisualizer.prototype._setTitle=function(a,b,c){var d=goog.dom.createDom("div",{"class":"description"});goog.dom.appendChild(a,d);a=goog.dom.createDom("h3",{innerHTML:b});goog.dom.appendChild(d,a);c=goog.dom.createDom("a",{href:c,innerHTML:VK2.Utils.get_I18n_String("mdrecord_moremetadata"),target:"_blank"});goog.dom.appendChild(d,c)};
VK2.Tools.MetadataVisualizer.prototype._setThumbnail=function(a,b){var c=goog.dom.createDom("img",{"class":"thumbnail",src:b});goog.dom.appendChild(a,c)};VK2.Tools.MetadataVisualizer.prototype._setCatchwords=function(a,b,c){a=this._createMetadataRow(a);b=goog.dom.createDom("div",{"class":"label",innerHTML:b});goog.dom.appendChild(a,b);c=goog.dom.createDom("div",{innerHTML:c});goog.dom.appendChild(a,c)};
VK2.Tools.MetadataVisualizer.prototype._setLanguage=function(a,b,c){a=this._createMetadataRow(a);b=goog.dom.createDom("div",{"class":"label",innerHTML:b});goog.dom.appendChild(a,b);c=goog.dom.createDom("div",{innerHTML:c});goog.dom.appendChild(a,c)};
VK2.Tools.MetadataVisualizer.prototype._setCrsIdentifier=function(a,b,c){a=this._createMetadataRow(a);b=goog.dom.createDom("div",{"class":"label",innerHTML:b});goog.dom.appendChild(a,b);c=goog.dom.createDom("div",{innerHTML:c});goog.dom.appendChild(a,c)};
VK2.Tools.MetadataVisualizer.prototype._setOnlineRessource=function(a,b,c){a=this._createMetadataRow(a);b=goog.dom.createDom("div",{"class":"label",innerHTML:b});goog.dom.appendChild(a,b);b=goog.dom.createDom("div");goog.dom.appendChild(a,b);url=new goog.Uri(c);url.setQuery("");c=goog.dom.createDom("a",{target:"_blank",href:c,innerHTML:url.toString()});goog.dom.appendChild(b,c)};
VK2.Tools.MetadataVisualizer.prototype._setResolution=function(a,b,c){a=this._createMetadataRow(a);b=goog.dom.createDom("div",{"class":"label",innerHTML:b});goog.dom.appendChild(a,b);b=goog.dom.createDom("div");goog.dom.appendChild(a,b);a=goog.dom.createDom("label",{innerHTML:"Denominator"});goog.dom.appendChild(b,a);c=goog.dom.createDom("span",{innerHTML:c});goog.dom.appendChild(b,c)};
VK2.Tools.MetadataVisualizer.prototype._setUniqueId=function(a,b){var c=goog.dom.createDom("span",{"class":"unique-id",innerHTML:VK2.Utils.get_I18n_String("mdrecord_uniqueid")+" | "+b});goog.dom.appendChild(a,c)};VK2.Tools.MetadataVisualizer.prototype._createMetadataRow=function(a){var b=goog.dom.createDom("div",{"class":"metadata-content-row"});goog.dom.appendChild(a,b);return b};VK2.Tools.ResetGeoreferenceParameter=function(a,b){this._anchor_element=goog.dom.getElement(a);this._key=b;this._loadHtmlContent();this._loadClickBehavior()};
VK2.Tools.ResetGeoreferenceParameter.prototype._loadHtmlContent=function(){this._dialogContainer=goog.dom.createDom("div",{id:"myModal","class":"modal fade",tabindex:"-1",role:"dialog","aria-labelledby":"myModalLabel","aria-hidden":"true"});var a=goog.dom.createDom("div",{"class":"modal-dialog"});goog.dom.appendChild(this._dialogContainer,a);var b=goog.dom.createDom("div",{"class":"modal-content"});goog.dom.appendChild(a,b);a=goog.dom.createDom("div",{"class":"modal-header"});goog.dom.appendChild(b,
a);var c=goog.dom.createDom("button",{type:"button","class":"close","data-dismiss":"modal",innerHTML:"&times;","aria-hidden":"true"});goog.dom.appendChild(a,c);c=goog.dom.createDom("h4",{id:"myModalLabel","class":"modal-title",innerHTML:"VORSICHT - Zur\u00fccksetzen der Georeferenzierungsparameter f\u00fcr Messtischblatt "+this._key});goog.dom.appendChild(a,c);a=goog.dom.createDom("div",{"class":"modal-body"});goog.dom.appendChild(b,a);c=goog.dom.createDom("p",{"class":"bg-danger text-danger",innerHTML:"Sind sie sicher das Sie die Georeferenzierung-Parameter f\u00fcr dieses Messtischblatt zur\u00fccksetzen wollen? Dieser Prozess kann nicht R\u00fcckg\u00e4ngig gemacht werden."});
goog.dom.appendChild(a,c);a=goog.dom.createDom("div",{"class":"modal-footer"});goog.dom.appendChild(b,a);b=goog.dom.createDom("button",{type:"button","class":"btn btn-default","data-dismiss":"modal",innerHTML:VK2.Utils.get_I18n_String("report_error_btn_cancel")});goog.dom.appendChild(a,b);this._submitBtn=goog.dom.createDom("button",{type:"button","class":"btn btn-primary","data-dismiss":"modal",innerHTML:VK2.Utils.get_I18n_String("report_error_btn_submit")});goog.dom.appendChild(a,this._submitBtn)};
VK2.Tools.ResetGeoreferenceParameter.prototype._loadClickBehavior=function(){goog.events.listen(this._anchor_element,goog.events.EventType.CLICK,function(a){$(this._dialogContainer).modal({show:!0,keyboard:!0})},void 0,this);goog.events.listen(this._submitBtn,goog.events.EventType.CLICK,function(a){var b=this._key;VK2.Utils.sendReport("/vkviewer/report/resetgeorefparameters?mtbid="+b,function(a){alert("Georeferenzierung Parameter f\u00fcr das Messtischblatt mit der ID "+b+" wurden zur\u00fcckgesetzt.")},
function(a){alert("Die Georeferenzierungsparameter f\u00fcr das Messtischblatt mit der ID "+b+" konnten nicht zur\u00fcckgesetzt werden.")})},void 0,this)};goog.dom.xml={};goog.dom.xml.MAX_XML_SIZE_KB=2048;goog.dom.xml.MAX_ELEMENT_DEPTH=256;
...
goog.dom.xml.setAttributes=function(a,b){for(var c in b)b.hasOwnProperty(c)&&a.setAttribute(c,b[c])};goog.dom.xml.createMsXmlDocument_=function(){var a=new ActiveXObject("MSXML2.DOMDocument");if(a){a.resolveExternals=!1;a.validateOnParse=!1;try{a.setProperty("ProhibitDTD",!0),a.setProperty("MaxXMLSize",goog.dom.xml.MAX_XML_SIZE_KB),a.setProperty("MaxElementDepth",goog.dom.xml.MAX_ELEMENT_DEPTH)}catch(b){}}return a};VK2.Tools.ZoomifyViewer=function(a,b,c,d){this._parentElement=goog.dom.getElement(a);this._mapContainer=a;this._zoomifyServerPath=b;this._loadZoomifyMap(b,c,d)};
VK2.Tools.ZoomifyViewer.prototype._loadZoomifyMap=function(a,b,c){var d=[b/2,-c/2],e=[0,0,b,c];goog.isDef(this._zoomifyLayer)&&goog.isDef(this._map)?(this._map.removeLayer(this._zoomifyLayer),this._zoomifyLayer=new ol.layer.Tile({source:new ol.source.Zoomify({url:a,size:[b,c]})}),this._map.addLayer(this._zoomifyLayer)):(e=new ol.proj.Projection({code:"ZOOMIFY",units:"pixels",extent:e}),this._zoomifyLayer=new ol.layer.Tile({source:new ol.source.Zoomify({url:a,size:[b,c]})}),this._map=new ol.Map({layers:[this._zoomifyLayer],
interactions:ol.interaction.defaults().extend([new ol.interaction.DragZoom]),controls:[new ol.control.FullScreen,new ol.control.Zoom],renderer:"canvas",target:this._mapContainer,view:new ol.View2D({projection:e,center:d,zoom:2,maxZoom:10})}))};
VK2.Tools.ZoomifyViewer.prototype._loadZoomifyLayer=function(a){var b="/vkviewer/proxy/?url="+a+"/ImageProperties.xml",c=new goog.net.XhrIo;goog.events.listenOnce(c,"success",function(b){b=b.target;var c=b.getResponseXml().childNodes[0];this._loadZoomifyMap(a+"/",c.getAttribute("WIDTH"),c.getAttribute("HEIGHT"));b.dispose()},!1,this);goog.events.listenOnce(c,"error",function(a){goog.isDef(error_callback)&&error_callback(a)},!1,this);c.send(b)};VK2.Tools.ZoomifyViewer.prototype.getMap=function(){return this._map};VK2.Tools.TimestampSwitcher=function(a,b){var c="/vkviewer/gettimestampsforid?id="+b,d=new goog.net.XhrIo;goog.events.listenOnce(d,"success",function(b){b=b.target;var c=b.getResponseJson()?b.getResponseJson():"";b.dispose();b=goog.dom.getElement(a);b.innerHTML="";var d=c.maps.length,h=goog.dom.createDom("li",{"class":"dropdown-header",innerHTML:d+" "+VK2.Utils.get_I18n_String("timestamps")});goog.dom.appendChild(b,h);for(var k=0;k<d;k++){var l=goog.dom.createDom("li",{});goog.dom.appendChild(b,l);
h=goog.dom.createDom("a",{href:"/vkviewer/profile/mtb?extent="+c.maps[k].extent+"&time="+c.maps[k].time+"&id="+c.maps[k].id,innerHTML:c.maps[k].time});goog.dom.appendChild(l,h)}c=goog.dom.createDom("li",{"class":"divider"});goog.dom.appendChild(b,c);c=goog.dom.createDom("li",{});goog.dom.appendChild(b,c);h=goog.dom.createDom("a",{href:"#",innerHTML:d+" "+VK2.Utils.get_I18n_String("found_timestamp")});goog.dom.appendChild(c,h)});goog.events.listenOnce(d,"error",function(a){console.log("Error whily trying to fetch data from server ...")});
d.send(c)};VK2.Tools.SingleMapViewer=function(a){this._settings={reset_georef_id:"reset-georef-map",map_id:null,tab_list_id:"singlemapview-tab-list",georef_map_container_id:"map-container",opacity_slider_id:"opacity-slider",str_extent:"",time:null,metadata_container:"metadata-container",metadata_key:null,zoomify_container:"zoomify-container",zoomify_url:null,zoomify_width:null,zoomify_height:null,timestamp_chooser_list:"timestamp-chooser"};goog.object.extend(this._settings,a);a=this._settings.str_extent;a=a.split(",");
for(var b=[],c=0;c<a.length;c++)b.push(parseFloat(a[c]));var d=new VK2.Tools.MesstischblattViewer(this._settings.georef_map_container_id,{time:this._settings.time,extent:b,opacity_slider:this._settings.opacity_slider_id});new VK2.Tools.MetadataVisualizer(this._settings.metadata_container,this._settings.metadata_key,{csw_url:VK2.Utils.Settings.csw_url});goog.dom.getElement(this._settings.reset_georef_id)&&new VK2.Tools.ResetGeoreferenceParameter(this._settings.reset_georef_id,this._settings.map_id);
var e=new VK2.Tools.ZoomifyViewer(this._settings.zoomify_container,this._settings.zoomify_url,this._settings.zoomify_width,this._settings.zoomify_height);this._zoomifyViewer=e;$("#"+this._settings.tab_list_id+" a").click(function(a){a.preventDefault();$(this).tab("show");a=(new goog.Uri(this.href)).getFragment();"georef-view"==a?d.getMap().updateSize():"original-view"==a&&e.getMap().updateSize()});goog.dom.getElement(this._settings.timestamp_chooser_list)&&VK2.Tools.TimestampSwitcher(this._settings.timestamp_chooser_list,
this._settings.map_id)};VK2.Tools.SingleMapViewer.prototype.getZoomifyViewer=function(){return this._zoomifyViewer};VK2.Requests={};VK2.Requests.Georeferencer={};VK2.Requests.Georeferencer.submit=function(a,b,c,d){goog.isDef(a)&&goog.isDef(b)?console.log("Pure submit."):goog.isDef(a)&&goog.isDef(c)&&console.log("Submit validation.")};VK2.Requests.Georeferencer.validate=function(a,b,c,d,e){this._sendRequest(a+"?mtbid="+b+"&points="+c,d,e)};
VK2.Requests.Georeferencer.submit=function(a,b,c,d,e,f){goog.isDef(c)?this._sendRequest(a+"?mtbid="+b+"&points="+c,e,f):goog.isDef(d)&&(a=a+"?mtbid="+b+"&georefid="+d,this._sendRequest(a,e,f))};VK2.Requests.Georeferencer.getExtentForWMS=function(a,b,c){this._sendRequest(a+"&VERSION=1.1.1&SERVICE=WMS&REQUEST=GetCapabilities",b,c)};
VK2.Requests.Georeferencer._sendRequest=function(a,b,c){var d=new goog.net.XhrIo;goog.events.listenOnce(d,"success",function(a){a=a.target;var c=a.getResponseText()?a.getResponseText():"";a.dispose();goog.isDef(b)&&b(c)},!1,this);goog.events.listenOnce(d,"error",function(a){goog.isDef(c)&&c(a)},!1,this);d.send(a)};VK2.Requests.CSW_GetRecordById=function(){goog.events.EventTarget.call(this)};goog.inherits(VK2.Requests.CSW_GetRecordById,goog.events.EventTarget);VK2.Requests.CSW_GetRecordById._parentElement="gmd:MD_Metadata";
