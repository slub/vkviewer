...
VK2.Controller.MapSearchController.prototype._addRowClickBehavior=function(a,b){var c=this._ftLayer;goog.events.listen(a,goog.events.EventType.CLICK,function(a){if(goog.dom.classes.has(a.target,"anchor-show-metadata")){goog.isDefAndNotNull(goog.dom.getElement("metadata-record-parent"))||(a=goog.dom.createDom("div",{"class":"metadata-record",id:"metadata-record-parent"}),goog.dom.appendChild(document.body,a));a=b.geometry.bounds.left+","+b.geometry.bounds.bottom+","+b.geometry.bounds.right+","+b.geometry.bounds.top;
var e=goog.dom.createDom("a",{href:"/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+a+"&time="+b.data.time});goog.dom.appendChild(document.body,e);$(e).fancybox({type:"iframe",href:"/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+a+"&time="+b.data.time,width:"100%",height:"100%"}).trigger("click")}else a=b.geometry.getCentroid(),e=4<c.map.getZoom()?c.map.getZoom():4,c.map.setCenter(new OpenLayers.LonLat(a.x,a.y),e),goog.dom.getElement("spatialsearch-tools-input-layer").value=b.data.time,
this._table.setLastFocusRow(b.data.mtbid)},void 0,this)};VK2.Controller.MapSearchController.prototype._addRowHoverBehavior=function(a,b){var c=this._ftLayer,d=this._hoverLayer;$(a).hover(function(a){$(this).hasClass("hover-table")||($(this).addClass("hover-table"),d.updateGeometry(b.geometry))},function(a){$(this).hasClass("hover-table")&&($(this).removeClass("hover-table"),d.removeAllFeatures(),c.drawFeature(b))})};
...
VK2.Tools.SearchTable.prototype.refreshData=function(a){goog.dom.removeChildren(this._tableBody);var b=0;for(key in a){b++;for(var c=goog.dom.createDom("tr",{id:key,"class":"data-row"}),d=0;d<this._columnIds.length;d++){var e="titel"==this._columnIds[d]&&a[key].csw_id?this._createMetadataCol(this._columnIds[d],a[key][this._columnIds[d]],a[key].csw_id):goog.dom.createDom("td",{"class":"data-col-"+this._columnIds[d]+" col-"+this._columnIds[d],innerHTML:a[key][this._columnIds[d]]});goog.dom.appendChild(c,
e)}this._controller.addRowBehavior(c,a[key].feature);goog.dom.appendChild(this._tableBody,c)}$(document.getElementById(this.tableId)).trigger("update");VK2.Utils.initializeFancyboxForClass(this._mdFancyBoxClass)};VK2.Tools.SearchTable.prototype.setLastFocusRow=function(a){this._lastFocus=a};VK2.Tools.SpatialSearch=function(a,b,c){this.NAME=VK2.Utils.get_I18n_String("toolname_layersearch");this._timeParams={extent:null,time:null,wms:"http://194.95.145.43/mapcache",wms_layer:"messtischblaetter",wfs:"http://194.95.145.43/cgi-bin/mtbows",layer:"Historische Messtischblaetter",featureType:"Historische_Messtischblaetter_WFS",featurePrefix:"ms",featureNS:"http://mapserver.gis.umn.edu/mapserver",geometryName:"boundingbox",serviceVersion:"1.0.0",maxFeatures:1E4,srsName:"EPSG:900913",maxResolution:305.74811309814453};
