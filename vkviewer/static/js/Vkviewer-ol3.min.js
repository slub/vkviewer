...
VK2.Tools.MetadataVisualizer.prototype._clearHtmlContent=function(){goog.dom.removeChildren(this._parentEl);goog.dom.removeNode(this._parentEl)};VK2.Tools.ResetGeoreferenceParameter=function(a,b){this._anchor_element=a;this._key=b;this._loadHtmlContent();this._loadClickBehavior()};
...
function(a){alert("Die Georeferenzierungsparameter f\u00fcr das Messtischblatt mit der ID "+b+" konnten nicht zur\u00fcckgesetzt werden.")})},void 0,this)};VK2.Requests={};VK2.Requests.Georeferencer={};VK2.Requests.Georeferencer.submit=function(a,b,c,d){goog.isDef(a)&&goog.isDef(b)?console.log("Pure submit."):goog.isDef(a)&&goog.isDef(c)&&console.log("Submit validation.")};VK2.Requests.Georeferencer.validate=function(a,b,c,d,e){this._sendRequest(a+"?mtbid="+b+"&points="+c,d,e)};
