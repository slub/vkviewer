...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};goog.userAgent={};goog.userAgent.ASSUME_IE=!1;goog.userAgent.ASSUME_GECKO=!1;goog.userAgent.ASSUME_WEBKIT=!1;goog.userAgent.ASSUME_MOBILE_WEBKIT=!1;goog.userAgent.ASSUME_OPERA=!1;goog.userAgent.ASSUME_ANY_VERSION=!1;goog.userAgent.BROWSER_KNOWN_=goog.userAgent.ASSUME_IE||goog.userAgent.ASSUME_GECKO||goog.userAgent.ASSUME_MOBILE_WEBKIT||goog.userAgent.ASSUME_WEBKIT||goog.userAgent.ASSUME_OPERA;
...
$("#"+this._settings.formClassEl.textArea).val("");$("#"+this._settings.formClassEl.dialogContainer).dialog("option","title",VK2.Utils.get_I18n_String("report_error_titel")+": "+a).dialog("open")}});VK2.Tools.Georeferencer=VK2.Class({_settings:{urlParams:null,container:"vk2GeoreferenceToolsPanel",handler:"vk2GeoreferenceToolsHandle",map:null,controller:VK2.Controller.GeoreferenceController,vectorLayer:null,status:"georeference"},_loadHTMLContent:function(){var a=$("<div/>",{"class":"GeoreferenceToolsContent"}).appendTo("#vk2GeoreferenceToolsPanel"),a=$("<ul/>",{id:"controlsList","class":"controlsList"}).appendTo(a),b=$("<li/>").appendTo(a);$("<input/>",{type:"radio",name:"type",value:"none",
