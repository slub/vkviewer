	...
	<div class="georeference-start page-container full-display">
		<div class="vk2GeoreferenceMtbStartPage">
			<div id="georeferenceMap" class="georeferenceMap">
				...
				<!-- testing purpose -->
				<div class="georeference-tools-container" id="georeference-tools-container">
					<div class="radio">
						<label>
							<input type="radio" class="toggle-elements" name="type" value="" id="noneToggle">
							<span>Karte verschieben</span>
						</label>
					</div>
					<div class="radio">
						<label>
							<input type="radio" class="toggle-elements" name="type" value="addpoint" id="pointToggle">
							<span>Eckpunkte setzen</span>
						</label>
					</div>
					<div class="radio">
						<label>
							<input type="radio" class="toggle-elements" name="type" value="dragpoint" id="dragToggle">
...
<%block name="js_content">
    ...
    <script>
		...
		$(document).ready(function(){
			...
			var georeferencer = new Dev.VK2.Tools.Georeferencer('georeferenceMap',{
				'width': imgWidth,
				'height': imgHeight,
				'url': zoomify_url,
				'zoomify': true
