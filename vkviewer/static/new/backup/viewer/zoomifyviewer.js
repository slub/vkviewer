goog.provide('VK2.Viewer.Zoomify');
 ...
 */
VK2.Viewer.Zoomify = function(map_div, zoomify_url, zoomify_width, zoomify_height){
 ...
 * @private
 */
VK2.Viewer.Zoomify.prototype._loadZoomifyMap = function(zoomify_url, width, height){
 ...
 * @private
 */
VK2.Viewer.Zoomify.prototype._loadZoomifyLayer = function(zoomifyUrl){
 ...
 * @return {ol.Map}
 */
VK2.Viewer.Zoomify.prototype.getMap = function(){
	return this._map;
}