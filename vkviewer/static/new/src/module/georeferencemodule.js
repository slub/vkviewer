goog.provide('VK2.Module.GeoreferencerModule');
 ...
 * @constructor
 */
VK2.Module.GeoreferencerModule = function(mapContainerId, objectId, settings){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadGeorefParams = function(source, georef_params){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadToolbox = function(){
 ...
 * @return {Element}
 */
VK2.Module.GeoreferencerModule.prototype._loadLoadingScreenHtmlContent = function(){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadOpenCloseBehavior = function(controlElement){
 ...
 * @return {Element}
 */
VK2.Module.GeoreferencerModule.prototype._loadToolHtmlContent = function(){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadZoomifyLayer = function(){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadGeoreferenceControls = function(){
...
VK2.Module.GeoreferencerModule.prototype._loadButtonEvents = function(){
 ...
 */
VK2.Module.GeoreferencerModule.prototype._validateGeorefParams = function(){
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._loadToggleControls = function(map, drawSource){
...
//			    	}
			...
			'deletepoint': [
			   new VK2.Interaction.DeleteFeature({
			      	'source': drawSource,
			    	pixelTolerance: 5				   
			   }, drawSource)
			]
 ...
 * @private
 */
VK2.Module.GeoreferencerModule.prototype._removeInteractions = function(interactions, map){
