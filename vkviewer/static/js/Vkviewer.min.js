...
VK2.Utils.jumptolonlat(b,a.coordinates[0],a.coordinates[1],12)):alert(VK2.Utils.get_I18n_String("noResultsBlattnr"))},this)})):$.ajax({url:"http://open.mapquestapi.com/nominatim/v1/search.php",dataType:"json",data:{featureClass:"P",style:"full",maxRows:8,format:"json",q:a.term,viewbox:"4.35,58.48,27.78,45.97",bounded:1},success:function(a){c($.map(a,function(a){return{label:a.display_name,value:a.display_name,lonlat:new OpenLayers.LonLat(a.lon,a.lat),type:a.type}}))}})},delay:500,minLength:3,autoFocus:!0,
