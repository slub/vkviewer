...
goog.style.getCssTranslation=function(a){var b;goog.userAgent.IE?b="-ms-transform":goog.userAgent.WEBKIT?b="-webkit-transform":goog.userAgent.OPERA?b="-o-transform":goog.userAgent.GECKO&&(b="-moz-transform");var c;b&&(c=goog.style.getStyle_(a,b));c||(c=goog.style.getStyle_(a,"transform"));return c?(a=c.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});VK2.Utils={};VK2.Utils.initializeFancyboxForClass=function(a){for(var b=goog.dom.getElementsByClass(a),c=0;c<b.length;c++){var d=b[c];a="vk2-fancybox-wrapper";goog.isDefAndNotNull(b[c].getAttribute("data-fancyclass"))&&(a+=" "+b[c].getAttribute("data-fancyclass")+"-page-container");$(d).fancybox({type:"iframe",autoSize:!1,wrapCSS:a})}};VK2.Utils.loadBaseMap=function(a,b,c){a=new OpenLayers.Map(a,b);c=new OpenLayers.Layer.OSM("Mapnik","",c);a.addLayers([c]);a.setCenter(b.startPoint,2);return a};
VK2.Utils.setGenericOpenLayersPropertys=function(a){OpenLayers.IMAGE_RELOAD_ATTEMPTS=5;OpenLayers.ProxyHost=VK2.Utils.getHost(a)};VK2.Utils.jumptolonlat=function(a,b,c,d){b=(new OpenLayers.LonLat(b,c)).transform(new OpenLayers.Projection("EPSG:4326"),a.getProjectionObject());goog.isDef(d)?a.setCenter(b,d):a.setCenter(b,12);return!0};
...
VK2.Utils.AppLoader.prototype._loadEventBehavior=function(){VK2.Utils.initializeFancyboxForClass("fancybox-open");goog.dom.getElement("vk2WelcomePage")&&$("#vk2WelcomePage").fancybox({type:"iframe",padding:0,wrapCSS:"welcomeBox"}).click()};VK2.Utils.AppLoader.prototype._checkIfCookiesAreEnabble=function(){goog.net.cookies.isEnabled()?console.log("Cookies are enabled"):alert("This page needs cookies for correct behavior. So please activate them in your browser.")};
VK2.Utils.AppLoader.prototype.loadApplication=function(){this._checkIfCookiesAreEnabble();this._loadOLMap();this._loadEventBehavior();this._loadVK2Tools()};VK2.Utils.AppLoader.prototype.loadApplicationWithGeoref=function(){this.loadApplication();this._loadGeoreferencerChooser()};VK2.Utils.Settings={};VK2.Utils.Settings.DOM={};VK2.Utils.Settings.proxy_url="/vkviewer/proxy/?url=";VK2.Utils.Settings.geonetwork="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/search#|";VK2.Utils.Settings.csw_url="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/csw";
VK2.Utils.Settings.timeWmsWfsOptions={extent:null,time:null,wms:"http://194.95.145.43/mapcache",wms_layer:"messtischblaetter",wfs:"http://194.95.145.43/cgi-bin/mtbows",layer:"Historische Messtischblaetter",featureType:"Historische_Messtischblaetter_WFS",featurePrefix:"ms",featureNS:"http://mapserver.gis.umn.edu/mapserver",geometryName:"boundingbox",serviceVersion:"1.0.0",maxFeatures:1E4,srsName:"EPSG:900913",maxResolution:305.74811309814453};VK2.Utils.Settings.DOM.idControlGeorefChooser="vk2GeorefControl";
VK2.Utils.Settings.DOM.idControlSearchMap="vk2LayersearchControl";VK2.Styles={};VK2.Styles.FeatureLayerStyles={};VK2.Styles.FeatureLayerStyles._defaultStyle={fillColor:"#ee9900",fillOpacity:"0"};VK2.Styles.FeatureLayerStyles._tmpStyle={fillColor:"#FF5500",fillOpacity:"0.4",strokeColor:"#FF0000",labelAlign:"cc",fontColor:"#000000",fontOpacity:1,fontFamily:"Arial",fontSize:16,fontWeight:"600"};VK2.Styles.FeatureLayerStyles._defaultStyleMap=new OpenLayers.StyleMap({fillColor:"#ee9900",fillOpacity:"0"});
VK2.Styles.FeatureLayerStyles._georeferenceLayerStyles=new OpenLayers.StyleMap({"default":new OpenLayers.Style({pointRadius:6,strokeColor:"#ff6103",fillColor:"#FF0000",fillOpacity:0.4,strokeWidth:2})});var Mediator=function(){var a=function(a,b){Mediator.channels[a]||(Mediator.channels[a]=[]);Mediator.channels[a].push({context:this,callback:b});return this},b=function(a){if(!Mediator.channels[a])return!1;for(var b=Array.prototype.slice.call(arguments,1),e=0,f=Mediator.channels[a].length;e<f;e++){var g=Mediator.channels[a][e];g.callback.apply(g.context,b)}return this};return{channels:{},publish:b,subscribe:a,installTo:function(c){c.subscribe=a;c.publish=b}}}();VK2.Controller.MapController=function(){var a=null,b=[new OpenLayers.Control.Navigation],c={moveend:function(){var a={centerPoint:this.getCenter(),extent:this.getExtent(),zoom:this.getZoom()};VK2.Controller.MapController.publish("mapmove",a)}},d={addtimelayer:function(a){a=new VK2.Layer.Vk2Layer(a);VK2.Controller.MapController.addTimeLayer(a)}},e={};return{initialize:function(f,g){a=f;for(var h in g)e[h]=g[h];for(h=0;h<b.length;h++)a.addControl(b[h]);for(var k in c)a.events.register(k,a,c[k]);for(var l in d)VK2.Controller.MapController.subscribe(l,
d[l])},getMap:function(){return a},setMap:function(b){a=b},addTimeLayer:function(a){"vk2layermanagement"in e?e.vk2layermanagement.addLayer(a):console.log("VK2.Controller.MapController can not identifier the Vk2LayerManagement tool!")},activateTimeFeatureControl:function(){for(var b=0;b<e.length;b++)e[b].deactivate(a);e.vk2timefeaturecontrols.activate(a)}}}();Mediator.installTo(VK2.Controller.MapController);VK2.Controller.TimeFeatureControls=function(){var a=!1,b=[],c=[],d=function(){c=[];var a=new OpenLayers.Control.SelectFeature(b,{clickout:!0,onSelect:$.proxy(function(a){var b=a.data.original;$.fancybox.open([{href:b,title:'<a target="_blank" href="'+b+'">Download Karte</a> |       <a target="_blank" href="'+a.data.permalink+'">Gehe zu Kartenforum</a>'}]);c[0].unselect(a)},this)});c.push(a)},e=function(){if(a)for(var d=0;d<c.length;d++)c[d].setLayer(b)};return{addLayerToControls:function(a){b.push(a);
e()},removeLayerFromControls:function(a){a=b.indexOf(a);b.splice(a,1);e()},activate:function(b){d();for(var e=0;e<c.length;e++)b.addControl(c[e]),c[e].activate(),VK2.Utils.fixControlConflictsOnOLMap(c[e]);a=!0},deactivate:function(b){for(var d=0;d<c.length;d++)c[d].deactivate(),b.removeControl(c[d]);a=!1}}}();VK2.Controller.SidebarController=function(a,b){this._settings={speed:300,panelLocation:"right",sidebarPanel:"vk2SBPanel",sidebarHeaderLabel:"vk2SBHeaderLabel",sidebarContentPanel:"vk2SBContentPanel",sidebarPanelWidth:300,sidebarCloseBtn:"vk2SBClose"};goog.object.extend(this._settings,a);this._sidebar=$(goog.dom.getElement(this._settings.sidebarPanel));this._mapController=b;this._controls=[];this._controlElements=[];this._loadCloseBehavior()};
...
VK2.Controller.SidebarController.prototype._slideOut=function(){goog.style.setStyle(goog.dom.getElement(this._settings.sidebarContentPanel),"display","block");"right"==this._settings.panelLocation&&this._sidebar.animate({right:"-3px"},this._settings.speed).addClass("open")};VK2.Controller.MapSearchController=function(a,b,c){this._map=a;this._ftLayer=b;this._hoverLayer=c};VK2.Controller.MapSearchController.prototype.registerSearchTable=function(a){this._table=a};VK2.Controller.MapSearchController.prototype.registerMinimizeMesstischblattView=function(a){this._minimizeMtbView=a};VK2.Controller.MapSearchController.prototype.addRowBehavior=function(a,b){this._addRowClickBehavior(a,b);this._addRowHoverBehavior(a,b)};
VK2.Controller.MapSearchController.prototype._addRowClickBehavior=function(a,b){var c=this._ftLayer;goog.events.listen(a,goog.events.EventType.CLICK,function(a){a=b.geometry.getCentroid();var e=4<c.map.getZoom()?c.map.getZoom():4;c.map.setCenter(new OpenLayers.LonLat(a.x,a.y),e);a=[];for(e=0;e<c.features.length;e++)b.bounds.containsBounds(c.features[e].bounds)&&a.push(c.features[e]);goog.isDef(this._minimizeMtbView)&&this._minimizeMtbView.updateView(a)},void 0,this)};
...
VK2.Controller.MapSearchController.prototype.registerFeatureLayerBehavior=function(a){this._ftLoadingCbEl=a;this._ftLayer.events.register("loadstart",this,this._featureLoadingFeedback);this._ftLayer.events.register("loadend",this,this._featureLoadingFeedback);this._ftLayer.events.register("featuresadded",this,this._updateDisplayedFeatureData);this._map.events.register("moveend",this,this._updateLayerFeatures)};
VK2.Controller.MapSearchController.prototype.unregisterFeatureLayerBehavior=function(){this._ftLayer.events.unregister("loadstart",this,this._featureLoadingFeedback);this._ftLayer.events.unregister("loadend",this,this._featureLoadingFeedback);this._ftLayer.events.unregister("featuresadded",this,this._updateDisplayedFeatureData);this._map.events.unregister("moveend",this,this._updateLayerFeatures)};
VK2.Controller.MapSearchController.prototype._updateLayerFeatures=function(a){this._map.getResolution()<=this._ftLayer.maxResolution?this._ftLayer.refreshLayer():(this._updateDisplayedFeatureData(),goog.dom.getElementByClass("content",this._ftLoadingCbEl).innerHTML=VK2.Utils.get_I18n_String("change_zoomlevel"))};
VK2.Controller.MapSearchController.prototype._featureLoadingFeedback=function(a){var b=goog.dom.getElementByClass("loading",this._ftLoadingCbEl);"loadstart"==a.type?goog.dom.classes.add(b,"active"):"loadend"==a.type&&(goog.dom.classes.has(b,"active")&&goog.dom.classes.remove(b,"active"),goog.dom.getElementByClass("content",this._ftLoadingCbEl).innerHTML=this._ftLayer.features.length+" "+VK2.Utils.get_I18n_String("found_mtb"),0==this._ftLayer.features.length&&this._updateDisplayedFeatureData())};
...
console.log("Feature unselected!")},clickout:function(a){alert(VK2.Utils.get_I18n_String("clickout"))}}},_addLayersToMap:function(){this._settings.map.addLayers([this._settings.wmsLayer,this._settings.selectLayer])},_addGetFeaturesControlToMap:function(){this._settings.map.addControl(this._settings.controls.getfeature);this._settings.controls.getfeature.activate()},_removeLayersToMap:function(){this._settings.map.removeLayer(this._settings.wmsLayer);this._settings.map.removeLayer(this._settings.selectLayer)},
_removeGetFeaturesControlToMap:function(){this._settings.map.removeControl(this._settings.controls.getfeature);this._settings.controls.getfeature.deactivate()},_loadOLElements:function(){this._settings.selectLayer=new OpenLayers.Layer.Vector("georeferencer_select_1",{styleMap:new OpenLayers.Style(OpenLayers.Feature.Vector.style.select)});this._settings.controls.getfeature=new OpenLayers.Control.GetFeature({name:"georeferencer_control_1",protocol:this._settings.requestWfs});for(var a in this._settings.eventListeners)this._settings.controls.getfeature.events.register(a,
this,this._settings.eventListeners[a])},_updateSettings:function(a){for(var b in a)this._settings[b]=a[b]},initialize:function(a){this._updateSettings(a);this._loadOLElements()},activate:function(){this._addLayersToMap();this._addGetFeaturesControlToMap()},deactivate:function(){if(null!=this._settings.wmsLayer.map||"undefined"==this._settings.wmsLayer.map)this._removeLayersToMap(),this._removeGetFeaturesControlToMap()}});VK2.Layer.TimeFeatureLayer=function(a,b){this._timeFtLayer=null;this._wfsProtocol=b;this._timeLayer=a;this._refresh=this._actualTimestamp=null;this._eventsOnParentLayer={visibilitychanged:function(a){this.getVisibility()&&"undefined"!==this.timeFtLayer?(this.timeFtLayer.setVisibility(!0),this.timeFtLayer.refresh()):this.getVisibility()||"undefined"===this.timeFtLayer?console.log("No TimeFeatureLayer is registered!"):this.timeFtLayer.setVisibility(!1)},added:function(a){this.getVisibility()&&"undefined"!==
this.timeFtLayer&&(this.timeFtLayer._initializeTimeLayer(this.map),VK2.Controller.TimeFeatureControls.addLayerToControls(this.timeFtLayer.getLayer()))},removed:function(a){goog.isDef(this.timeFtLayer)&&(a=this.timeFtLayer.getLayer(),a.map.removeLayer(a),VK2.Controller.TimeFeatureControls.removeLayerFromControls(a))}};this.lastSelectedFeatures=[];this._initializeParentLayerEvents()};
VK2.Layer.TimeFeatureLayer.prototype._initializeTimeLayer=function(a){this._actualTimestamp=this._timeLayer.params.TIME;this._refresh=new OpenLayers.Strategy.Refresh({force:!0,active:!0});this._timeFtLayer=new OpenLayers.Layer.Vector(OpenLayers.Util.createUniqueID("TimeFeatureLayer_"),{displayInLayerSwitcher:!1,styleMap:VK2.Styles.FeatureLayerStyles._defaultStyleMap,strategies:[new OpenLayers.Strategy.BBOX,this._refresh],protocol:this._wfsProtocol,filter:new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,
property:"time",value:this._actualTimestamp})},{visibility:!0});a.addLayer(this._timeFtLayer)};VK2.Layer.TimeFeatureLayer.prototype._initializeParentLayerEvents=function(){for(var a in this._eventsOnParentLayer)this._timeLayer.events.register(a,this._timeLayer,this._eventsOnParentLayer[a])};
VK2.Layer.TimeFeatureLayer.prototype._updateFilter=function(){this._timeFtLayer.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:"time",value:this._actualTimestamp});this.refresh()};VK2.Layer.TimeFeatureLayer.prototype.getLayer=function(){return this._timeFtLayer};VK2.Layer.TimeFeatureLayer.prototype.updateFeatures=function(){this._timeLayer.params.TIME!=this._timeFtLayer._actualTimestamp&&(this._actualTimestamp=this._timeLayer.params.TIME,this._updateFilter())};
VK2.Layer.TimeFeatureLayer.prototype.setVisibility=function(a){this._timeFtLayer&&this._timeFtLayer.setVisibility(a)};VK2.Layer.TimeFeatureLayer.prototype.refresh=function(){this._timeFtLayer&&(this._refresh.refresh(),this._timeFtLayer.redraw())};VK2.Layer.Vk2Layer=function(a){var b=new OpenLayers.Layer.WMS(a.layer,a.wms,{layers:a.wms_layer,type:"png",format:"image/png",transparent:"true",time:a.time},{isBaseLayer:!1,visibility:!0,projection:new OpenLayers.Projection(a.srsName)});b.timeFtLayer=new VK2.Layer.TimeFeatureLayer(b,new OpenLayers.Protocol.WFS({url:a.wfs,geometryName:a.geometryName,featureNS:a.featureNS,featurePrefix:a.featurePrefix,featureType:a.featureType,srsName:a.srsName,maxFeatures:a.maxFeatures,version:a.serviceVersion}));
...
this.addFeatures([a])};a.activate=function(){if(this.map){var a=this.map,b=a.getLayerIndex(this)+1;a.getNumLayers()>b&&a.setLayerIndex(this,a.getNumLayers()+1);this.setVisibility(!0)}};a.deactivate=function(){this.map&&this.setVisibility(!1)};return a};VK2.Tools.Gazetteersearch=function(a,b,c){this._gazetteerElement=a;goog.isDef(this._gazetteerElement.parentElement)&&(this._parentElement=this._gazetteerElement.parentElement);this._map=b;this._loadGazetteerBehavior(this._gazetteerElement,this._map)};
VK2.Tools.Gazetteersearch.prototype._loadGazetteerBehavior=function(a,b){var c=function(a,c){b.setCenter(a,c);var f=goog.dom.getElement(VK2.Utils.Settings.DOM.idControlSearchMap);0==goog.dom.getElementsByTagNameAndClass("a","open",f.parentElement).length&&f.click()};$(a).autocomplete({source:function(a,c){VK2.Validation.isBlattnumber(a.term)?(c(),$.ajax({url:"/vkviewer/proxy/?url=http://eiger.auf.uni-rostock.de/fgs/vkll/fragblattnr.php?blattnr="+a.term,success:$.proxy(function(a){""!=a?(a=JSON.parse(a),
VK2.Utils.jumptolonlat(b,a.coordinates[0],a.coordinates[1],5)):alert(VK2.Utils.get_I18n_String("noResultsBlattnr"))},this)})):$.ajax({url:"http://open.mapquestapi.com/nominatim/v1/search.php",dataType:"json",data:{featureClass:"P",style:"full",maxRows:8,format:"json",q:a.term,viewbox:"4.35,58.48,27.78,45.97",bounded:1},success:function(a){c($.map(a,function(a){return{label:a.display_name,value:a.display_name,lonlat:new OpenLayers.LonLat(a.lon,a.lat),type:a.type}}))}})},delay:500,minLength:3,autoFocus:!0,
select:function(a,e){switch(e.item.type){case "administrative":c(e.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),4);break;case "city":c(e.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),4);break;case "village":c(e.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),4);default:c(e.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),6)}},open:function(){$(this).removeClass("ui-corner-all").addClass("ui-corner-top")},
close:function(){$(this).removeClass("ui-corner-top").addClass("ui-corner-all")}})};VK2.Tools.Gazetteersearch.prototype._loadSubmitBehavior=function(a,b){var c=goog.dom.getElementsByTagNameAndClass("BUTTON","gazetteer-submit-button",a);goog.isDef(c)&&($(c).click(function(a){$(b).data("ui-autocomplete")._trigger("select")}),console.log("Add submit Button to Gazetteersearch."))};VK2.Tools.GeoreferencerChooser=function(a,b){this._settings={wmsLayer:new OpenLayers.Layer.WMS("georeferencer_wms_1","http://194.95.145.43/cgi-bin/mtb_grid",{layers:"mtb_grid_puzzle",transparent:!0},{isBaseLayer:!1,displayInLayerSwitcher:!0,singleTile:!0}),requestWfs:new OpenLayers.Protocol.WFS({url:"http://194.95.145.43/cgi-bin/mtb_grid",geometryName:"the_geom",featureNS:"http://mapserver.gis.umn.edu/mapserver",featurePrefix:"ms",featureType:"mtb_grid",srsName:"EPSG:3857",maxFeatures:1E3,version:"1.0.0"}),
...
VK2.Tools.GeoreferencerChooser.prototype.deactivate=function(){goog.isDef(this._layerbar)&&this._isActive&&this._layerbar.showOverlayLayers();this._georefLayer.deactivate();this._isActive=!1};VK2.Tools.Layerbar=function(a){this.ascending=!0;goog.isDef(VK2.Utils.get_I18n_String)?this.NAME=VK2.Utils.get_I18n_String("toolname_layerbar"):this.NAME="Layerbar";this._map=a.map;this._div=a.div;this._id=a.id;goog.isDef(a.vk2featurelayer)?this._vk2FeatureLayer=a.vk2featurelayer:this._vk2FeatureLayer=new Vk2FeatureLayer;this.baseLayers=[];this.overlayLayers=[];this.layerStates=[];this.draw()};
...
VK2.Tools.Layerbar.prototype._loadContents=function(){this.layersDiv=goog.dom.createDom("div",{id:this._id+"_layersDiv","class":"layersDiv"});goog.dom.appendChild(this._div,this.layersDiv);var a=goog.dom.createDom("div",{"class":"layerbar-header-container"});this._loadHeaderContent(a);this.overlayLayersDiv=goog.dom.createDom("div",{"class":"overlayDivs"});this.ascending?(goog.dom.appendChild(this.layersDiv,a),goog.dom.appendChild(this.layersDiv,this.overlayLayersDiv)):(goog.dom.appendChild(this.layersDiv,
this.overlayLayersDiv),goog.dom.appendChild(this.layersDiv,a));this._div.appendChild(this.layersDiv)};
VK2.Tools.Layerbar.prototype._loadHeaderContent=function(a){this.vk2DataLayersLbl=goog.dom.createDom("div",{"class":"overlayLbls",innerHTML:"Overlays"});goog.dom.appendChild(a,this.vk2DataLayersLbl);var b=goog.dom.createDom("div",{"class":"add-layer"});goog.dom.appendChild(a,b);goog.events.listen(b,goog.events.EventType.CLICK,function(a){a=goog.object.clone(VK2.Utils.Settings.timeWmsWfsOptions);a.extent=this._map.getExtent();a.time=1912;this.addLayer(new VK2.Layer.Vk2Layer(a))},void 0,this)};
VK2.Tools.Layerbar.prototype.addLayer=function(a){this._map.addLayer(a);this.redraw();return!0};VK2.Tools.Layerbar.prototype.activate=function(){this._vk2FeatureLayer.activate(this._map)};VK2.Tools.Layerbar.prototype.deactivate=function(){this._vk2FeatureLayer.deactivate(this._map)};VK2.Tools.Layerbar.prototype.hideOverlayLayers=function(){for(var a=0;a<this.overlayLayers.length;a++)this.overlayLayers[a].setVisibility(!1)};VK2.Tools.Layerbar.prototype.showOverlayLayers=function(){for(var a=0;a<this.overlayLayers.length;a++)this.overlayLayers[a].setVisibility(!0)};
VK2.Tools.Layerbar.prototype.createLayerControllerView=function(a,b){if(goog.isDefAndNotNull(a)){var c=goog.dom.createDom("li",{"class":"overlayElem"}),d=goog.dom.createDom("div",{"class":"overlayElemDiv"});goog.dom.appendChild(c,d);goog.dom.appendChild(d,this._createMinimizeOverlayView(a,b));goog.dom.appendChild(d,this._createMaximizeOverlayView(a));return c}};
VK2.Tools.Layerbar.prototype._createMinimizeOverlayView=function(a,b){var c=goog.dom.createDom("div",{value:b,"class":"minimize"}),d=goog.dom.createDom("input",{id:a.id,name:a.name,value:a.name,checked:a.getVisibility(),defaultChecked:a.getVisibility(),"class":"olButton",_layer:a.id,_layerSwitcher:b,type:"checkbox"});a.inRange||(d.disabled=!0);goog.dom.appendChild(c,d);d=goog.dom.createDom("div",{value:a.id,text:a.name,"class":"vk2Label",innerHTML:a.name});goog.dom.appendChild(c,d);d=goog.dom.createDom("div",
{"class":"layer-remove"});goog.dom.appendChild(c,d);var e=goog.dom.createDom("button",{type:"button","aria-hidden":"true","class":"close layerbar-remove-layer",innerHTML:"x"});goog.dom.appendChild(d,e);goog.events.listen(e,goog.events.EventType.CLICK,function(b){a.map.removeLayer(a);this.redraw()},void 0,this);return c};
VK2.Tools.Layerbar.prototype._createMaximizeOverlayView=function(a){var b=goog.dom.createDom("ul",{"class":"maximize"}),c=goog.dom.createDom("div",{"class":"layer-max-container"});goog.dom.appendChild(b,c);var d=goog.dom.createDom("div",{"class":"media"});goog.dom.appendChild(c,d);c=goog.dom.createDom("img",{alt:"...","class":"thumbnail pull-left media-object",src:a.thumbnail});goog.dom.appendChild(d,c);c=goog.dom.createDom("div",{"class":"media-body slider-container"});goog.dom.appendChild(d,c);
goog.dom.appendChild(c,this._createSliderView(a.id,"Opacity","opacity"));a.isTime&&goog.dom.appendChild(c,this._createSliderView(a.id,VK2.Utils.get_I18n_String("layerbar_choosetime"),"time"));return b};
VK2.Tools.Layerbar.prototype._createSliderView=function(a,b,c){c=goog.dom.createDom("div",{"class":c});var d=goog.dom.createDom("div",{"class":"slider-outer"});goog.dom.appendChild(c,d);b=goog.dom.createDom("div",{"class":"label",innerHTML:b+":"});goog.dom.appendChild(d,b);a=goog.dom.createDom("div",{"class":"slider-inner",value:a});goog.dom.appendChild(d,a);d=goog.dom.createDom("div",{"class":"tooltip top in fade"});b=goog.dom.createDom("div",{"class":"tooltip-arrow"});var e=goog.dom.createDom("div",
{"class":"tooltip-inner"});goog.dom.appendChild(d,b);goog.dom.appendChild(d,e);goog.dom.appendChild(a,d);return c};VK2.Tools.Sidebar=function(a,b,c){this._settings={sidebarPanel:"vk2SBPanel",sidebarContentPanel:"vk2SBContentPanel",sidebarBodyPanel:"vk2SidebarBodyPanel",sidebarHeaderPanel:"vk2SBHeaderPanel",sidebarHeaderLabel:"vk2SBHeaderLabel",sidebarHeaderClose:"vk2SBClose",sidebarIcon:"vk2SidebarIcon",sidebarControlBtn:"vk2SBControlBtn",sidebarToolActive:"vk2ToolActivate"};goog.object.extend(this._settings,a);this._sidebarController=null;this._loadHtmlElements(b);this._loadSidebarController(c)};
VK2.Tools.Sidebar.prototype._loadHtmlElements=function(a){var b=goog.dom.getElement(this._settings.sidebarPanel),c=goog.dom.createDom("div",{id:this._settings.sidebarContentPanel,"class":this._settings.sidebarContentPanel});goog.dom.appendChild(b,c);b=goog.dom.createDom("div",{id:this._settings.sidebarHeaderPanel,"class":this._settings.sidebarHeaderPanel});goog.dom.appendChild(c,b);var d=goog.dom.createDom("div",{id:this._settings.sidebarHeaderLabel,"class":this._settings.sidebarHeaderLabel});goog.dom.appendChild(b,
d);d=goog.dom.createDom("button",{type:"button",innerHTML:"&times;","aria-hidden":"true",id:this._settings.sidebarHeaderClose,"class":"close "+this._settings.sidebarHeaderClose});goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{id:this._settings.sidebarBodyPanel,"class":this._settings.sidebarBodyPanel});goog.dom.appendChild(c,b);for(c=0;c<a.length;c++)d=goog.dom.createDom("div",{id:a[c],"class":a[c]}),goog.dom.appendChild(b,d)};
VK2.Tools.Sidebar.prototype._loadSidebarController=function(a){var b=$("#"+this._settings.sidebarPanel).css("width");this._sidebarController=new VK2.Controller.SidebarController({speed:300,panelLocation:"right",sidebarPanel:this._settings.sidebarPanel,sidebarHeaderLabel:this._settings.sidebarHeaderLabel,sidebarPanelWidth:b,sidebarCloseBtn:this._settings.sidebarHeaderClose},a)};
VK2.Tools.Sidebar.prototype._createControlElement=function(a,b){var c=goog.dom.createDom("a",{id:a,"class":a+" "+this._settings.sidebarControlBtn});c.setAttribute("value",b);goog.dom.appendChild(goog.dom.getElement(this._settings.sidebarPanel),c);var d=goog.dom.createDom("span",{"class":this._settings.sidebarIcon});goog.dom.appendChild(c,d);"vk2LayerbarControl"==a&&(c=goog.dom.createDom("span",{"class":"badge pull-right",id:"vk2-layerbar-badge-counter",innerHTML:""}),goog.dom.appendChild(d,c))};
VK2.Tools.Sidebar.prototype._appendControlPanel=function(a){goog.dom.appendChild(goog.dom.getElement(this._settings.sidebarBodyPanel),goog.dom.getElement(a));goog.dom.classes.add(goog.dom.getElement(a),this._settings.sidebarToolActive)};VK2.Tools.Sidebar.prototype.appendControl=function(a,b,c){this._createControlElement(a,b);this._appendControlPanel(b);this._sidebarController._registerControl(a,c)};
VK2.Tools.Sidebar.prototype.appendSlimControl=function(a,b){this._createControlElement(a,"");this._sidebarController._registerSlimControl(a,b)};VK2.Tools.Sidebar.prototype.open=function(a){this._sidebarController._slideOut()};VK2.Tools.Sidebar.prototype.close=function(a){this._sidebarController._deactivateControls();this._sidebarController._slideIn()};VK2.Tools.MapSearch=function(a,b,c,d,e,f){this._map=a;this._feedBackEl=document.getElementById(d);this._hoverLayer=new VK2.Layer.HoverLayer;this._ftLayer=new VK2.Layer.MapSearchLayer(c,b,this._map);this._controller=new VK2.Controller.MapSearchController(this._map,this._ftLayer,this._hoverLayer);this._table=new VK2.Tools.SearchTable(e,[{id:"time",title:VK2.Utils.get_I18n_String("timestamp")},{id:"titel",title:VK2.Utils.get_I18n_String("titel")}],this._controller);this._controller.registerSearchTable(this._table);
this._controller.registerMinimizeMesstischblattView(f)};VK2.Tools.MapSearch.prototype.updateTimestamp=function(a,b){this._ftLayer.timestamps=b;this._ftLayer.refreshLayer()};VK2.Tools.MapSearch.prototype.activate=function(){-1==this._map.getLayerIndex(this._ftLayer)&&(this._map.addLayer(this._hoverLayer),this._map.addLayer(this._ftLayer),this._controller.registerFeatureLayerBehavior(this._feedBackEl));this._ftLayer.setVisibility(!0);this._ftLayer.refreshLayer();this._hoverLayer.setVisibility(!0)};
VK2.Tools.MapSearch.prototype.deactivate=function(){this._ftLayer.setVisibility(!1);this._hoverLayer.setVisibility(!1);this._table.refreshData({})};goog.ui={};goog.ui.IdGenerator=function(){};goog.addSingletonGetter(goog.ui.IdGenerator);goog.ui.IdGenerator.prototype.nextId_=0;goog.ui.IdGenerator.prototype.getNextUniqueId=function(){return":"+(this.nextId_++).toString(36)};VK2.Tools.SearchTable=function(a,b,c){this._parentId=a;(this._parentEl=goog.dom.getElement(a))||console.log("Could not find parent element for SearchTable object.");if(goog.isDef(b)){this._headingCol=b;this._columnIds=[];for(var d in this._headingCol)this._headingCol.hasOwnProperty(d)&&this._columnIds.push(this._headingCol[d].id)}this._idGenerator=goog.ui.IdGenerator.getInstance();this.tableId="searchTable"+this._idGenerator.getNextUniqueId();this._controller=c;this._createTable()};
VK2.Tools.SearchTable.prototype._createTable=function(){var a=goog.dom.createDom("table",{id:this.tableId,"class":"table zebra-striped tablesorter"}),b=goog.dom.createDom("colgroup",{}),c=goog.dom.createDom("col",{"class":"span3",span:"1"}),d=goog.dom.createDom("col",{"class":"span6",span:"1"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,d);var c=goog.dom.createDom("thead",{"class":"table-heading"}),d=goog.dom.createDom("tr",{"class":"table-heading-row"}),e;for(e in this._headingCol)if(this._headingCol.hasOwnProperty(e)){var f=
goog.dom.createDom("th",{id:"header-col-"+this._headingCol[e].id,"class":"header-col col-"+this._headingCol[e].id}),g=goog.dom.createDom("div",{"class":this._headingCol[e].id,innerHTML:this._headingCol[e].title+' <span class="caret caret-reversed"></span>'});goog.dom.appendChild(f,g);goog.dom.appendChild(d,f)}this._tableBody=goog.dom.createDom("tbody",{"class":"table-body"});goog.dom.appendChild(c,d);goog.dom.appendChild(a,b);goog.dom.appendChild(a,c);goog.dom.appendChild(a,this._tableBody);goog.dom.appendChild(this._parentEl,
a);$(goog.dom.getElement(this.tableId)).tablesorter()};VK2.Tools.SearchTable._mdFancyBoxClass="fancybox-md";
VK2.Tools.SearchTable.prototype.refreshData=function(a){goog.dom.removeChildren(this._tableBody);var b=0;for(key in a){b++;for(var c=goog.dom.createDom("tr",{id:key,"class":"data-row"}),d=0;d<this._columnIds.length;d++){var e=goog.dom.createDom("td",{"class":"data-col-"+this._columnIds[d]+" col-"+this._columnIds[d],innerHTML:a[key][this._columnIds[d]]});goog.dom.appendChild(c,e)}this._controller.addRowBehavior(c,a[key].feature);goog.dom.appendChild(this._tableBody,c)}$(document.getElementById(this.tableId)).trigger("update");
VK2.Utils.initializeFancyboxForClass(this._mdFancyBoxClass)};VK2.Tools.SpatialSearch=function(a,b,c){this.NAME=VK2.Utils.get_I18n_String("toolname_layersearch");this._parentElement=a;this._elementIds={headerPanel:"panel-heading-mapsearch",tablePanel:"panel-spatialsearch-table",toolsPanel:"panel-spatialsearch-tools"};this._toolElementIds={slider:"spatialsearch-tools-slider",label_start:"spatialsearch-slider-label-start",label_end:"spatialsearch-slider-label-end"};this._timestamps=[1868,1945];this._maxResolution=305.74811309814453;this._map=b;this._pubSubHandler=
c;this._isActive=!1;this._mapsearch=null;this._loadHtmlContent();this._loadBehavior()};
...
c);goog.dom.appendChild(b,d);goog.dom.appendChild(a,b);b=goog.dom.createDom("div",{id:this._elementIds.tablePanel,"class":"panel-mapsearch-table"});goog.dom.appendChild(a,b);b=goog.dom.createDom("div",{id:this._elementIds.toolsPanel,"class":"panel-spatialsearch-tools"});goog.dom.appendChild(a,b);c=goog.dom.createDom("label",{innerHTML:VK2.Utils.get_I18n_String("change_timeperiod")});goog.dom.appendChild(b,c);var c=goog.dom.createDom("div",{"class":"time-slider-container"}),d=goog.dom.createDom("div",
{id:this._toolElementIds.label_start,"class":"slider-label slider-label-start"}),e=goog.dom.createDom("div",{id:this._toolElementIds.label_end,"class":"slider-label slider-label-end"}),f=goog.dom.createDom("div",{id:this._toolElementIds.slider,"class":"slider"});goog.dom.appendChild(c,d);goog.dom.appendChild(c,f);goog.dom.appendChild(c,e);goog.dom.appendChild(b,c);b=goog.dom.createDom("div",{id:"panel-spatialsearch-mtbview","class":"panel-spatialsearch-mtbview"});goog.dom.appendChild(a,b)};
VK2.Tools.SpatialSearch.prototype._loadBehavior=function(){this._minimizeMtbView=new VK2.Tools.MinimizeMesstischblattView("panel-spatialsearch-mtbview",this._pubSubHandler);this._mapsearch=new VK2.Tools.MapSearch(this._map,this._maxResolution,this._timestamps,this._elementIds.headerPanel,this._elementIds.tablePanel,this._minimizeMtbView);var a=document.getElementById(this._toolElementIds.slider),b=document.getElementById(this._toolElementIds.label_start),c=document.getElementById(this._toolElementIds.label_end),
a=$(a).slider({range:!0,min:this._timestamps[0],max:this._timestamps[1],values:this._timestamps,animate:"slow",orientation:"horizontal",step:1,slide:function(a,e){$(b).text(e.values[0]);$(c).text(e.values[1])},change:$.proxy(function(a,b){this._mapsearch.updateTimestamp(a,b.values)},this)});$(b).text(a.slider("values",0));$(c).text(a.slider("values",1))};VK2.Tools.SpatialSearch.prototype.activate=function(){this._mapsearch.activate();this._isActive=!0};
VK2.Tools.SpatialSearch.prototype.deactivate=function(){this._mapsearch.deactivate();this._minimizeMtbView.deactivate();this._isActive=!1};VK2.Tools.MinimizeMesstischblattView=function(a,b){this._parentContainer=goog.dom.getElement(a);this._mapController=b;this._loadHtmlContent()};
VK2.Tools.MinimizeMesstischblattView.prototype._loadHtmlContent=function(){this._panel=goog.dom.createDom("div",{"class":"minimize-messtischblatt-view",style:"display:none"});goog.dom.appendChild(this._parentContainer,this._panel);this._label=goog.dom.createDom("label");goog.dom.appendChild(this._panel,this._label);var a=goog.dom.createDom("table",{"class":"table"});goog.dom.appendChild(this._panel,a);var b=goog.dom.createDom("thead",{"class":"table-heading"});goog.dom.appendChild(a,b);var c=goog.dom.createDom("tr",
{"class":"table-heading-row"});goog.dom.appendChild(b,c);b=goog.dom.createDom("th",{"class":"header-col col-time",id:"mmv-header-col-time",innerHTML:VK2.Utils.get_I18n_String("timestamp")});goog.dom.appendChild(c,b);b=goog.dom.createDom("th",{"class":"header-col col-titel",id:"mmv-header-col-titel",innerHTML:VK2.Utils.get_I18n_String("titel")});goog.dom.appendChild(c,b);this._tbody=goog.dom.createDom("tbody",{"class":"table-body mmv-table-body"});goog.dom.appendChild(a,this._tbody);a=goog.dom.createDom("div",
{"class":"mmv-tools-container"});goog.dom.appendChild(this._panel,a)};
VK2.Tools.MinimizeMesstischblattView.prototype._appendRow=function(a){var b=goog.dom.createDom("tr");goog.dom.appendChild(this._tbody,b);var c=goog.dom.createDom("td",{"class":"col-time",innerHTML:a.data.time});goog.dom.appendChild(b,c);c=goog.dom.createDom("td",{"class":"col-titel",innerHTML:a.data.titel});goog.dom.appendChild(b,c);b=goog.dom.createDom("div",{"class":"mmv-tools-container"});goog.dom.appendChild(c,b);c=goog.dom.createDom("a",{"class":"mmv-tool-anchor show-timestamp"});goog.dom.appendChild(b,
c);var d=goog.dom.createDom("span",{"class":"mmv-tool-icon",innerHTML:"T"});goog.dom.appendChild(c,d);this._addShowTimestampBehavior(c,a.data.time);c=goog.dom.createDom("a",{"class":"mmv-tool-anchor show-single-map"});goog.dom.appendChild(b,c);d=goog.dom.createDom("span",{"class":"mmv-tool-icon",innerHTML:"S"});goog.dom.appendChild(c,d);this._addShowSingleMapBehavior(c,a);c=goog.dom.createDom("a",{"class":"mmv-tool-anchor show-metadata"});goog.dom.appendChild(b,c);b=goog.dom.createDom("span",{"class":"mmv-tool-icon",
innerHTML:"M"});goog.dom.appendChild(c,b);this._addShowMetadataBehavior(c,a.data.dateiname)};VK2.Tools.MinimizeMesstischblattView.prototype.updateView=function(a){goog.dom.removeChildren(this._tbody);this._label.innerHTML=VK2.Utils.get_I18n_String("mmv_label_blattnr")+" "+a[0].data.blattnr;for(var b=0;b<a.length;b++)this._appendRow(a[b]);goog.style.showElement(this._panel,!0);$(this._tbody).effect("highlight",{},3E3)};
VK2.Tools.MinimizeMesstischblattView.prototype._addShowTimestampBehavior=function(a,b){goog.events.listen(a,goog.events.EventType.CLICK,function(a){a=goog.object.clone(VK2.Utils.Settings.timeWmsWfsOptions);a.extent=this._mapController.getMap().getExtent();a.time=b;this._mapController.publish("addtimelayer",a)},void 0,this)};
VK2.Tools.MinimizeMesstischblattView.prototype._addShowSingleMapBehavior=function(a,b){a.href="/vkviewer/profile/mtb?extent="+(b.geometry.bounds.left+","+b.geometry.bounds.bottom+","+b.geometry.bounds.right+","+b.geometry.bounds.top)+"&time="+b.data.time+"&id="+b.data.mtbid;$(a).fancybox({type:"iframe",width:"100%",height:"100%"})};VK2.Tools.MinimizeMesstischblattView.prototype._addShowMetadataBehavior=function(a,b){var c=VK2.Utils.Settings.geonetwork;goog.isDef(b)&&(c+=b);a.href=c;a.target="_blank"};
VK2.Tools.MinimizeMesstischblattView.prototype.deactivate=function(){goog.style.showElement(this._panel,!1)};
