...
COMMANDS = {
    ...
    'compile': '../lib/closure-library/closure/bin/calcdeps.py -i %s -p ../lib/closure-library -p ./ -o compiled -c ../lib/closure-library/closure/bin/compiler.jar -f --compilation_level=SIMPLE_OPTIMIZATIONS -f --language_in=ECMASCRIPT5 > %s'
}
