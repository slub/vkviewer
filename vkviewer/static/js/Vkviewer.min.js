...
VK2.Tools.MinimizeMesstischblattView.prototype._addShowSingleMapBehavior=function(a,b){a.href="/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+(b.geometry.bounds.left+","+b.geometry.bounds.bottom+","+b.geometry.bounds.right+","+b.geometry.bounds.top)+"&time="+b.data.time;$(a).fancybox({type:"iframe",width:"100%",height:"100%"})};
