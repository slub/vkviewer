...
VK2.Utils.AppLoader.prototype._loadGeoreferencerChooser=function(){var a=new VK2.Tools.GeoreferencerChooser({wmsLayer:this._settings.georeference_grid.wms,requestWfs:this._settings.georeference_grid.wfs,map:this._map});this._sidebar.appendSlimControl(this._settings.vk2GeorefChooserControl,a);a=VK2.Utils.getAllUrlParams();"georef"in a&&"on"==a.georef&&$(goog.dom.getElement(this._settings.vk2GeorefChooserControl)).click()};
...
VK2.Utils.AppLoader.prototype._loadSpatialSearch=function(){var a=new VK2.Tools.SpatialSearch(goog.dom.getElement(this._settings.vk2LayersearchPanel),this._map,this._mapController);this._sidebar.appendControl(this._settings.vk2LayersearchControl,this._settings.vk2LayersearchPanel,a);return a};VK2.Utils.AppLoader.prototype._loadVK2Tools=function(){this._loadGazeettersearch();var a=this._loadSpatialSearch(),b=this._loadLayerbar();this._loadMapController(a,b)};
VK2.Utils.AppLoader.prototype._loadOLMap=function(){VK2.Utils.setGenericOpenLayersPropertys("vkviewer/proxy/?url=");return this._map=VK2.Utils.loadBaseMap(this._settings.map_container,this._settings.map,this._settings.mapnik)};VK2.Utils.AppLoader.prototype._loadEventBehavior=function(){VK2.Utils.initializeFancyboxForClass("fancybox-open");goog.dom.getElement("vk2WelcomePage")&&$("#vk2WelcomePage").fancybox({type:"iframe",padding:0}).click()};
VK2.Utils.AppLoader.prototype._checkIfCookiesAreEnabble=function(){goog.net.cookies.isEnabled()?console.log("Cookies are enabled"):alert("This page needs cookies for correct behavior. So please activate them in your browser.")};VK2.Utils.AppLoader.prototype.loadApplication=function(){this._checkIfCookiesAreEnabble();this._loadOLMap();this._loadEventBehavior();this._loadVK2Tools()};
...
a,this._pubSubHandler.publish("addtimelayer",this._timeParams)):alert(VK2.Utils.get_I18n_String("choose_valide_timestamp")))},this))};VK2.Tools.SpatialSearch.prototype.activate=function(){this._mapsearch.activate();this._isActive=!0};VK2.Tools.SpatialSearch.prototype.deactivate=function(){this._mapsearch.deactivate();this._isActive=!1};VK2.Tools.MesstischblattViewer=function(a,b){this._mtbProps={width:0,height:0,zoomify_url:"",extent:[1409871.625,6603406.5,1428422.75,6621075],projection:"EPSG:900913",crossOrigin:"anonymous",full_screen:!0,zoomToMaxExtent:!0,layerSpy:!0,time:"",minResolution:0,maxResolution:76.43702827453613};goog.object.extend(this._mtbProps,b);this._borderLayer=this._createBorderLayer(this._mtbProps.extent);this._baseLayer=new ol.layer.Tile({attributions:void 0,source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,
maxResolution:this._mtbProps.maxResolution});this._mtbLayer=new ol.layer.Tile({source:new ol.source.TileWMS({url:"http://194.95.145.43/mapcache",params:{LAYERS:"messtischblaetter",TIME:this._mtbProps.time,VERSION:"1.1.1"},projection:this._mtbProps.projection,extent:this._mtbProps.extent}),maxResolution:this._mtbProps.maxResolution});this._map=new ol.Map({layers:[this._baseLayer,this._mtbLayer,this._borderLayer],interactions:ol.interaction.defaults().extend([new ol.interaction.DragRotateAndZoom]),
renderer:ol.RendererHint.CANVAS,target:a,view:new ol.View2D({projection:this._mtbProps.projection,minResolution:2*this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution/2}),controls:[new ol.control.Zoom,new ol3.control.RotateNorth]});this._map.getView().fitExtent(this._mtbProps.extent,this._map.getSize());this._loadControls()};
VK2.Tools.MesstischblattViewer.prototype._loadControls=function(){this._mtbProps.full_screen&&this._map.addControl(new ol.control.FullScreen);this._mtbProps.zoomToMaxExtent&&this._map.addControl(new ol.control.ZoomToExtent({extent:this._mtbProps.extent}));this._mtbProps.layerSpy&&this._map.addControl(new ol3.control.LayerSpy({spyLayer:new ol.layer.Tile({attributions:void 0,source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution})}))};
VK2.Tools.MesstischblattViewer.prototype._createBorderLayer=function(a){var b=[new ol.style.Style({stroke:new ol.style.Stroke({color:"#000000",width:3})})];a=new ol.source.Vector({features:[new ol.Feature(new ol.geom.Polygon([[[a[0],a[1]],[a[0],a[3]],[a[2],a[3]],[a[2],a[1]]]]))]});return new ol.layer.Vector({source:a,styleFunction:function(a,d){return b}})};VK2.Tools.MesstischblattViewer.prototype.getMap=function(){return this._map};VK2.Tools.MetadataVisualizer=function(a,b,c,d){this._parentEl=goog.dom.getElement(a);goog.isDef(d)&&d&&this._initFancyBox();var e=this;a=new VK2.Requests.CSW_GetRecordById;a.addEventListener(VK2.Events.EventType.PARSED_RECORD,function(a){e.displayCswIsoRecord(a)});response=a.getRecord(b,c)};
...
"display","block")},afterClose:function(){goog.style.setStyle(this.parentEl,"display","none");this.parentObj._clearHtmlContent();this.parentObj=null;delete this.parentObj}}).click();this._fixCloseClick()};VK2.Tools.MetadataVisualizer.prototype.displayCswIsoRecord=function(a){a=a.parsed_content;this._createTable();this._createHeader(a.TITEL[0],a.ABSTRACT[0],a.THUMBNAIL[0]);this._createContent(a,this._tBody)};
...
VK2.Tools.MetadataVisualizer.prototype._createHeaderContent=function(a,b,c){var d=goog.dom.createDom("tr",{});a=goog.dom.createDom("td",{innerHTML:a});goog.dom.appendChild(d,a);a=goog.dom.createDom("td",{"class":"right"});b=goog.dom.createDom("img",{src:b,alt:"thumbnail","class":"thumbnail"});goog.dom.appendChild(a,b);goog.dom.appendChild(d,a);goog.dom.appendChild(c,d)};
...
VK2.Tools.MetadataVisualizer.prototype._clearHtmlContent=function(){goog.dom.removeChildren(this._parentEl);goog.dom.removeNode(this._parentEl)};VK2.Tools.MetadataVisualizer.prototype._fixLinks=function(){for(var a=goog.dom.getElementsByTagNameAndClass("a",void 0,this._parentEl),b=0;b<a.length;b++)goog.events.listen(a[b],"click",function(a){window.location=event.target.href})};
VK2.Tools.MetadataVisualizer.prototype._fixCloseClick=function(){goog.events.listen(this._parentEl,"click",function(a){a.stopPropagation()},!0)};
