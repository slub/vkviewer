...
ol3.control.LayerSpy=function(a){var b=a||{};this._buildHtmlElement();var c=this,d=goog.isDef(b.radius)?parseInt(b.radius):75;goog.events.listen(document,goog.events.EventType.KEYDOWN,function(a){if(107===a.keyCode||187===a.keyCode)d=Math.min(d+5,150),c.getMap().requestRenderFrame();else if(109===a.keyCode||189===a.keyCode)d=Math.max(d-5,25),c.getMap().requestRenderFrame()});var e=null,f=function(a){a=a.context;a.save();a.beginPath();e&&(a.arc(e[0],e[1],d,0,2*Math.PI),a.lineWidth=5,a.strokeStyle=
"rgba(0,0,0,0.5)",a.stroke());a.clip()},g=function(a){a.context.restore()};goog.events.listen(this._layerSpyAnchor,goog.events.EventType.CLICK,function(a){goog.dom.classes.has(this,"active")?(b.spyLayer.un("precompose",f),b.spyLayer.un("postcompose",g),c.getMap().removeLayer(b.spyLayer),goog.dom.classes.remove(this,"active")):(c.getMap().addLayer(b.spyLayer),b.spyLayer.on("precompose",f),b.spyLayer.on("postcompose",g),goog.dom.classes.add(this,"active"),goog.events.listen(c.getMap().getViewport(),
"mousemove",function(a){e=c.getMap().getEventPixel(a.event_);c.getMap().requestRenderFrame()}),goog.events.listen(c.getMap().getViewport(),"mouseout",function(){e=null;c.getMap().requestRenderFrame()}))});ol.control.Control.call(this,{element:this._layerSpyContainer,target:b.target})};ol.inherits(ol3.control.LayerSpy,ol.control.Control);
