...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};var VK2={Utils:{}};VK2.Utils.Settings={};VK2.Utils.Settings.DOM={};VK2.Utils.Settings.proxy_url="/vkviewer/proxy/?url=";VK2.Utils.Settings.geonetwork="http://kartenforum.slub-dresden.de/geonetwork/srv/eng/search#|";
...
VK2.Tools.Georeferencer.prototype._loadOpenCloseBehavior=function(a){goog.events.listen(a,goog.events.EventType.CLICK,function(a){goog.style.getSize(a.target.parentElement);var c=this._toolContainer;goog.dom.classes.has(a.target,"open")?$(a.target.parentElement).animate({left:"-250px"},1E3,function(){goog.dom.classes.remove(a.target,"open");goog.style.setStyle(c,"display","none")}):(goog.style.setStyle(c,"display","block"),$(a.target.parentElement).animate({left:"-2px"},1E3,function(){goog.dom.classes.add(a.target,
"open")}))},void 0,this)};
...
this)};VK2.Tools.ResetGeoreferenceParameter=function(a,b){this._anchor_element=a;this._key=b;this._loadHtmlContent();this._loadClickBehavior()};
