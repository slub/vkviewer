...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};var initConfiguration={mapOptions:{maxExtent:new OpenLayers.Bounds(640161.933,5958026.134,2661768.457,7817626.892),restrictedExtent:new OpenLayers.Bounds(640161.933,5958026.134,2661768.457,7817626.892),projection:new OpenLayers.Projection("EPSG:900913"),displayProjection:new OpenLayers.Projection("EPSG:900913"),units:"m",startPoint:new OpenLayers.LonLat(1528150,6630500)},mapnikOptions:{resolutions:[1222.9924523925781,611.4962261962891,305.74811309814453,152.87405654907226,76.43702827453613,38.218514137268066,
...
goog.net.cookies=new goog.net.Cookies(document);goog.net.cookies.MAX_COOKIE_LENGTH=goog.net.Cookies.MAX_COOKIE_LENGTH;goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};goog.dom.BrowserFeature={CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),CAN_USE_CHILDREN_ATTRIBUTE:!goog.userAgent.GECKO&&!goog.userAgent.IE||goog.userAgent.IE&&goog.userAgent.isDocumentModeOrHigher(9)||goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9.1"),CAN_USE_INNER_TEXT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),CAN_USE_PARENT_ELEMENT_PROPERTY:goog.userAgent.IE||goog.userAgent.OPERA||goog.userAgent.WEBKIT,INNER_HTML_NEEDS_SCOPED_ELEMENT:goog.userAgent.IE};goog.dom.TagName={A:"A",ABBR:"ABBR",ACRONYM:"ACRONYM",ADDRESS:"ADDRESS",APPLET:"APPLET",AREA:"AREA",ARTICLE:"ARTICLE",ASIDE:"ASIDE",AUDIO:"AUDIO",B:"B",BASE:"BASE",BASEFONT:"BASEFONT",BDI:"BDI",BDO:"BDO",BIG:"BIG",BLOCKQUOTE:"BLOCKQUOTE",BODY:"BODY",BR:"BR",BUTTON:"BUTTON",CANVAS:"CANVAS",CAPTION:"CAPTION",CENTER:"CENTER",CITE:"CITE",CODE:"CODE",COL:"COL",COLGROUP:"COLGROUP",COMMAND:"COMMAND",DATA:"DATA",DATALIST:"DATALIST",DD:"DD",DEL:"DEL",DETAILS:"DETAILS",DFN:"DFN",DIALOG:"DIALOG",DIR:"DIR",DIV:"DIV",
...
goog.style.getCssTranslation=function(a){var b;goog.userAgent.IE?b="-ms-transform":goog.userAgent.WEBKIT?b="-webkit-transform":goog.userAgent.OPERA?b="-o-transform":goog.userAgent.GECKO&&(b="-moz-transform");var c;b&&(c=goog.style.getStyle_(a,b));c||(c=goog.style.getStyle_(a,"transform"));return c?(a=c.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};VK2.Utils={};VK2.Utils.initializeFancyboxForClass=function(a){$("."+a).each(function(){$(this).fancybox({type:"iframe",autoSize:!1,beforeShow:function(){for(var a=$(".fancybox-iframe").contents()[0].body,a=goog.dom.getChildren(a),c=0;c<a.length;c++)if(goog.dom.classes.has(a[c],"page-container")){var d=goog.style.getSize(a[c]),e=goog.object.get(d,"width")+20;this.width=goog.isDef(e)?e+"px":"100%";d=goog.object.get(d,"height");this.height=goog.isDef(d)?d+"px":"100%"}}})})};
VK2.Utils.loadBaseMap=function(a,b,c){a=new OpenLayers.Map(a,b);c=new OpenLayers.Layer.OSM("Mapnik","",c);a.addLayers([c]);a.setCenter(b.startPoint,2);return a};VK2.Utils.setGenericOpenLayersPropertys=function(a){OpenLayers.IMAGE_RELOAD_ATTEMPTS=5;OpenLayers.ProxyHost=VK2.Utils.getHost(a)};VK2.Utils.jumptolonlat=function(a,b,c){b=(new OpenLayers.LonLat(b,c)).transform(new OpenLayers.Projection("EPSG:4326"),a.getProjectionObject());a.setCenter(b,12);return!0};
VK2.Utils.encode_utf8=function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var d=a.charCodeAt(c);128>d?b+=String.fromCharCode(d):(127<d&&2048>d?b+=String.fromCharCode(d>>6|192):(b+=String.fromCharCode(d>>12|224),b+=String.fromCharCode(d>>6&63|128)),b+=String.fromCharCode(d&63|128))}return b};
VK2.Utils.decode_utf8=function(a){for(var b="",c=0,d=c1=c2=0;c<a.length;)d=a.charCodeAt(c),128>d?(b+=String.fromCharCode(d),c++):191<d&&224>d?(c2=a.charCodeAt(c+1),b+=String.fromCharCode((d&31)<<6|c2&63),c+=2):(c2=a.charCodeAt(c+1),c3=a.charCodeAt(c+2),b+=String.fromCharCode((d&15)<<12|(c2&63)<<6|c3&63),c+=3);return b};VK2.Utils.getAllUrlParams=function(){for(var a=window.location.search.substring(1).split("&"),b={},c=0;c<a.length;c++){var d=a[c].split("=");b[d[0]]=decodeURIComponent(d.slice(1).join("="))}return b};
VK2.Utils.get_url_param=function(a){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");a=RegExp("[\\?&]"+a+"=([^&#]*)").exec(window.location.href);return null==a?"":a[1]};VK2.Utils.getHost=function(a){var b=location.protocol+"//"+location.hostname+(location.port?":"+location.port:"");return"/"==a.charAt(0)?b+a:b+"/"+a};VK2.Utils.routeToTop=function(a){var b=document.createElement("a");b.href=a;b.target="_top";document.body.appendChild(b);b.click()};
VK2.Utils.fixControlConflictsOnOLMap=function(a){"undefined"!=typeof a.handlers?a.handlers.feature.stopDown=!1:"undefined"!=typeof a.handler&&(a.handler.stopDown=!1,a.handler.stopUp=!1)};VK2.Utils.getDictionaryValues=function(a){list=[];for(var b in a)return list.push(a[b]),list};VK2.Utils.get_I18n_String=function(a){try{if(goog.isDef(lang_dictionary))return lang_dictionary[a]}catch(b){console.log("Could not found dictionary.")}};VK2.Utils.setCookie=function(a,b){goog.net.cookies.set(a,b)};
VK2.Utils.removeClass=function(a,b){goog.dom.classes.has(a,b)&&goog.dom.classes.remove(a,b)};VK2.Utils.getAllQueryParams=function(a){return(goog.isDef(a)?new goog.Uri(a):new goog.Uri(window.location.href)).getQueryData()};VK2.Utils.getQueryParam=function(a,b){return goog.isDef(b)?this.getAllQueryParams(b).get(a):this.getAllQueryParams().get(a)};String.prototype.replaceAll=function(a,b){return this.split(a).join(b)};VK2.Class=function(a){classObj=function(){this.initialize.apply(this,arguments)};for(var b in a)classObj.prototype[b]=a[b];classObj.prototype.initialize||(classObj.prototype.initialize=function(){});return classObj};VK2.Filter={getBoundingBoxFilter:function(a,b){return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,value:a,projection:b})},getTimeFilter:function(a,b,c,d){return new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,value:a,projection:b}),new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.LESS_THAN_OR_EQUAL_TO,
property:"time",value:d}),new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.GREATER_THAN_OR_EQUAL_TO,property:"time",value:c})]})]})}};VK2.Validation={};VK2.Validation.isBlattnumber=function(a){var b=[],b=-1!==a.indexOf(":"),c=-1!==a.indexOf("_"),b=b?a.split(":"):c?a.split("_"):[];return 2==b.length?areNumbers=(areNumbers=(areNumbers=(areNumbers=(areNumbers=!0)&&this.isInt(b[0])?!0:!1)&&this.isInt(b[1])?!0:!1)&&3>=b[0].length?!0:!1)&&3>=b[1].length?!0:!1:!1};VK2.Validation.isInt=function(a){return isValideInteger=/^[0-9]+$/.test(a)};VK2.Validation.checkLength=function(a,b,c){return a.length>c||a.length<b?!1:!0};
VK2.Validation.checkRegexp=function(a,b){return b.test(a)?!0:!1};VK2.Validation.setErrorMsg=function(a,b,c){b=goog.dom.getElement(b);goog.isDef(b)&&(b.innerHTML=a,goog.dom.classes.add(b,c))};
VK2.Validation.checkPassword=function(a,b,c){a=goog.dom.getElement(a);var d=!0;if(goog.dom.classes.has(a.parentElement,"has-success")||goog.dom.classes.has(a.parentElement,"has-error"))goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.remove(a.parentElement,"has-success");d=(d=d&&goog.isDefAndNotNull(a))&&this.checkLength(a.value,5,16);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("password_to_short"),b,c),goog.dom.classes.add(a.parentElement,
"has-error"),d;d=d&&this.checkRegexp(a.value,/^([0-9a-zA-Z])+$/);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("password_wrong_token"),b,c),goog.dom.classes.add(a.parentElement,"has-error"),d;goog.isDef(b)&&goog.isDef(c)&&d&&(goog.dom.classes.remove(goog.dom.getElement(b),c),goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.add(a.parentElement,"has-success"));return d};
VK2.Validation.checkPasswordMatch=function(a,b,c,d){a=goog.dom.getElement(a);b=goog.dom.getElement(b);if(goog.dom.classes.has(b.parentElement,"has-success")||goog.dom.classes.has(b.parentElement,"has-error"))goog.dom.classes.remove(b.parentElement,"has-error"),goog.dom.classes.remove(b.parentElement,"has-success");var e;e=(e=goog.isDefAndNotNull(a)&&goog.isDefAndNotNull(b))&&a.value==b.value;if(goog.isDef(c)&&goog.isDef(d)&&!e)return this.setErrorMsg(VK2.Utils.get_I18n_String("password_is_same"),
c,d),goog.dom.classes.add(b.parentElement,"has-error"),e;goog.isDef(c)&&goog.isDef(d)&&e&&(goog.dom.classes.remove(goog.dom.getElement(c),d),goog.dom.classes.remove(b.parentElement,"has-error"),goog.dom.classes.add(b.parentElement,"has-success"));return e};
VK2.Validation.checkUsername=function(a,b,c){a=goog.dom.getElement(a);var d=!0;if(goog.dom.classes.has(a.parentElement,"has-success")||goog.dom.classes.has(a.parentElement,"has-error"))goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.remove(a.parentElement,"has-success");d=(d=d&&goog.isDefAndNotNull(a))&&this.checkLength(a.value,3,16);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("username_to_short"),b,c),goog.dom.classes.add(a.parentElement,
"has-error"),d;d=d&&this.checkRegexp(a.value,/^([0-9a-zA-Z])+$/);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("username_wrong_token"),b,c),goog.dom.classes.add(a.parentElement,"has-error"),d;goog.isDef(b)&&goog.isDef(c)&&d&&(goog.dom.classes.remove(goog.dom.getElement(b),c),goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.add(a.parentElement,"has-success"));return d};
VK2.Validation.checkPersonName=function(a,b,c){a=goog.dom.getElement(a);var d=!0;if(goog.dom.classes.has(a.parentElement,"has-success")||goog.dom.classes.has(a.parentElement,"has-error"))goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.remove(a.parentElement,"has-success");d=(d=d&&goog.isDefAndNotNull(a))&&this.checkLength(a.value,3,16);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("personname_to_short"),b,c),goog.dom.classes.add(a.parentElement,
"has-error"),d;d=d&&this.checkRegexp(a.value,/^([a-zA-Z])+$/);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("personname_wrong_token"),b,c),goog.dom.classes.add(a.parentElement,"has-error"),d;goog.isDef(b)&&goog.isDef(c)&&d&&(goog.dom.classes.remove(goog.dom.getElement(b),c),goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.add(a.parentElement,"has-success"));return d};
VK2.Validation.checkEmailAdress=function(a,b,c){a=goog.dom.getElement(a);var d=!0;if(goog.dom.classes.has(a.parentElement,"has-success")||goog.dom.classes.has(a.parentElement,"has-error"))goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.remove(a.parentElement,"has-success");d=(d=d&&goog.isDefAndNotNull(a))&&this.checkLength(a.value,6,80);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("email_to_short"),b,c),goog.dom.classes.add(a.parentElement,
"has-error"),d;regexp_email=/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i;
d=d&&this.checkRegexp(a.value,regexp_email);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("email_wrong_token"),b,c),goog.dom.classes.add(a.parentElement,"has-error"),d;goog.isDef(b)&&goog.isDef(c)&&d&&(goog.dom.classes.remove(goog.dom.getElement(b),c),goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.add(a.parentElement,"has-success"));return d};VK2.Utils.Georef={};VK2.Utils.Georef.createZoomifyLayer=function(a){var b=a.get("zoomify_prop").substring(0,a.get("zoomify_prop").lastIndexOf("/")+1);return new OpenLayers.Layer.Zoomify(a.get("layer"),b,new OpenLayers.Size(a.get("zoomify_width"),a.get("zoomify_height")))};
VK2.Utils.Georef.createZoomifyOverviewLayer=function(a,b){var c=a.get("zoomify_prop").substring(0,a.get("zoomify_prop").lastIndexOf("/")+1)+"TileGroup0/0-0-0.jpg",d=new OpenLayers.Layer.Image("zoomifyOverviewMap",c,new OpenLayers.Bounds(0,0,a.get("zoomify_width"),a.get("zoomify_height")),new OpenLayers.Size(150,110),{numZoomLevels:1,maxExtent:new OpenLayers.Bounds(0,0,a.get("zoomify_width"),a.get("zoomify_height"))});console.log(c);return overviewMapControl=new OpenLayers.Control.OverviewMap({size:new OpenLayers.Size(150,
110),layers:[d],maximized:!0})};
VK2.Utils.Georef.zommToBBoxFromWMSLayer=function(a,b,c){wmsParser=new OpenLayers.Format.WMSCapabilities.v1_1_1;wmsCapaRequest=b+"&VERSION=1.1.1&SERVICE=WMS&REQUEST=GetCapabilities";OpenLayers.Request.GET({url:wmsCapaRequest,success:function(b){b=wmsParser.read(b.responseText).capability;for(var e=0,f=b.layers.length;e<f;e+=1){var g=b.layers[e];if(g.name===c){bbox_pure=g.bbox["EPSG:4314"];bbox=OpenLayers.Bounds.fromArray(bbox_pure.bbox);bbox_transformed=bbox.transform(new OpenLayers.Projection(bbox_pure.srs),a.getProjectionObject());
a.zoomToExtent(bbox_transformed);break}}}})};VK2.Utils.Georef.loadValidationLayer=function(a,b){var c=null;try{c=new OpenLayers.Layer.WMS(b.get("layer_id"),b.get("wms_url"),{layers:b.get("layer_id"),type:"png",format:"image/png",transparent:"true"},{isBaseLayer:!1,opacity:0.75,visibility:!0})}catch(d){c=new OpenLayers.Layer.Image("Default MTB","mtb_default.jpg",new OpenLayers.Bounds(0,0,1797,2001),new OpenLayers.Size(1E3,1E3),{numZoomLevels:3})}a.addLayer(c)};
VK2.Utils.Georef.initializeGeoreferencerMap=function(a,b,c){var d=this.createZoomifyLayer(b),e={units:"pixels",maxExtent:new OpenLayers.Bounds(0,0,b.get("zoomify_width"),b.get("zoomify_height")),maxResolution:Math.pow(2,d.numberOfTiers-1),numZoomLevels:10,controls:[new OpenLayers.Control.Attribution,new OpenLayers.Control.Navigation,new OpenLayers.Control.Zoom]};a=new OpenLayers.Map(a,e);c&&(b=this.createZoomifyOverviewLayer(b,d),a.addControls([b]));a.addLayer(d);a.setBaseLayer(d);a.zoomToMaxExtent();
return a};
VK2.Utils.Georef.initializeGeoreferenceResultMap=function(a,b){var c={projection:new OpenLayers.Projection("EPSG:900913"),units:"m",maxResolution:"auto",maxExtent:new OpenLayers.Bounds(-2.003750834E7,-2.003750834E7,2.003750834E7,2.003750834E7),controls:[new OpenLayers.Control.Navigation,new OpenLayers.Control.LayerSwitcher,new OpenLayers.Control.Zoom,new OpenLayers.Control.Attribution,new OpenLayers.Control.ScaleLine({geodesic:!0})]},c=new OpenLayers.Map(a,c),d=new OpenLayers.Layer.OSM("Mapnik");c.addLayer(d);
this.loadValidationLayer(c,b);this.zommToBBoxFromWMSLayer(c,b.get("wms_url"),b.get("layer_id"));return c};VK2.Utils.Georef.showGeorefPoints=function(a,b){a.innerHTML="+"+b+" "+VK2.Utils.get_I18n_String("georef_points");$(a).fadeIn(1E3).effect("puff",{},3E3,function(){a.innerHTML=""})};VK2.Utils.AppLoader=function(a,b){this._settings={vk2LayersearchPanel:"vk2LayersearchPanel",vk2LayersearchControl:"vk2LayersearchControl",vk2LayerbarPanel:"vk2LayerbarPanel",vk2LayerbarControl:"vk2LayerbarControl",vk2Gazetteer:"vk2GazetteerSearchInput",vk2GeorefChooser:"vk2GeorefPanel",vk2GeorefChooserControl:"vk2GeorefControl",vk2Sidebar:"vk2SBPanel",timeParameter:b.timeParameter,georeference_grid:b.georeference_grid,map_container:"mapdiv",map:b.mapOptions,mapnik:b.mapnikOptions,toolPanels:["vk2LayersearchPanel",
"vk2LayerbarPanel"]};this._mapController=VK2.Controller.MapController;this._map=null;goog.dom.getElement(this._settings.vk2Sidebar)&&(this._sidebar=new VK2.Tools.Sidebar({},this._mapController,this._settings.toolPanels));for(var c in a)this._settings[c]=a[c]};VK2.Utils.AppLoader.prototype._loadMapController=function(a,b){this._mapController=VK2.Controller.MapController.initialize(this._map,{vk2layermanagement:b,vk2layersearch:a,vk2timefeaturecontrols:VK2.Controller.TimeFeatureControls})};
VK2.Utils.AppLoader.prototype._loadGazeettersearch=function(){goog.dom.getElement(this._settings.vk2Gazetteer)&&new VK2.Tools.Gazetteersearch(document.getElementById(this._settings.vk2Gazetteer),this._map)};
VK2.Utils.AppLoader.prototype._loadGeoreferencerChooser=function(){var a=new VK2.Tools.GeoreferencerChooser({wmsLayer:this._settings.georeference_grid.wms,requestWfs:this._settings.georeference_grid.wfs,map:this._map},this._layerbar);this._sidebar.appendSlimControl(this._settings.vk2GeorefChooserControl,a);a=VK2.Utils.getAllUrlParams();"georef"in a&&"on"==a.georef&&$(goog.dom.getElement(this._settings.vk2GeorefChooserControl)).click()};
VK2.Utils.AppLoader.prototype._loadLayerbar=function(){var a={map:this._map,div:goog.dom.getElement(this._settings.vk2LayerbarPanel),id:"layerbar_1",vk2featurelayer:VK2.Controller.TimeFeatureControls},a=new VK2.Tools.Layerbar(a);this._sidebar.appendControl(this._settings.vk2LayerbarControl,this._settings.vk2LayerbarPanel,a);return a};
VK2.Utils.AppLoader.prototype._loadSpatialSearch=function(){var a=new VK2.Tools.SpatialSearch(goog.dom.getElement(this._settings.vk2LayersearchPanel),this._map,this._mapController);this._sidebar.appendControl(this._settings.vk2LayersearchControl,this._settings.vk2LayersearchPanel,a);return a};
VK2.Utils.AppLoader.prototype._loadVK2Tools=function(){this._loadGazeettersearch();this._spatialsearch=this._loadSpatialSearch();this._layerbar=this._loadLayerbar();this._loadMapController(this._spatialsearch,this._layerbar)};VK2.Utils.AppLoader.prototype._loadOLMap=function(){VK2.Utils.setGenericOpenLayersPropertys("vkviewer/proxy/?url=");return this._map=VK2.Utils.loadBaseMap(this._settings.map_container,this._settings.map,this._settings.mapnik)};
VK2.Utils.AppLoader.prototype._loadEventBehavior=function(){VK2.Utils.initializeFancyboxForClass("fancybox-open");goog.dom.getElement("vk2WelcomePage")&&$("#vk2WelcomePage").fancybox({type:"iframe",padding:0}).click()};VK2.Utils.AppLoader.prototype._checkIfCookiesAreEnabble=function(){goog.net.cookies.isEnabled()?console.log("Cookies are enabled"):alert("This page needs cookies for correct behavior. So please activate them in your browser.")};
VK2.Utils.AppLoader.prototype.loadApplication=function(){this._checkIfCookiesAreEnabble();this._loadOLMap();this._loadEventBehavior();this._loadVK2Tools()};VK2.Utils.AppLoader.prototype.loadApplicationWithGeoref=function(){this.loadApplication();this._loadGeoreferencerChooser();VK2.Utils.getQueryParam("points")&&"on"==VK2.Utils.getQueryParam("georef")&&VK2.Utils.Georef.showGeorefPoints(goog.dom.getElement("georefPointContainer"),VK2.Utils.getQueryParam("points"))};VK2.Login={createSubmitLoginBtn:function(){$("#submitPasswortBtn").click(function(){VK2.Login.validateLoginForm()&&$.ajax({type:"POST",url:"/vkviewer/sign/in",data:{username:$("#loginUsername").val(),password:$("#loginPassword").val(),"form.submitted":!0,came_from:"/vkviewer/sign/getscreen"},success:function(a,b,c){b=!1;try{b=JSON.parse(a),console.log(b)}catch(d){}b?$("#validationTips").html(b.message).addClass("ui-state-error"):(a=document.createElement("a"),a.href="../auth",a.target="_top",document.body.appendChild(a),
...
goog.events.wrapListener_=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");return a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)})};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});VK2.Controller.SidebarController=function(a,b){this._settings={speed:300,panelLocation:"right",sidebarPanel:"vk2SBPanel",sidebarHeaderLabel:"vk2SBHeaderLabel",sidebarContentPanel:"vk2SBContentPanel",sidebarPanelWidth:300,sidebarCloseBtn:"vk2SBClose"};goog.object.extend(this._settings,a);this._sidebar=$(goog.dom.getElement(this._settings.sidebarPanel));this._mapController=b;this._controls=[];this._controlElements=[];this._loadCloseBehavior()};
VK2.Controller.SidebarController.prototype._activateControl=function(a,b){this._deactivateControls();this._deactivateControlElements();b.activate();this._changeHeader(b.NAME);goog.dom.classes.add(a,"open");var c=goog.dom.getElement(a.getAttribute("value"));goog.isDefAndNotNull(c)&&goog.style.setStyle(c,"display","block")};VK2.Controller.SidebarController.prototype._changeHeader=function(a){goog.dom.getElement(this._settings.sidebarHeaderLabel).innerHTML="<h4>"+a+"</h4>"};
VK2.Controller.SidebarController.prototype._closeSlidebar=function(){this._deactivateControls();this._deactivateControlElements();this._slideIn();this._mapController.activateTimeFeatureControl()};VK2.Controller.SidebarController.prototype._createControlBehavior=function(a,b){goog.events.listen(goog.dom.getElement(a),goog.events.EventType.CLICK,function(a){a=a.currentTarget;goog.dom.classes.has(a,"open")?this._closeSlidebar():(this._activateControl(a,b),this._slideOut())},void 0,this)};
VK2.Controller.SidebarController.prototype._createSlimControlBehavior=function(a,b){goog.events.listen(goog.dom.getElement(a),goog.events.EventType.CLICK,function(a){a=a.currentTarget;goog.dom.classes.has(a,"open")?this._closeSlidebar():(this._activateControl(a,b),this._slideIn())},void 0,this)};VK2.Controller.SidebarController.prototype._deactivateControls=function(){for(var a=0;a<this._controls.length;a++)this._controls[a].deactivate()};
VK2.Controller.SidebarController.prototype._deactivateControlElements=function(){for(var a=0;a<this._controlElements.length;a++){goog.dom.classes.remove(this._controlElements[a],"open");var b=goog.dom.getElement(this._controlElements[a].getAttribute("value"));goog.isDefAndNotNull(b)&&goog.style.setStyle(b,"display","none")}};
VK2.Controller.SidebarController.prototype._loadCloseBehavior=function(){null!=document.getElementById(this._settings.sidebarCloseBtn)&&goog.events.listen(goog.dom.getElement(this._settings.sidebarCloseBtn),goog.events.EventType.CLICK,function(a){this._closeSlidebar()},void 0,this)};VK2.Controller.SidebarController.prototype._registerControl=function(a,b){this._createControlBehavior(a,b);this._controls.push(b);this._controlElements.push(goog.dom.getElement(a))};
VK2.Controller.SidebarController.prototype._registerSlimControl=function(a,b){this._createSlimControlBehavior(a,b);this._controls.push(b);this._controlElements.push(goog.dom.getElement(a))};VK2.Controller.SidebarController.prototype._slideIn=function(){if("right"==this._settings.panelLocation){var a=goog.dom.getElement(this._settings.sidebarContentPanel);this._sidebar.animate({right:"-"+this._settings.sidebarPanelWidth},this._settings.speed,function(){goog.style.setStyle(a,"display","none")}).removeClass("open")}};
VK2.Controller.SidebarController.prototype._slideOut=function(){goog.style.setStyle(goog.dom.getElement(this._settings.sidebarContentPanel),"display","block");"right"==this._settings.panelLocation&&this._sidebar.animate({right:"-3px"},this._settings.speed).addClass("open")};VK2.Controller.GeoreferenceController=function(){var a=OpenLayers.Class(OpenLayers.Control,{initialize:function(a,b){OpenLayers.Control.prototype.initialize.apply(this,[b]);this.layer=a;this.handler=new OpenLayers.Handler.Feature(this,a,{click:this.clickFeature})},clickFeature:function(a){void 0==a.fid?this.layer.destroyFeatures([a]):(this.layer.drawFeature(a,{display:"none"}),this.layer.removeFeatures(a),this.layer.events.triggerEvent("afterfeaturemodified",{feature:a}))},setMap:function(a){this.handler.setMap(a);
...
e=function(){var a=c,d;for(d in b.toggleElements)$("#"+b.toggleElements[d]).click(function(b){for(var c in a){var d=a[c];b.currentTarget.value==c&&b.currentTarget.checked?d.activate():d.deactivate()}})},f=function(){var a=b.vectorLayer;"georeference"==b.status?$("#"+b.formElements.btnSubmit).click(function(c){if(h(a)){c=b.urlParams.get("mtbid");var d=document.getElementById(b.formElements.hiddenPoints).value;console.log(c);console.log(d);$("#"+b.loadingScreen).css({display:"block","z-index":"2000"});
$.ajax({url:b.urls.submit,type:"GET",data:{mtbid:c,points:d},success:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});console.log(a);document.getElementById(b.anchorIndexPage).click()},error:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});alert("Die Georeferenzierungsparameter konnten nicht registriert werden")},complete:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"})}})}else console.log("inputs are not valide")}):"validate"==b.status&&
$("#"+b.formElements.btnSubmit).click(function(c){if(h(a)){c=b.urlParams.get("mtbid");var d=b.urlParams.get("georefid");$("#"+b.loadingScreen).css({display:"block","z-index":"2000"});$.ajax({url:b.urls.submit,type:"GET",data:{mtbid:c,georefid:d},success:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});console.log(a);document.getElementById(b.anchorIndexPage).click()},error:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});alert("Die Georeferenzierungsparameter konnten nicht best\u00e4tigt werden")},
complete:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"})}})}else console.log("inputs are not valide")})},g=function(){var a=b.vectorLayer;$("#"+b.formElements.btnValidate).click(function(c){if(h(a)){c=b.urlParams.get("mtbid");var d=document.getElementById(b.formElements.hiddenPoints).value;console.log(c);console.log(d);$("#"+b.loadingScreen).css({display:"block","z-index":"2000"});$.ajax({url:b.urls.validate,type:"GET",data:{mtbid:c,points:d},success:function(a){$("#"+b.loadingScreen).css({display:"none",
"z-index":"0"});console.log(a);for(var c=b.urls.validatePage+"?points="+d+"&",e=b.urlParams.getKeys(),f=0;f<e.length;f++)c=c+e[f]+"="+b.urlParams.get(e[f])+"&";a=JSON.parse(a);for(var g in a)c=c+g+"="+a[g]+"&";g=document.createElement("a");document.body.appendChild(g);g.href=c;g.click()},error:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});alert("Es konnte keine Validierung berechnet werden")},complete:function(a){$("#"+b.loadingScreen).css({display:"none","z-index":"0"});
console.log(a)}})}else console.log("inputs are not valide")});f()},h=function(a){if(4>a.features.length)return alert("4 Eckpunkte ben\u00f6tigt"),!1;var c=document.getElementById(b.formElements.hiddenPoints);c.value="";for(var d in a.features)c.value=c.value+a.features[d].geometry.x+":"+a.features[d].geometry.y,c.value=d<a.features.length-1?c.value+",":c.value+"";return!0};return{initialize:function(a){for(var c in a)b[c]=a[c];d();e();g()},getMap:function(a){return b.map}}}();VK2.Controller.MapSearchController=function(a,b,c){this._map=a;this._ftLayer=b;this._hoverLayer=c};VK2.Controller.MapSearchController.prototype.registerSearchTable=function(a){this._table=a};VK2.Controller.MapSearchController.prototype.addRowBehavior=function(a,b){this._addRowClickBehavior(a,b);this._addRowHoverBehavior(a,b)};
VK2.Controller.MapSearchController.prototype._addRowClickBehavior=function(a,b){var c=this._ftLayer;$(a).click(function(a){var e=b.geometry.getCentroid();c.map.setCenter(new OpenLayers.LonLat(e.x,e.y),4);$(this).trigger("mouseenter");$("#spatialsearch-tools-input-layer").val(b.data.time);goog.dom.classes.has(a.target,"anchor-show-metadata")&&(goog.isDefAndNotNull(goog.dom.getElement("metadata-record-parent"))||(a=goog.dom.createDom("div",{"class":"metadata-record",id:"metadata-record-parent"}),goog.dom.appendChild(document.body,
a)),a=b.geometry.bounds.left+","+b.geometry.bounds.bottom+","+b.geometry.bounds.right+","+b.geometry.bounds.top,e=goog.dom.createDom("a",{href:"/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+a+"&time="+b.data.time}),goog.dom.appendChild(document.body,e),$(e).fancybox({type:"iframe",href:"/vkviewer/profile/mtb?key="+b.data.dateiname+"&extent="+a+"&time="+b.data.time,width:"100%",height:"100%"}).trigger("click"))})};
VK2.Controller.MapSearchController.prototype._addRowHoverBehavior=function(a,b){var c=this._ftLayer,d=this._hoverLayer;$(a).hover(function(a){$(this).hasClass("hover-table")||($(this).addClass("hover-table"),d.updateGeometry(b.geometry))},function(a){$(this).hasClass("hover-table")&&($(this).removeClass("hover-table"),d.removeAllFeatures(),c.drawFeature(b))})};
VK2.Controller.MapSearchController.prototype.registerFeatureLayerBehavior=function(a){this._ftLoadingCbEl=a;this._ftLayer.events.register("loadstart",this,this._featureLoadingFeedback);this._ftLayer.events.register("loadend",this,this._featureLoadingFeedback);this._ftLayer.events.register("featuresadded",this,this._updateDisplayedFeatureData);this._ftLayer.events.register("featuresremoved",this,this._updateDisplayedFeatureData);this._map.events.register("moveend",this,this._updateLayerFeatures)};
VK2.Controller.MapSearchController.prototype.unregisterFeatureLayerBehavior=function(){this._ftLayer.events.unregister("loadstart",this,this._featureLoadingFeedback);this._ftLayer.events.unregister("loadend",this,this._featureLoadingFeedback);this._ftLayer.events.unregister("featuresadded",this,this._updateDisplayedFeatureData);this._ftLayer.events.unregister("featuresremoved",this,this._updateDisplayedFeatureData);this._map.events.unregister("moveend",this,this._updateLayerFeatures)};
VK2.Controller.MapSearchController.prototype._updateLayerFeatures=function(a){this._map.getResolution()<=this._ftLayer.maxResolution?this._ftLayer.refreshLayer():(this._updateDisplayedFeatureData(),$(this._ftLoadingCbEl).find(".content").html(VK2.Utils.get_I18n_String("change_zoomlevel")))};
VK2.Controller.MapSearchController.prototype._featureLoadingFeedback=function(a){var b=$(this._ftLoadingCbEl).find(".loading");"loadstart"==a.type?b.addClass("active"):"loadend"==a.type&&(b.hasClass("active")&&b.removeClass("active"),$(this._ftLoadingCbEl).find(".content").html(this._ftLayer.features.length+" "+VK2.Utils.get_I18n_String("found_mtb")))};
VK2.Controller.MapSearchController.prototype._updateDisplayedFeatureData=function(a){var b={};if(a)for(var c=0;c<a.features.length;c++){var d=a.features[c];b[d.data.mtbid]={titel:d.data.titel,time:d.data.time,csw_id:d.data.dateiname,feature:d}}this._table.refreshData(b);this._hoverLayer.activate()};VK2.Controller.LayerController=function(a){this._layer=a;var b=this._createLayerDomElement(a);this._createEventBehaviorToLayerElem(b,a);return b};
VK2.Controller.LayerController.createLayerControllerView=function(a,b){if(goog.isDefAndNotNull(a)){var c=goog.dom.createDom("li",{"class":"overlayElem"}),d=goog.dom.createDom("div",{"class":"overlayElemDiv"});goog.dom.appendChild(c,d);goog.dom.appendChild(d,this._createMinimizeOverlayView(a,b));goog.dom.appendChild(d,this._createMaximizeOverlayView(a));return c}};
VK2.Controller.LayerController._createMinimizeOverlayView=function(a,b){var c=goog.dom.createDom("div",{value:b,"class":"minimize"}),d=goog.dom.createDom("input",{id:a.id,name:a.name,value:a.name,checked:a.getVisibility(),defaultChecked:a.getVisibility(),"class":"olButton",_layer:a.id,_layerSwitcher:b,type:"checkbox"});a.inRange||(d.disabled=!0);goog.dom.appendChild(c,d);d=goog.dom.createDom("div",{value:a.id,text:a.name,"class":"vk2Label",innerHTML:a.name});goog.dom.appendChild(c,d);return c};
VK2.Controller.LayerController._createMaximizeOverlayView=function(a){var b=goog.dom.createDom("ul",{"class":"maximize"}),c=goog.dom.createDom("div",{"class":"layer-max-container"});goog.dom.appendChild(b,c);var d=goog.dom.createDom("div",{"class":"media"});goog.dom.appendChild(c,d);c=goog.dom.createDom("img",{alt:"...","class":"thumbnail pull-left media-object",src:a.thumbnail});goog.dom.appendChild(d,c);c=goog.dom.createDom("div",{"class":"media-body slider-container"});goog.dom.appendChild(d,c);
goog.dom.appendChild(c,this._createSliderView(a.id,"Opacity","opacity"));a.isTime&&goog.dom.appendChild(c,this._createSliderView(a.id,"Time","time"));return b};
VK2.Controller.LayerController._createSliderView=function(a,b,c){c=goog.dom.createDom("div",{"class":c});var d=goog.dom.createDom("div",{"class":"slider-outer"});goog.dom.appendChild(c,d);b=goog.dom.createDom("div",{"class":"label",innerHTML:b+":"});goog.dom.appendChild(d,b);a=goog.dom.createDom("div",{"class":"slider-inner",value:a});goog.dom.appendChild(d,a);d=goog.dom.createDom("div",{"class":"tooltip top in fade"});b=goog.dom.createDom("div",{"class":"tooltip-arrow"});var e=goog.dom.createDom("div",
{"class":"tooltip-inner"});goog.dom.appendChild(d,b);goog.dom.appendChild(d,e);goog.dom.appendChild(a,d);return c};VK2.Layer.GeoreferencerSearchLayer=VK2.Class({_settings:{wmsLayer:null,selectLayer:null,requestWfs:null,map:null,controls:{getfeature:null},eventListeners:{featureselected:function(a){this._settings.selectLayer.addFeatures([a.feature]);console.log("Feature selected - MTB "+a.feature.attributes.blattnr+", ID "+a.feature.attributes.id);a=VK2.Utils.getHost("vkviewer/choosegeoref?blattnr=")+a.feature.attributes.blattnr;$.fancybox.open([{href:a,width:"100%",height:"100%",type:"iframe"}])},featureunselected:function(a){this._settings.selectLayer.removeFeatures([a.feature]);
...
"_");b.isTime=!0;b.thumbnail="/vkviewer/static/images/layer_default.png";b.extent=a.extent;return b};VK2.Layer.TimeSearchLayer=function(a,b,c){var d=new OpenLayers.Strategy.Refresh({force:!0,active:!0}),e=new OpenLayers.Protocol.WFS({url:"http://194.95.145.43/cgi-bin/mtbows",geometryName:"boundingbox",featureNS:"http://mapserver.gis.umn.edu/mapserver",featurePrefix:"ms",featureType:"Historische_Messtischblaetter_WFS",srsName:"EPSG:900913",maxFeatures:1E4,version:"1.0.0"});b=new OpenLayers.Layer.Vector("Messtischblaetter",{displayInLayerSwitcher:!1,maxResolution:b,visibility:!1,strategies:[new OpenLayers.Strategy.BBOX({ratio:2}),
d],protocol:e});b._refresh=d;b._ftSource=e;b.timestamps=a;b.refreshLayer=function(a){a=a?a:this.map;this.filter=this._createTimeSpatialFilter(a.getExtent(),a.projection);this._refresh.refresh()};b._createTimeSpatialFilter=function(a,b){a=a?a:this.map.getExtent();var c=this.timestamps[0],d=this.timestamps[1]?this.timestamps[1]:this.timestamps[0];return new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,value:a,
projection:b?b:this.map.projection}),new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND,filters:[new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.GREATER_THAN_OR_EQUAL_TO,property:"time",value:c}),new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.LESS_THAN_OR_EQUAL_TO,property:"time",value:d})]})]})};b.filter=b._createTimeSpatialFilter(c.getExtent(),c.projection);return b};VK2.Layer.HoverLayer=function(){var a={},b=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);b.fillOpacity=0.2;b.strokeColor="blue";b.fillColor="blue";b.strokeWidth=3;a=new OpenLayers.Layer.Vector("HoverLayer",{displayInLayerSwitcher:!1,maxResolution:305.74811309814453,visibility:!1,style:b});a._style=b;a.updateGeometry=function(a){this.removeAllFeatures();a=a?a:(new OpenLayers.Bounds(1521175.510958,6568187.683823,1539726.583989,6585780.297411)).toGeometry();a=new OpenLayers.Feature.Vector(a);
this.addFeatures([a])};a.activate=function(){if(this.map){var a=this.map,b=a.getLayerIndex(this)+1;a.getNumLayers()>b&&a.setLayerIndex(this,a.getNumLayers()+1);this.setVisibility(!0)}};a.deactivate=function(){this.map&&this.setVisibility(!1)};return a};VK2.Events={};VK2.Events.EventType={PARSED_RECORD:goog.events.getUniqueId("parsed_record")};VK2.Events.ParsedCswRecordEvent=function(a,b){goog.events.Event.call(this,VK2.Events.EventType.PARSED_RECORD);this.parser=a;this.parsed_content=b};goog.inherits(VK2.Events.ParsedCswRecordEvent,goog.events.Event);goog.events.EventTarget=function(){goog.Disposable.call(this);this.eventTargetListeners_=new goog.events.ListenerMap(this);this.actualEventTarget_=this};goog.inherits(goog.events.EventTarget,goog.Disposable);goog.events.Listenable.addImplementation(goog.events.EventTarget);goog.events.EventTarget.MAX_ANCESTORS_=1E3;goog.events.EventTarget.prototype.parentEventTarget_=null;goog.events.EventTarget.prototype.getParentEventTarget=function(){return this.parentEventTarget_};
...
goog.json.Serializer.prototype.serializeObject_=function(a,b){b.push("{");var c="",d;for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var e=a[d];"function"!=typeof e&&(b.push(c),this.serializeString_(d,b),b.push(":"),this.serialize_(this.replacer_?this.replacer_.call(a,d,e):e,b),c=",")}b.push("}")};goog.structs.Collection=function(){};goog.structs.Set=function(a){this.map_=new goog.structs.Map;a&&this.addAll(a)};goog.structs.Set.getKey_=function(a){var b=typeof a;return"object"==b&&a||"function"==b?"o"+goog.getUid(a):b.substr(0,1)+a};goog.structs.Set.prototype.getCount=function(){return this.map_.getCount()};goog.structs.Set.prototype.add=function(a){this.map_.set(goog.structs.Set.getKey_(a),a)};goog.structs.Set.prototype.addAll=function(a){a=goog.structs.getValues(a);for(var b=a.length,c=0;c<b;c++)this.add(a[c])};
...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});VK2.Requests={};VK2.Requests.CSW_GetRecordById=function(){goog.events.EventTarget.call(this)};goog.inherits(VK2.Requests.CSW_GetRecordById,goog.events.EventTarget);VK2.Requests.CSW_GetRecordById._parentElement="gmd:MD_Metadata";
VK2.Requests.CSW_GetRecordById.SearchPaths={ONLINE_RESSOURCE:"gmd:distributionInfo gmd:MD_Distribution gmd:transferOptions gmd:MD_DigitalTransferOptions gmd:onLine gmd:CI_OnlineResource gmd:linkage gmd:URL".split(" "),ID:["gmd:fileIdentifier","gco:CharacterString"],LANGUAGE:["gmd:language","gco:CharacterString"],PARENT_ID:["gmd:parentIdentifier","gco:CharacterString"],LAST_UPDATE:["gmd:dateStamp","gco:Date"],REFERENCE_SYSTEM:"gmd:referenceSystemInfo gmd:MD_ReferenceSystem gmd:referenceSystemIdentifier gmd:RS_Identifier gmd:code gco:CharacterString".split(" "),
TITEL:"gmd:identificationInfo gmd:MD_DataIdentification gmd:citation gmd:CI_Citation gmd:title gco:CharacterString".split(" "),ABSTRACT:["gmd:identificationInfo","gmd:MD_DataIdentification","gmd:abstract","gco:CharacterString"],DENOMINATOR:"gmd:identificationInfo gmd:MD_DataIdentification gmd:spatialResolution gmd:MD_Resolution gmd:equivalentScale gmd:MD_RepresentativeFraction gmd:denominator gco:Integer".split(" "),THUMBNAIL:"gmd:identificationInfo gmd:MD_DataIdentification gmd:graphicOverview gmd:MD_BrowseGraphic gmd:fileName gco:CharacterString".split(" ")};
VK2.Requests.CSW_GetRecordById.prototype.getRecord=function(a,b){console.log("Record-ID: "+a+" Service-URL: "+b);requestUrl=VK2.Utils.Settings.proxy_url+b;xmlRequest='<?xml version="1.0"?><csw:GetRecordById xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" service="CSW" version="2.0.2" outputSchema="csw:IsoRecord"><csw:Id>'+a+"</csw:Id></csw:GetRecordById>";var c=new goog.net.XhrIo;goog.events.listenOnce(c,goog.net.EventType.SUCCESS,function(a){a=a.target;var b=a.getResponseXml(),b=VK2.Requests.CSW_GetRecordById._parseGetRecordResponse(b);
this.dispatchEvent(new VK2.Events.ParsedCswRecordEvent(this,b));a.dispose()},!1,this);c.send(requestUrl,"POST",xmlRequest,{"Content-Type":"application/xml;charset=UTF-8"})};VK2.Requests.CSW_GetRecordById._parseGetRecordResponse=function(a){var b=this._parentElement;a=goog.dom.findNode(a,function(a){return a.nodeType==goog.dom.NodeType.ELEMENT&&a.tagName==b});var c={},d;for(d in this.SearchPaths)this.SearchPaths.hasOwnProperty(d)&&(c[d]=this._getChildNode(a,this.SearchPaths[d]));return c};
VK2.Requests.CSW_GetRecordById._getChildNode=function(a,b){var c=[],d=goog.dom.findNodes(a,function(a){return a.nodeType==goog.dom.NodeType.ELEMENT&&a.tagName==b[0]}),e=goog.array.slice(b,1);if(0<e.length)for(var f=0;f<d.length;f++)goog.array.extend(c,this._getChildNode(d[f],e));else for(f=0;f<d.length;f++)goog.array.insert(c,d[f].textContent);return c};VK2.Tools.Gazetteersearch=function(a,b,c){this._gazetteerElement=a;goog.isDef(this._gazetteerElement.parentElement)&&(this._parentElement=this._gazetteerElement.parentElement);this._map=b;console.log("Load Gazetteersearch.");this._loadGazetteerBehavior(this._gazetteerElement,this._map)};
VK2.Tools.Gazetteersearch.prototype._loadGazetteerBehavior=function(a,b){$(a).autocomplete({source:function(a,d){VK2.Validation.isBlattnumber(a.term)?(d(),$.ajax({url:"/vkviewer/proxy/?url=http://139.30.111.16/fgs/vkll/fragblattnr.php?blattnr="+a.term,success:$.proxy(function(a){""!=a?(a=JSON.parse(a),VK2.Utils.jumptolonlat(b,a.coordinates[0],a.coordinates[1])):alert(VK2.Utils.get_I18n_String("noResultsBlattnr"))},this)})):$.ajax({url:"http://open.mapquestapi.com/nominatim/v1/search.php",dataType:"json",
data:{featureClass:"P",style:"full",maxRows:8,format:"json",q:a.term,viewbox:"4.35,58.48,27.78,45.97",bounded:1},success:function(a){d($.map(a,function(a){return{label:a.display_name,value:a.display_name,lonlat:new OpenLayers.LonLat(a.lon,a.lat),type:a.type}}))}})},delay:500,minLength:3,autoFocus:!0,select:function(a,d){console.log("Type: "+d.item.type);switch(d.item.type){case "administrative":b.setCenter(d.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),5);
break;case "city":b.setCenter(d.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),5);break;case "village":b.setCenter(d.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),8);default:b.setCenter(d.item.lonlat.transform(new OpenLayers.Projection("EPSG:4326"),b.getProjectionObject()),10)}},open:function(){$(this).removeClass("ui-corner-all").addClass("ui-corner-top")},close:function(){$(this).removeClass("ui-corner-top").addClass("ui-corner-all")}})};
VK2.Tools.Gazetteersearch.prototype._loadSubmitBehavior=function(a,b){var c=goog.dom.getElementsByTagNameAndClass("BUTTON","gazetteer-submit-button",a);goog.isDef(c)&&($(c).click(function(a){$(b).data("ui-autocomplete")._trigger("select")}),console.log("Add submit Button to Gazetteersearch."))};VK2.Tools.GeoreferencerChooser=function(a,b){this._settings={wmsLayer:new OpenLayers.Layer.WMS("georeferencer_wms_1","http://194.95.145.43/cgi-bin/mtb_grid",{layers:"mtb_grid_puzzle",transparent:!0},{isBaseLayer:!1,displayInLayerSwitcher:!0,singleTile:!0}),requestWfs:new OpenLayers.Protocol.WFS({url:"http://194.95.145.43/cgi-bin/mtb_grid",geometryName:"the_geom",featureNS:"http://mapserver.gis.umn.edu/mapserver",featurePrefix:"ms",featureType:"mtb_grid",srsName:"EPSG:3857",maxFeatures:1E3,version:"1.0.0"}),
map:null};goog.object.extend(this._settings,a);this._georefLayer=new VK2.Layer.GeoreferencerSearchLayer({wmsLayer:this._settings.wmsLayer,requestWfs:this._settings.requestWfs,map:this._settings.map});goog.isDefAndNotNull(b)&&(this._layerbar=b);this._isActive=!1};VK2.Tools.GeoreferencerChooser.prototype.activate=function(){goog.isDef(this._layerbar)&&!this._isActive&&this._layerbar.hideOverlayLayers();this._georefLayer.activate();this._isActive=!0};
VK2.Tools.GeoreferencerChooser.prototype.deactivate=function(){goog.isDef(this._layerbar)&&this._isActive&&this._layerbar.showOverlayLayers();this._georefLayer.deactivate();this._isActive=!1};VK2.Tools.ReportError=VK2.Class({_settings:{formClassEl:{jqueryDialogClass:"vk2ReportErrorDialogContainer",dialogContainer:"vk2ReportErrorDialog",textArea:"vk2ErrorReportField",hiddenId:"vk2ErrorReportObjectId",hiddenRef:"vk2ErrorReportObjectRef"}},_updateSettings:function(a){for(var b in a)this._settings[b]=a[b]},_loadHTMLContent:function(){var a=$("<div/>",{id:this._settings.formClassEl.dialogContainer,"class":this._settings.formClassEl.dialogContainer}).appendTo(document.body);$("<textarea/>",
{id:this._settings.formClassEl.textArea,"class":this._settings.formClassEl.textArea+" ui-corner-all ui-widget-content"}).appendTo(a);$("<input/>",{id:this._settings.formClassEl.hiddenId,type:"hidden",name:"id"}).appendTo(a);$("<input/>",{id:this._settings.formClassEl.hiddenRef,type:"hidden",name:"reference"}).appendTo(a)},_loadJQDialog:function(){$("#"+this._settings.formClassEl.dialogContainer).dialog({autoOpen:!1,height:"auto",width:"auto",modal:!0,dialogClass:this._settings.formClassEl.jqueryDialogClass,
buttons:{Submit:$.proxy(function(){var a=document.getElementById(this._settings.formClassEl.textArea).value,b=document.getElementById(this._settings.formClassEl.hiddenId).value,c=document.getElementById(this._settings.formClassEl.hiddenRef).value;$.ajax({url:"../reporterror",type:"GET",data:{message:a,id:b,reference:c},success:$.proxy(function(a){$("#"+this._settings.formClassEl.dialogContainer).dialog("close");alert(VK2.Utils.get_I18n_String("report_error_confirmed"))},this),error:$.proxy(function(a){$("#"+
this._settings.formClassEl.dialogContainer).dialog("close");alert(VK2.Utils.get_I18n_String("report_error_alert"))},this),complete:$.proxy(function(a){$("#"+this._settings.formClassEl.dialogContainer).dialog("close")},this)})},this),Cancel:function(){$(this).dialog("close")}},close:function(){$(this).dialog("close")}})},initialize:function(a){this._updateSettings(a);this._loadHTMLContent();this._loadJQDialog()},reportError:function(a,b){$("#"+this._settings.formClassEl.hiddenId).val(a);$("#"+this._settings.formClassEl.hiddenRef).val(b);
$("#"+this._settings.formClassEl.textArea).val("");$("#"+this._settings.formClassEl.dialogContainer).dialog("option","title",VK2.Utils.get_I18n_String("report_error_titel")+": "+a).dialog("open")}});VK2.Tools.Georeferencer=function(a,b){this._settings={urlParams:null,container:"vk2GeoreferenceToolsPanel",handler:"vk2GeoreferenceToolsHandle",map:null,controller:VK2.Controller.GeoreferenceController,vectorLayer:null,status:"georeference"};for(var c in a)a.hasOwnProperty(c)&&(this._settings[c]=a[c]);this._loadHTMLContent();this._loadGeoreferenceTools();document.getElementById("mtbid").value=b;this._initializeGeoreferenceController()};
VK2.Tools.Georeferencer.prototype._initializeGeoreferenceController=function(){this._settings.controller.initialize({map:this._settings.map,vectorLayer:this._settings.vectorLayer,urlParams:this._settings.urlParams,status:this._settings.status})};
VK2.Tools.Georeferencer.prototype._loadHTMLContent=function(){var a=goog.dom.createDom("div",{"class":"GeoreferenceToolsContent"});goog.dom.appendChild(goog.dom.getElement(this._settings.container),a);var b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(a,b);var c=goog.dom.createDom("input",{type:"radio",name:"type",value:"none",id:"noneToggle",checked:"checked"}),d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("moveMap")}));
goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(a,b);c=goog.dom.createDom("input",{type:"radio",name:"type",value:"point",id:"pointToggle"});d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("setCornerPoint")}));goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(a,b);c=goog.dom.createDom("input",{type:"radio",name:"type",
value:"drag",id:"dragToggle"});d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("moveCornerPoint")}));goog.dom.appendChild(b,d);b=goog.dom.createDom("div",{"class":"radio"});goog.dom.appendChild(a,b);c=goog.dom.createDom("input",{type:"radio",name:"type",value:"delete",id:"deleteToggle"});d=goog.dom.createDom("label",{});goog.dom.appendChild(d,c);goog.dom.appendChild(d,goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("deleteCornerPoint")}));
goog.dom.appendChild(b,d);goog.dom.appendChild(a,goog.dom.createDom("br",{}));b=goog.dom.createDom("input",{type:"hidden",id:"mtbid",name:"mtbid"});goog.dom.appendChild(a,b);b=goog.dom.createDom("input",{type:"hidden",id:"points",name:"points"});goog.dom.appendChild(a,b);this._loadHTMLEventBtns(a)};
VK2.Tools.Georeferencer.prototype._loadHTMLEventBtns=function(a){var b,c="";"georeference"==this._settings.status?(b=VK2.Utils.get_I18n_String("validateBtn_georeference"),c=VK2.Utils.get_I18n_String("submitBtn_georeference")):"validate"==this._settings.status&&(b=VK2.Utils.get_I18n_String("validateBtn_validate"),c=VK2.Utils.get_I18n_String("submitBtn_validate"));b=goog.dom.createDom("input",{type:"button",id:"btnValidate","class":"vk2GeorefToolsBtn btn btn-default",value:b});goog.dom.appendChild(a,
b);c=goog.dom.createDom("input",{type:"button",id:"btnSubmit","class":"vk2GeorefToolsBtn btn btn-default",value:c});goog.dom.appendChild(a,c)};VK2.Tools.Georeferencer.prototype._loadLayerPointsFromUrl=function(){if(this._settings.urlParams.get("points"))for(zaehler in returnpoints=this._settings.urlParams.get("points").split(","),returnpoints)latLon=returnpoints[zaehler],latLon=latLon.replace(/:/g,","),latLon=latLon.split(","),kringel=new OpenLayers.Geometry.Point(latLon[0],latLon[1]),this._settings.vectorLayer.addFeatures([new OpenLayers.Feature.Vector(kringel)])};
VK2.Tools.Georeferencer.prototype._loadGeoreferenceToolLayers=function(){var a=OpenLayers.Util.getParameters(window.location.href).renderer,a=a?[a]:OpenLayers.Layer.Vector.prototype.renderers;this._settings.vectorLayer=new OpenLayers.Layer.Vector("Eckpunkte",{styleMap:VK2.Styles.FeatureLayerStyles._georeferenceLayerStyles,renderers:a});this._settings.map.addLayer(this._settings.vectorLayer);this._loadLayerPointsFromUrl()};
VK2.Tools.Georeferencer.prototype._loadGeoreferenceTabSlider=function(){$("#"+this._settings.container).tabSlideOut({tabHandle:"."+this._settings.handler,pathToTabImage:$("#"+this._settings.handler).attr("data-open"),pathToTabImageClose:$("#"+this._settings.handler).attr("data-close"),imageHeight:"40px",imageWidth:"40px",speed:300,action:"click",topPos:"250px",fixedPosition:!1,onLoadSlideOut:!0})};
VK2.Tools.Georeferencer.prototype._loadGeoreferenceTools=function(){this._loadGeoreferenceToolLayers();this._loadGeoreferenceTabSlider()};VK2.Tools.Layerbar=function(a){this.ascending=!0;goog.isDef(VK2.Utils.get_I18n_String)?this.NAME=VK2.Utils.get_I18n_String("toolname_layerbar"):this.NAME="Layerbar";this._map=a.map;this._div=a.div;this._id=a.id;goog.isDef(a.vk2featurelayer)?this._vk2FeatureLayer=a.vk2featurelayer:this._vk2FeatureLayer=new Vk2FeatureLayer;goog.isDef(a.displayBtn)?this.displayBtn=a.displayBtn:this.displayBtn=!1;this.baseLayers=[];this.overlayLayers=[];this.layerStates=[];this.draw()};
VK2.Tools.Layerbar.prototype.destroy=function(){this.clearLayersArray("vk2Data");this._map.events.un({buttonclick:onButtonClick,addlayer:this.redraw,changelayer:this.redraw,removelayer:this.redraw,changebaselayer:this.redraw,scope:this})};VK2.Tools.Layerbar.prototype.setMap=function(a){this._map.events.on({addlayer:this.redraw,changelayer:this.redraw,removelayer:this.redraw,changebaselayer:this.redraw,scope:this})};VK2.Tools.Layerbar.prototype.draw=function(){this._loadContents();this.redraw();return this._div};
VK2.Tools.Layerbar.prototype.clearLayersArray=function(a){this[a+"LayersDiv"].innerHTML="";this[a+"Layers"]=[]};VK2.Tools.Layerbar.prototype.checkRedraw=function(){if(!this.layerStates.length||this._map.layers.length!=this.layerStates.length)return!0;for(var a=0,b=this.layerStates.length;a<b;a++){var c=this.layerStates[a],d=this._map.layers[a];if(c.name!=d.name||c.inRange!=d.inRange||c.id!=d.id||c.visibility!=d.visibility)return!0}return!1};
VK2.Tools.Layerbar.prototype.redraw=function(){if(!this.checkRedraw())return this._div;this.clearLayersArray("overlay");var a=this._map.layers.length;this.layerStates=Array(a);for(var b=0;b<a;b++){var c=this._map.layers[b];this.layerStates[b]={name:c.name,visibility:c.visibility,inRange:c.inRange,id:c.id}}var d=this._map.layers.slice();this.ascending||d.reverse();b=0;for(a=d.length;b<a;b++){var c=d[b],e=c.isBaseLayer;c.displayInLayerSwitcher&&!e&&(this.overlayLayersDiv.appendChild(this._createLayerElement(c)),
this.overlayLayers.push(c))}return this._div};VK2.Tools.Layerbar.prototype.updateMap=function(){for(var a=0,b=this.baseLayers.length;a<b;a++){var c=this.baseLayers[a];c.inputElem.checked&&this._map.setBaseLayer(c.layer,!1)}a=0;for(b=this.overlayLayers.length;a<b;a++){var c=this.overlayLayers[a],d=document.getElementById(c.id).checked;c.setVisibility(d)}};
VK2.Tools.Layerbar.prototype.onButtonClick=function(a){a=a.currentTarget;a===this.minimizeDiv?this.minimizeControl():a===this.maximizeDiv?this.maximizeControl():a._layerSwitcher===this._id&&(a["for"]&&(a=document.getElementById(a["for"])),a.disabled||("radio"==a.type?(a.checked=!0,this._map.setBaseLayer(this._map.getLayer(a._layer))):this.updateMap()))};VK2.Tools.Layerbar.prototype.maximizeControl=function(a){this._div.style.width="";this._div.style.height="";this.showControls(!1)};
VK2.Tools.Layerbar.prototype.minimizeControl=function(a){this._div.style.width="0px";this._div.style.height="0px";this.showControls(!0)};VK2.Tools.Layerbar.prototype.showControls=function(a){this.maximizeDiv.style.display=a?"":"none";this.minimizeDiv.style.display=a?"none":"";this.layersDiv.style.display=a?"none":""};VK2.Tools.Layerbar.prototype._opacitySliderEvent=function(a,b){var c=b.value/100;this._getLayerToEvent(a).setOpacity(c);return null};
VK2.Tools.Layerbar.prototype._timeSliderEvent=function(a,b){for(var c=b.value,d=this._getLayerToEvent(a),e=$(document).find("div.vk2Label"),f=0;f<e.length;f++)e[f].value==a.target.value&&(e[f].innerHTML=d.name+" "+c,d.oldTime=d.params.TIME,d.params.TIME=c,d.timeFtLayer.updateFeatures(),d.redraw(!0))};VK2.Tools.Layerbar.prototype._createLayerElement=function(a){var b=VK2.Controller.LayerController.createLayerControllerView(a,this._id);this._addEventBehaviorToLayerControlView(b,a);return b};
VK2.Tools.Layerbar.prototype._addEventBehaviorToLayerControlView=function(a,b){$(a).find("ul").hide();$(a).find(".minimize").find(".vk2Label").click(function(b){$(a).find("ul").slideToggle()});$(a).find(".olButton").click($.proxy(this.onButtonClick,this));this._addSliderBehaviour({sliderDiv:$(a).find(".opacity").find(".slider-inner"),value:100,min:0,max:100,step:1},this._opacitySliderEvent);if(b.isTime){this._addSliderBehaviour({sliderDiv:$(a).find(".time").find(".slider-inner"),value:b.params.TIME,
min:1868,max:1945,step:1},this._timeSliderEvent);var c=b.name+" "+b.params.TIME;$(a).find(".minimize").find(".vk2Label").html(c)}return b};
VK2.Tools.Layerbar.prototype._addSliderBehaviour=function(a,b){$(a.sliderDiv).slider({min:a.min,max:a.max,value:a.value,animate:"slow",orientation:"horizontal",step:1,start:function(a,b){$(this.parentElement).find(".tooltip").fadeIn("fast")},slide:function(b,d){var e=$(this.parentElement).find(".tooltip");e.css("left",-1*(a.min-d.value- -15)+"px");e.find(".tooltip-inner").html(d.value)},stop:function(a,b){$(this.parentElement).find(".tooltip").fadeOut("fast")},change:$.proxy(b,this)});return!0};
VK2.Tools.Layerbar.prototype._getLayerToEvent=function(a){for(var b=0;b<this._map.layers.length;b++)if(this._map.layers[b].id===a.target.value)return this._map.layers[b];return null};
VK2.Tools.Layerbar.prototype._loadContents=function(){this.layersDiv=document.createElement("div");this.layersDiv.id=this._id+"_layersDiv";this.layersDiv.className+=" layersDiv";this.vk2DataLayersLbl=document.createElement("div");this.vk2DataLayersLbl.innerHTML="Overlays";this.vk2DataLayersLbl.className+=" overlayLbls";this.overlayLayersDiv=document.createElement("div");this.overlayLayersDiv.className+=" overlayDivs";this.layersDiv.appendChild(this.vk2DataLayersLbl);this.layersDiv.appendChild(this.overlayLayersDiv);
this._div.appendChild(this.layersDiv);if(!1!=this.displayBtn){var a=OpenLayers.Util.getImageLocation("layer-switcher-maximize.png");this.maximizeDiv=OpenLayers.Util.createAlphaImageDiv("OpenLayers_Control_MaximizeDiv",null,null,a,"absolute");OpenLayers.Element.addClass(this.maximizeDiv,"maximizeDiv");this.maximizeDiv.style.display="none";$(this.maximizeDiv).click($.proxy(this.onButtonClick,this));this._div.appendChild(this.maximizeDiv);a=OpenLayers.Util.getImageLocation("layer-switcher-minimize.png");
this.minimizeDiv=OpenLayers.Util.createAlphaImageDiv("OpenLayers_Control_MinimizeDiv",null,null,a,"absolute");OpenLayers.Element.addClass(this.minimizeDiv,"minimizeDiv");this.minimizeDiv.style.display="";$(this.minimizeDiv).click($.proxy(this.onButtonClick,this));this._div.appendChild(this.minimizeDiv)}};VK2.Tools.Layerbar.prototype.addLayer=function(a){this._map.addLayer(a);a.isBaseLayer||a.getVisibility();this.redraw();return!0};VK2.Tools.Layerbar.prototype.activate=function(){this._vk2FeatureLayer.activate(this._map)};
VK2.Tools.Layerbar.prototype.deactivate=function(){this._vk2FeatureLayer.deactivate(this._map)};VK2.Tools.Layerbar.prototype.hideOverlayLayers=function(){for(var a=0;a<this.overlayLayers.length;a++)this.overlayLayers[a].setVisibility(!1)};VK2.Tools.Layerbar.prototype.showOverlayLayers=function(){for(var a=0;a<this.overlayLayers.length;a++)this.overlayLayers[a].setVisibility(!0)};VK2.Tools.Sidebar=VK2.Class({_settings:{sidebarPanel:"vk2SBPanel",sidebarContentPanel:"vk2SBContentPanel",sidebarBodyPanel:"vk2SidebarBodyPanel",sidebarHeaderPanel:"vk2SBHeaderPanel",sidebarHeaderLabel:"vk2SBHeaderLabel",sidebarHeaderClose:"vk2SBClose",sidebarIcon:"vk2SidebarIcon",sidebarControlBtn:"vk2SBControlBtn",sidebarToolActive:"vk2ToolActivate"},_sidebarController:null,_updateSettings:function(a){for(var b in a)this._settings[b]=a[b]},_loadHtmlElements:function(a){var b=$("#"+this._settings.sidebarPanel),
...
this._createLoadingScreen()},setStatus:function(a){this._settings.status=a;this._updateLoadingScreen(a)},clearLoadingScreen:function(){$("#loadingScreen").remove()}});VK2.Tools.MapSearch=function(a,b,c,d,e){this._map=a;this._feedBackEl=document.getElementById(d);this._hoverLayer=new VK2.Layer.HoverLayer;this._ftLayer=new VK2.Layer.TimeSearchLayer(c,b,this._map);this._controller=new VK2.Controller.MapSearchController(this._map,this._ftLayer,this._hoverLayer);this._table=new VK2.Tools.SearchTable(e,[{id:"time",title:VK2.Utils.get_I18n_String("timestamp")},{id:"titel",title:VK2.Utils.get_I18n_String("titel")}],this._controller);this._controller.registerSearchTable(this._table)};
VK2.Tools.MapSearch.prototype.updateTimestamp=function(a,b){this._ftLayer.timestamps=b;this._ftLayer.refreshLayer()};VK2.Tools.MapSearch.prototype.activate=function(){-1==this._map.getLayerIndex(this._ftLayer)&&(this._map.addLayer(this._hoverLayer),this._map.addLayer(this._ftLayer),this._controller.registerFeatureLayerBehavior(this._feedBackEl));this._ftLayer.setVisibility(!0);this._ftLayer.refreshLayer();this._hoverLayer.setVisibility(!0)};
VK2.Tools.MapSearch.prototype.deactivate=function(){this._ftLayer.setVisibility(!1);this._hoverLayer.setVisibility(!1);this._table.refreshData({})};goog.ui={};goog.ui.IdGenerator=function(){};goog.addSingletonGetter(goog.ui.IdGenerator);goog.ui.IdGenerator.prototype.nextId_=0;goog.ui.IdGenerator.prototype.getNextUniqueId=function(){return":"+(this.nextId_++).toString(36)};VK2.Tools.SearchTable=function(a,b,c){this._parentId=a;(this._parentEl=goog.dom.getElement(a))||console.log("Could not find parent element for SearchTable object.");if(goog.isDef(b)){this._headingCol=b;this._columnIds=[];for(var d in this._headingCol)this._headingCol.hasOwnProperty(d)&&this._columnIds.push(this._headingCol[d].id);console.log("Length: "+this._columnIds.length)}this._idGenerator=goog.ui.IdGenerator.getInstance();this.tableId="searchTable"+this._idGenerator.getNextUniqueId();this._controller=
c;this._createTable()};
VK2.Tools.SearchTable.prototype._createTable=function(){var a=goog.dom.createDom("table",{id:this.tableId,"class":"table zebra-striped tablesorter"}),b=goog.dom.createDom("colgroup",{}),c=goog.dom.createDom("col",{"class":"span3",span:"1"}),d=goog.dom.createDom("col",{"class":"span6",span:"1"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,d);var c=goog.dom.createDom("thead",{"class":"table-heading"}),d=goog.dom.createDom("tr",{"class":"table-heading-row"}),e;for(e in this._headingCol)if(this._headingCol.hasOwnProperty(e)){var f=goog.dom.createDom("th",
{id:"header-col-"+this._headingCol[e].id,"class":"header-col col-"+this._headingCol[e].id}),g=goog.dom.createDom("div",{"class":this._headingCol[e].id,innerHTML:this._headingCol[e].title});goog.dom.appendChild(f,g);goog.dom.appendChild(d,f)}this._tableBody=goog.dom.createDom("tbody",{"class":"table-body"});goog.dom.appendChild(c,d);goog.dom.appendChild(a,b);goog.dom.appendChild(a,c);goog.dom.appendChild(a,this._tableBody);goog.dom.appendChild(this._parentEl,a);$(document.getElementById(this.tableId)).tablesorter()};
VK2.Tools.SearchTable._mdFancyBoxClass="fancybox-md";VK2.Tools.SearchTable.prototype._createMetadataCol=function(a,b,c){return goog.dom.createDom("td",{"class":"data-col-"+a+" col-"+a,innerHTML:b+' (<a href="#" class="anchor-show-metadata">'+VK2.Utils.get_I18n_String("show_metadata")+"</a>)"})};
VK2.Tools.SearchTable.prototype.refreshData=function(a){$(this._tableBody).empty();for(key in a){for(var b=goog.dom.createDom("tr",{id:key,"class":"data-row"}),c=0;c<this._columnIds.length;c++){var d="titel"==this._columnIds[c]&&a[key].csw_id?this._createMetadataCol(this._columnIds[c],a[key][this._columnIds[c]],a[key].csw_id):goog.dom.createDom("td",{"class":"data-col-"+this._columnIds[c]+" col-"+this._columnIds[c],innerHTML:a[key][this._columnIds[c]]});goog.dom.appendChild(b,d)}this._controller.addRowBehavior(b,
a[key].feature);goog.dom.appendChild(this._tableBody,b)}$(document.getElementById(this.tableId)).trigger("update");VK2.Utils.initializeFancyboxForClass(this._mdFancyBoxClass)};VK2.Tools.SpatialSearch=function(a,b,c){this.NAME=VK2.Utils.get_I18n_String("toolname_layersearch");this._timeParams={extent:null,time:null,wms:"http://194.95.145.43/mapcache",wms_layer:"messtischblaetter",wfs:"http://194.95.145.43/cgi-bin/mtbows",layer:"Historische Messtischblaetter",featureType:"Historische_Messtischblaetter_WFS",featurePrefix:"ms",featureNS:"http://mapserver.gis.umn.edu/mapserver",geometryName:"boundingbox",serviceVersion:"1.0.0",maxFeatures:1E4,srsName:"EPSG:900913",maxResolution:305.74811309814453};
this._parentElement=a;this._elementIds={headerPanel:"panel-heading-mapsearch",tablePanel:"panel-spatialsearch-table",toolsPanel:"panel-spatialsearch-tools"};this._toolElementIds={slider:"spatialsearch-tools-slider",label_start:"spatialsearch-slider-label-start",label_end:"spatialsearch-slider-label-end",btn:"spatialsearch-tools-btn-add-layer",input_field:"spatialsearch-tools-input-layer"};this._timestamps=[1868,1945];this._maxResolution=305.74811309814453;this._map=b;this._pubSubHandler=c;this._isActive=
!1;this._mapsearch=null;this._loadHtmlContent();this._loadBehavior()};
VK2.Tools.SpatialSearch.prototype._loadHtmlContent=function(){var a=goog.dom.createDom("div",{id:"panel-layersearch","class":"panel panel-default searchTablePanel"});goog.dom.appendChild(this._parentElement,a);var b=goog.dom.createDom("div",{id:this._elementIds.headerPanel,"class":"panel-heading"}),c=goog.dom.createDom("div",{id:"panel-heading-content","class":"content",innerHTML:VK2.Utils.get_I18n_String("change_zoomlevel")}),d=goog.dom.createDom("div",{"class":"loading"});goog.dom.appendChild(b,
c);goog.dom.appendChild(b,d);goog.dom.appendChild(a,b);b=goog.dom.createDom("div",{id:this._elementIds.tablePanel,"class":"panel-mapsearch-table"});goog.dom.appendChild(a,b);b=goog.dom.createDom("div",{id:this._elementIds.toolsPanel,"class":"panel-spatialsearch-tools"});goog.dom.appendChild(a,b);var a=goog.dom.createDom("div",{"class":"time-slider-container"}),c=goog.dom.createDom("div",{id:this._toolElementIds.label_start,"class":"slider-label slider-label-start"}),d=goog.dom.createDom("div",{id:this._toolElementIds.label_end,
"class":"slider-label slider-label-end"}),e=goog.dom.createDom("div",{id:this._toolElementIds.slider,"class":"slider"});goog.dom.appendChild(a,c);goog.dom.appendChild(a,e);goog.dom.appendChild(a,d);goog.dom.appendChild(b,a);a=goog.dom.createDom("div",{"class":"layer-chooser-container"});c=goog.dom.createDom("input",{id:this._toolElementIds.input_field,"class":"layer-chooser-input",type:"text"});d=goog.dom.createDom("button",{id:this._toolElementIds.btn,"class":"layer-chooser-btn",innerHTML:VK2.Utils.get_I18n_String("displaytimestamp")});
goog.dom.appendChild(a,c);goog.dom.appendChild(a,d);goog.dom.appendChild(b,a)};
VK2.Tools.SpatialSearch.prototype._loadBehavior=function(){this._mapsearch=new VK2.Tools.MapSearch(this._map,this._maxResolution,this._timestamps,this._elementIds.headerPanel,this._elementIds.tablePanel);var a=document.getElementById(this._toolElementIds.slider),b=document.getElementById(this._toolElementIds.label_start),c=document.getElementById(this._toolElementIds.label_end),a=$(a).slider({range:!0,min:this._timestamps[0],max:this._timestamps[1],values:this._timestamps,animate:"slow",orientation:"horizontal",
step:1,slide:function(a,e){$(b).text(e.values[0]);$(c).text(e.values[1])},change:$.proxy(function(a,b){this._mapsearch.updateTimestamp(a,b.values)},this)});$(b).text(a.slider("values",0));$(c).text(a.slider("values",1));a=document.getElementById(this._toolElementIds.btn);$(a).button().click($.proxy(function(a){a=$(document.getElementById(this._toolElementIds.input_field)).val();null!=this._pubSubHandler&&(4==a.length&&"number"===typeof parseInt(a)?(this._timeParams.extent=this._map.getExtent(),this._timeParams.time=
a,this._pubSubHandler.publish("addtimelayer",this._timeParams)):alert(VK2.Utils.get_I18n_String("choose_valide_timestamp")))},this))};VK2.Tools.SpatialSearch.prototype.activate=function(){this._mapsearch.activate();this._isActive=!0};VK2.Tools.SpatialSearch.prototype.deactivate=function(){this._mapsearch.deactivate();this._isActive=!1};VK2.Tools.MesstischblattViewer=function(a,b){this._mtbProps={width:0,height:0,zoomify_url:"",extent:[1409871.625,6603406.5,1428422.75,6621075],projection:"EPSG:900913",crossOrigin:"anonymous",full_screen:!0,zoomToMaxExtent:!0,layerSpy:!0,time:"",minResolution:0,maxResolution:76.43702827453613};goog.object.extend(this._mtbProps,b);this._borderLayer=this._createBorderLayer(this._mtbProps.extent);this._baseLayer=new ol.layer.Tile({source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution});
this._mtbLayer=new ol.layer.Tile({source:new ol.source.TileWMS({url:"http://194.95.145.43/mapcache",params:{LAYERS:"messtischblaetter",TIME:this._mtbProps.time,VERSION:"1.1.1"},projection:this._mtbProps.projection,extent:this._mtbProps.extent}),maxResolution:this._mtbProps.maxResolution});this._map=new ol.Map({layers:[this._baseLayer,this._mtbLayer,this._borderLayer],interactions:ol.interaction.defaults().extend([new ol.interaction.DragRotateAndZoom]),renderer:ol.RendererHint.CANVAS,target:a,view:new ol.View2D({projection:this._mtbProps.projection,
minResolution:2*this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution/2,extent:this._mtbProps.extent}),controls:[new ol.control.Attribution,new ol.control.Zoom,new ol3.control.RotateNorth]});this._map.getView().fitExtent(this._mtbProps.extent,this._map.getSize());this._loadControls()};
VK2.Tools.MesstischblattViewer.prototype._loadControls=function(){this._mtbProps.full_screen&&this._map.addControl(new ol.control.FullScreen);this._mtbProps.zoomToMaxExtent&&this._map.addControl(new ol.control.ZoomToExtent({extent:this._mtbProps.extent}));this._mtbProps.layerSpy&&this._map.addControl(new ol3.control.LayerSpy({spyLayer:new ol.layer.Tile({attribution:void 0,source:new ol.source.OSM,minResolution:this._mtbProps.minResolution,maxResolution:this._mtbProps.maxResolution})}))};
VK2.Tools.MesstischblattViewer.prototype._createBorderLayer=function(a){var b=[new ol.style.Style({stroke:new ol.style.Stroke({color:"#000000",width:3})})];a=new ol.source.Vector({features:[new ol.Feature(new ol.geom.Polygon([[[a[0],a[1]],[a[0],a[3]],[a[2],a[3]],[a[2],a[1]]]]))]});return new ol.layer.Vector({source:a,styleFunction:function(a,d){return b}})};VK2.Tools.MesstischblattViewer.prototype.getMap=function(){return this._map};VK2.Tools.MetadataVisualizer=function(a,b,c){this._parentEl=goog.dom.getElement(a);this._settings={csw_url:"http://kartenforum.slub-dresden.de/geonetwork/srv/eng/csw",thumbnail:!1,displayInFancybox:!1};goog.object.extend(this._settings,c);this._settings.displayInFancybox&&this._initFancyBox();var d=this;a=new VK2.Requests.CSW_GetRecordById;a.addEventListener(VK2.Events.EventType.PARSED_RECORD,function(a){d.displayCswIsoRecord(a)});response=a.getRecord(b,this._settings.csw_url)};
VK2.Tools.MetadataVisualizer.prototype._initFancyBox=function(){$(this._parentEl).fancybox({parentEl:this._parentEl,parentObj:this,maxWidth:800,maxHeight:600,fitToView:!1,autoSize:!1,width:"100%",height:"100%",closeClick:!1,closeEffect:"none",beforeShow:function(){var a=goog.style.getSize(this.parentEl),b=goog.object.get(a,"width")+20;this.width=goog.isDef(b)?b+"px":"100%";a=goog.object.get(a,"height");this.height=goog.isDef(a)?a+"px":"100%"},afterShow:function(){goog.style.setStyle(this.parentEl,
"display","block")},afterClose:function(){goog.style.setStyle(this.parentEl,"display","none");this.parentObj._clearHtmlContent();this.parentObj=null;delete this.parentObj}}).click()};VK2.Tools.MetadataVisualizer.prototype.displayCswIsoRecord=function(a){a=a.parsed_content;this._createTable();this._createHeader(a.TITEL[0],a.ABSTRACT[0],a.THUMBNAIL[0]);this._createContent(a,this._tBody)};
VK2.Tools.MetadataVisualizer.prototype._createTable=function(){var a=goog.dom.createDom("table",{"class":"metadata-record-table"});this._tBody=goog.dom.createDom("tbody",{});goog.dom.appendChild(a,this._tBody);goog.dom.appendChild(this._parentEl,a)};VK2.Tools.MetadataVisualizer.prototype._createHeader=function(a,b,c){this._createHeaderTitel(a,this._tBody);this._createHeaderContent(b,c,this._tBody)};
VK2.Tools.MetadataVisualizer.prototype._createHeaderTitel=function(a,b){var c=goog.dom.createDom("tr",{}),d=goog.dom.createDom("td",{colspan:"2","class":"col-header-titel"}),e=goog.dom.createDom("span",{"class":"metadata-title",innerHTML:a});goog.dom.appendChild(d,e);goog.dom.appendChild(c,d);goog.dom.appendChild(b,c)};
VK2.Tools.MetadataVisualizer.prototype._createHeaderContent=function(a,b,c){var d=goog.dom.createDom("tr",{});a=goog.dom.createDom("td",{innerHTML:a});goog.dom.appendChild(d,a);this._settings.thumbnail&&(a=goog.dom.createDom("td",{"class":"right"}),b=goog.dom.createDom("img",{src:b,alt:"thumbnail","class":"thumbnail"}),goog.dom.appendChild(a,b),goog.dom.appendChild(d,a));goog.dom.appendChild(c,d)};
VK2.Tools.MetadataVisualizer.prototype._createContent=function(a,b){this._createContentContainer(a.ID[0],b);this._slimContentRow(VK2.Utils.get_I18n_String("mdrecord_keyword"),"Messtischbl\u00e4tter, Messtischblatt",this._tBodyContent);this._slimContentRow(VK2.Utils.get_I18n_String("mdrecord_language"),"German",this._tBodyContent);for(var c=0;c<a.REFERENCE_SYSTEM.length;c++)this._slimContentRow(VK2.Utils.get_I18n_String("mdrecord_referencesystem"),a.REFERENCE_SYSTEM[c],this._tBodyContent);for(c=0;c<
a.ONLINE_RESSOURCE.length;c++)this._anchorContentRow(VK2.Utils.get_I18n_String("mdrecord_onlineresource"),a.ONLINE_RESSOURCE[c],this._tBodyContent);this._fatContentRow(VK2.Utils.get_I18n_String("mdrecord_spatialresolution"),a.DENOMINATOR[0],"Denominator",this._tBodyContent)};
VK2.Tools.MetadataVisualizer.prototype._createContentContainer=function(a,b){var c=goog.dom.createDom("tr",{});goog.dom.appendChild(b,c);var d=goog.dom.createDom("td",{colspan:"2"});goog.dom.appendChild(c,d);c=goog.dom.createDom("fieldset",{"class":"content"});goog.dom.appendChild(d,c);d=goog.dom.createDom("legend",{});goog.dom.appendChild(c,d);var e=goog.dom.createDom("span",{innerHTML:VK2.Utils.get_I18n_String("metadata_overview")});goog.dom.appendChild(d,e);e=goog.dom.createDom("a",{href:"http://kartenforum.slub-dresden.de/geonetwork/srv/eng/search#|"+
a,innerHTML:VK2.Utils.get_I18n_String("mdrecord_moremetadata"),target:"_blank"});goog.dom.appendChild(d,e);d=goog.dom.createDom("table",{"class":"metadata-record-table-content"});goog.dom.appendChild(c,d);this._tBodyContent=goog.dom.createDom("tbody",{});goog.dom.appendChild(d,this._tBodyContent);d=goog.dom.createDom("span",{"class":"metadata-record-footer",innerHTML:VK2.Utils.get_I18n_String("mdrecord_uniqueid")+" | "+a});goog.dom.appendChild(c,d)};
VK2.Tools.MetadataVisualizer.prototype._slimContentRow=function(a,b,c){var d=goog.dom.createDom("tr",{});a=goog.dom.createDom("th",{innerHTML:a});goog.dom.appendChild(d,a);b=goog.dom.createDom("td",{innerHTML:b});goog.dom.appendChild(d,b);goog.dom.appendChild(c,d)};
VK2.Tools.MetadataVisualizer.prototype._anchorContentRow=function(a,b,c){var d=goog.dom.createDom("tr",{});a=goog.dom.createDom("th",{innerHTML:a});goog.dom.appendChild(d,a);a=goog.dom.createDom("td",{});goog.dom.appendChild(d,a);url=new goog.Uri(b);url.setQuery("");b=goog.dom.createDom("a",{innerHTML:url.toString(),href:b,target:"_blank",style:"z-index:10000;"});goog.dom.appendChild(a,b);goog.dom.appendChild(c,d)};
VK2.Tools.MetadataVisualizer.prototype._fatContentRow=function(a,b,c,d){var e=goog.dom.createDom("tr",{}),f=goog.dom.createDom("th",{innerHTML:a});goog.dom.appendChild(e,f);a=goog.dom.createDom("td",{});goog.dom.appendChild(e,a);f=goog.dom.createDom("div",{"class":"el"});goog.dom.appendChild(a,f);a=goog.dom.createDom("label",{innerHTML:c});goog.dom.appendChild(f,a);b=goog.dom.createDom("div",{innerHTML:b});goog.dom.appendChild(f,b);goog.dom.appendChild(d,e)};
VK2.Tools.MetadataVisualizer.prototype._clearHtmlContent=function(){goog.dom.removeChildren(this._parentEl);goog.dom.removeNode(this._parentEl)};
