...
VK2.Validation.checkEmailAdress=function(a,b,c){a=goog.dom.getElement(a);var d=!0;if(goog.dom.classes.has(a.parentElement,"has-success")||goog.dom.classes.has(name.parentElement,"has-error"))goog.dom.classes.remove(a.parentElement,"has-error"),goog.dom.classes.remove(a.parentElement,"has-success");d=(d=d&&goog.isDefAndNotNull(a))&&this.checkLength(a.value,6,80);if(goog.isDef(b)&&goog.isDef(c)&&!d)return this.setErrorMsg(VK2.Utils.get_I18n_String("email_to_short"),b,c),goog.dom.classes.add(a.parentElement,
